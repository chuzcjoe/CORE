...
GLESProgram::GLESProgram(const char* vertex_shader_source, const char* fragment_shader_source) {
  // Vertex Shader
...
GLESProgram::~GLESProgram() { glDeleteProgram(program_id_); }

void GLESProgram::Use() const { glUseProgram(program_id_); }
