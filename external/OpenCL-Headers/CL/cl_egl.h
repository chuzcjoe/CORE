...
#define CL_KHR_EGL_IMAGE_EXTENSION_NAME "cl_khr_egl_image"
...
typedef cl_mem CL_API_CALL clCreateFromEGLImageKHR_t(cl_context context, CLeglDisplayKHR egldisplay,
...
typedef cl_int CL_API_CALL clEnqueueAcquireEGLObjectsKHR_t(
    cl_command_queue command_queue, cl_uint num_objects, const cl_mem* mem_objects,
    cl_uint num_events_in_wait_list, const cl_event* event_wait_list, cl_event* event);

typedef clEnqueueAcquireEGLObjectsKHR_t* clEnqueueAcquireEGLObjectsKHR_fn
    CL_API_SUFFIX__VERSION_1_0;

typedef cl_int CL_API_CALL clEnqueueReleaseEGLObjectsKHR_t(
    cl_command_queue command_queue, cl_uint num_objects, const cl_mem* mem_objects,
    cl_uint num_events_in_wait_list, const cl_event* event_wait_list, cl_event* event);

typedef clEnqueueReleaseEGLObjectsKHR_t* clEnqueueReleaseEGLObjectsKHR_fn
    CL_API_SUFFIX__VERSION_1_0;
...
extern CL_API_ENTRY cl_mem CL_API_CALL clCreateFromEGLImageKHR(
    ...
    const cl_egl_image_properties_khr* properties, cl_int* errcode_ret) CL_API_SUFFIX__VERSION_1_0;

extern CL_API_ENTRY cl_int CL_API_CALL clEnqueueAcquireEGLObjectsKHR(
    cl_command_queue command_queue, cl_uint num_objects, const cl_mem* mem_objects,
...
#define CL_KHR_EGL_EVENT_EXTENSION_NAME "cl_khr_egl_event"
...
typedef cl_event CL_API_CALL clCreateEventFromEGLSyncKHR_t(cl_context context, CLeglSyncKHR sync,
...
clCreateEventFromEGLSyncKHR(cl_context context, CLeglSyncKHR sync, CLeglDisplayKHR display,
