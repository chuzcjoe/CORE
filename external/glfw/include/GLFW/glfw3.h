...
#elif !defined(GLFW_INCLUDE_NONE) && !defined(__gl_h_) && !defined(__gles1_gl_h_) &&             \
    !defined(__gles2_gl2_h_) && !defined(__gles2_gl3_h_) && !defined(__gles2_gl31_h_) &&         \
    !defined(__gles2_gl32_h_) && !defined(__gl_glcorearb_h_) && !defined(__gl2_h_) /*legacy*/ && \
    !defined(__gl3_h_) /*legacy*/ && !defined(__gl31_h_) /*legacy*/ &&                           \
    !defined(__gl32_h_) /*legacy*/ && !defined(__glcorearb_h_) /*legacy*/ &&                     \
 ...
 *  @ingroup monitor
 */
GLFWAPI void glfwGetMonitorWorkarea(GLFWmonitor* monitor, int* xpos, int* ypos, int* width,
                                    int* height);
 ...
 *  @ingroup window
 */
GLFWAPI void glfwSetWindowSizeLimits(GLFWwindow* window, int minwidth, int minheight, int maxwidth,
                                     int maxheight);
 ...
 *  @ingroup window
 */
GLFWAPI void glfwGetWindowFrameSize(GLFWwindow* window, int* left, int* top, int* right,
                                    int* bottom);
 ...
 *  @ref GLFW_RESIZE_NWSE_CURSOR   | Yes     | Yes<sup>1</sup> | Maybe<sup>2</sup> |
 * Maybe<sup>2</sup>
 *  @ref GLFW_RESIZE_NESW_CURSOR   | Yes     | Yes<sup>1</sup> | Maybe<sup>2</sup> |
 * Maybe<sup>2</sup>
