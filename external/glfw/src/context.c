...
GLFWbool _glfwIsValidContextConfig(const _GLFWctxconfig* ctxconfig) {
  ...
  if (ctxconfig->client != GLFW_NO_API && ctxconfig->client != GLFW_OPENGL_API &&
  ...
  if (ctxconfig->client == GLFW_OPENGL_API) {
    if ((ctxconfig->major < 1 || ctxconfig->minor < 0) ||
      ...
      _glfwInputError(GLFW_INVALID_VALUE, "Invalid OpenGL version %i.%i", ctxconfig->major,
                      ctxconfig->minor);
      return GLFW_FALSE;
    }
    ...
    if (ctxconfig->major < 1 || ctxconfig->minor < 0 ||
      ...
      _glfwInputError(GLFW_INVALID_VALUE, "Invalid OpenGL ES version %i.%i", ctxconfig->major,
                      ctxconfig->minor);
      return GLFW_FALSE;
    }
  }
  ...
  if (ctxconfig->robustness) {
    if (ctxconfig->robustness != GLFW_NO_RESET_NOTIFICATION &&
      ...
      _glfwInputError(GLFW_INVALID_ENUM, "Invalid context robustness mode 0x%08X",
  ...
  if (ctxconfig->release) {
    if (ctxconfig->release != GLFW_RELEASE_BEHAVIOR_NONE &&
      ...
      _glfwInputError(GLFW_INVALID_ENUM, "Invalid context release behavior 0x%08X",
                      ctxconfig->release);
      return GLFW_FALSE;
    }
  }
...
GLFWbool _glfwRefreshContextAttribs(_GLFWwindow* window, const _GLFWctxconfig* ctxconfig) {
  ...
  if (!sscanf(version, "%d.%d.%d", &window->context.major, &window->context.minor,
  ...
  if (window->context.major < ctxconfig->major ||
    ...
    if (window->context.client == GLFW_OPENGL_API) {
      _glfwInputError(GLFW_VERSION_UNAVAILABLE, "Requested OpenGL version %i.%i, got version %i.%i",
                      ctxconfig->major, ctxconfig->minor, window->context.major,
                      window->context.minor);
    } else {
      _glfwInputError(GLFW_VERSION_UNAVAILABLE,
                      "Requested OpenGL ES version %i.%i, got version %i.%i", ctxconfig->major,
                      ctxconfig->minor, window->context.major, window->context.minor);
    }
  ...
  if (window->context.major >= 3) {
    ...
    window->context.GetStringi =
        (PFNGLGETSTRINGIPROC)window->context.getProcAddress("glGetStringi");
