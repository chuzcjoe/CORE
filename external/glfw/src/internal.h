...
#if defined(GLFW_INCLUDE_GLCOREARB) || defined(GLFW_INCLUDE_ES1) || defined(GLFW_INCLUDE_ES2) || \
    defined(GLFW_INCLUDE_ES3) || defined(GLFW_INCLUDE_ES31) || defined(GLFW_INCLUDE_ES32) ||     \
    defined(GLFW_INCLUDE_NONE) || defined(GLFW_INCLUDE_GLEXT) || defined(GLFW_INCLUDE_GLU) ||    \
    defined(GLFW_INCLUDE_VULKAN) || defined(GLFW_DLL)
...
typedef EGLContext(APIENTRY* PFN_eglCreateContext)(EGLDisplay, EGLConfig, EGLContext,
                                                   const EGLint*);
...
typedef EGLSurface(APIENTRY* PFN_eglCreateWindowSurface)(EGLDisplay, EGLConfig, EGLNativeWindowType,
                                                         const EGLint*);
...
typedef EGLSurface(APIENTRY* PFNEGLCREATEPLATFORMWINDOWSURFACEEXTPROC)(EGLDisplay, EGLConfig, void*,
                                                                       const EGLint*);
...
typedef OSMesaContext(GLAPIENTRY* PFN_OSMesaCreateContextExt)(GLenum, GLint, GLint, GLint,
                                                              OSMesaContext);
...
typedef VkResult(APIENTRY* PFN_vkEnumerateInstanceExtensionProperties)(const char*, uint32_t*,
                                                                       VkExtensionProperties*);
...
struct _GLFWplatform {
  ...
  // window
  GLFWbool (*createWindow)(_GLFWwindow*, const _GLFWwndconfig*, const _GLFWctxconfig*,
                           const _GLFWfbconfig*);
  ...
  VkResult (*createWindowSurface)(VkInstance, _GLFWwindow*, const VkAllocationCallbacks*,
                                  VkSurfaceKHR*);
};
...
const _GLFWfbconfig* _glfwChooseFBConfig(const _GLFWfbconfig* desired,
                                         const _GLFWfbconfig* alternatives, unsigned int count);
