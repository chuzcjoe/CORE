...
void _glfwPollMonitorsNull(void) {
  ...
  _GLFWmonitor* monitor = _glfwAllocMonitor("Null SuperNoop 0", (int)(mode.width * 25.4f / dpi),
...
void _glfwFreeMonitorNull(_GLFWmonitor* monitor) { _glfwFreeGammaArrays(&monitor->null.ramp); }
...
void _glfwGetMonitorWorkareaNull(_GLFWmonitor* monitor, int* xpos, int* ypos, int* width,
  ...
  if (height) *height = mode.height - 10;
}
