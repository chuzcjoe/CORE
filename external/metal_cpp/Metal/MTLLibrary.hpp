...
_MTL_ENUM(NS::UInteger, FunctionType){
    FunctionTypeVertex = 1,  FunctionTypeFragment = 2,     FunctionTypeKernel = 3,
    FunctionTypeVisible = 5, FunctionTypeIntersection = 6, FunctionTypeMesh = 7,
...
_MTL_ENUM(NS::UInteger, LibraryError){
    LibraryErrorUnsupported = 1,      LibraryErrorInternal = 2,
    LibraryErrorCompileFailure = 3,   LibraryErrorCompileWarning = 4,
    LibraryErrorFunctionNotFound = 5, LibraryErrorFileNotFound = 6,
};

using AutoreleasedArgument = MTL::Argument*;
using FunctionCompletionHandlerFunction =
    std::function<void(MTL::Function* pFunction, NS::Error* pError)>;
...
class Library : public NS::Referencing<Library> {
 public:
  ...
  void newIntersectionFunction(const MTL::IntersectionFunctionDescriptor* descriptor,
                               void (^completionHandler)(MTL::Function*, NS::Error*));
  Function* newIntersectionFunction(const MTL::IntersectionFunctionDescriptor* descriptor,
                                    NS::Error** error);
...
_MTL_INLINE MTL::ArgumentEncoder* MTL::Function::newArgumentEncoder(
    NS::UInteger bufferIndex, const MTL::AutoreleasedArgument* reflection) {
  return Object::sendMessage<MTL::ArgumentEncoder*>(
      this, _MTL_PRIVATE_SEL(newArgumentEncoderWithBufferIndex_reflection_), bufferIndex,
      reflection);
}
...
_MTL_INLINE MTL::CompileSymbolVisibility MTL::CompileOptions::compileSymbolVisibility() const {
  return Object::sendMessage<MTL::CompileSymbolVisibility>(
      this, _MTL_PRIVATE_SEL(compileSymbolVisibility));
}
...
_MTL_INLINE MTL::MathFloatingPointFunctions MTL::CompileOptions::mathFloatingPointFunctions()
    const {
  return Object::sendMessage<MTL::MathFloatingPointFunctions>(
      this, _MTL_PRIVATE_SEL(mathFloatingPointFunctions));
}
...
_MTL_INLINE MTL::LibraryOptimizationLevel MTL::CompileOptions::optimizationLevel() const {
  return Object::sendMessage<MTL::LibraryOptimizationLevel>(this,
...
_MTL_INLINE void MTL::CompileOptions::setCompileSymbolVisibility(
  ...
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setCompileSymbolVisibility_),
...
_MTL_INLINE void MTL::CompileOptions::setMathFloatingPointFunctions(
  ...
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setMathFloatingPointFunctions_),
...
_MTL_INLINE void MTL::CompileOptions::setOptimizationLevel(
    MTL::LibraryOptimizationLevel optimizationLevel) {
...
_MTL_INLINE void MTL::CompileOptions::setPreprocessorMacros(
    const NS::Dictionary* preprocessorMacros) {
...
_MTL_INLINE void MTL::CompileOptions::setRequiredThreadsPerThreadgroup(
...
_MTL_INLINE MTL::Function* MTL::Library::newFunction(const NS::String* functionName) {
  return Object::sendMessage<MTL::Function*>(this, _MTL_PRIVATE_SEL(newFunctionWithName_),
                                             functionName);
}

_MTL_INLINE MTL::Function* MTL::Library::newFunction(
    const NS::String* name, const MTL::FunctionConstantValues* constantValues, NS::Error** error) {
  return Object::sendMessage<MTL::Function*>(
      this, _MTL_PRIVATE_SEL(newFunctionWithName_constantValues_error_), name, constantValues,
      error);
}
...
_MTL_INLINE void MTL::Library::newFunction(const NS::String* name,
  ...
  Object::sendMessage<void>(this,
                            ...
                            name, constantValues, completionHandler);
}

_MTL_INLINE void MTL::Library::newFunction(const MTL::FunctionDescriptor* descriptor,
                                           void (^completionHandler)(MTL::Function*, NS::Error*)) {
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(newFunctionWithDescriptor_completionHandler_),
                            descriptor, completionHandler);
}

_MTL_INLINE MTL::Function* MTL::Library::newFunction(const MTL::FunctionDescriptor* descriptor,
                                                     NS::Error** error) {
  return Object::sendMessage<MTL::Function*>(
      this, _MTL_PRIVATE_SEL(newFunctionWithDescriptor_error_), descriptor, error);
}

_MTL_INLINE void MTL::Library::newFunction(
    const NS::String* pFunctionName, const MTL::FunctionConstantValues* pConstantValues,
    const MTL::FunctionCompletionHandlerFunction& completionHandler) {
...
_MTL_INLINE void MTL::Library::newFunction(
    const MTL::FunctionDescriptor* pDescriptor,
    const MTL::FunctionCompletionHandlerFunction& completionHandler) {
  __block MTL::FunctionCompletionHandlerFunction blockCompletionHandler = completionHandler;
...
_MTL_INLINE void MTL::Library::newIntersectionFunction(
    const MTL::IntersectionFunctionDescriptor* descriptor,
    void (^completionHandler)(MTL::Function*, NS::Error*)) {
  Object::sendMessage<void>(
      this, _MTL_PRIVATE_SEL(newIntersectionFunctionWithDescriptor_completionHandler_), descriptor,
      completionHandler);
}

_MTL_INLINE MTL::Function* MTL::Library::newIntersectionFunction(
    const MTL::IntersectionFunctionDescriptor* descriptor, NS::Error** error) {
  return Object::sendMessage<MTL::Function*>(
      this, _MTL_PRIVATE_SEL(newIntersectionFunctionWithDescriptor_error_), descriptor, error);
}

_MTL_INLINE void MTL::Library::newIntersectionFunction(
    const MTL::IntersectionFunctionDescriptor* pDescriptor,
    const MTL::FunctionCompletionHandlerFunction& completionHandler) {
  __block MTL::FunctionCompletionHandlerFunction blockCompletionHandler = completionHandler;
...
_MTL_INLINE MTL::FunctionReflection* MTL::Library::reflectionForFunction(
