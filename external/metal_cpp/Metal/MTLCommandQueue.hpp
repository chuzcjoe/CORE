...
_MTL_INLINE void MTL::CommandQueue::addResidencySets(const MTL::ResidencySet* const residencySets[],
                                                     NS::UInteger count) {
...
_MTL_INLINE void MTL::CommandQueue::removeResidencySets(
...
_MTL_INLINE MTL::CommandQueueDescriptor* MTL::CommandQueueDescriptor::alloc() {
  return NS::Object::alloc<MTL::CommandQueueDescriptor>(
      _MTL_PRIVATE_CLS(MTLCommandQueueDescriptor));
}
...
_MTL_INLINE void MTL::CommandQueueDescriptor::setMaxCommandBufferCount(
