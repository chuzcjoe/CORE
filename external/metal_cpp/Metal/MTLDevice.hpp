...
_MTL_ENUM(NS::Integer, GPUFamily){
    ...
    GPUFamilyApple7 = 1007,       GPUFamilyApple8 = 1008,       GPUFamilyApple9 = 1009,
    GPUFamilyApple10 = 1010,      GPUFamilyMac1 = 2001,         GPUFamilyMac2 = 2002,
    GPUFamilyCommon1 = 3001,      GPUFamilyCommon2 = 3002,      GPUFamilyCommon3 = 3003,
    GPUFamilyMacCatalyst1 = 4001, GPUFamilyMacCatalyst2 = 4002, GPUFamilyMetal3 = 5001,
...
using DeviceNotificationHandlerBlock = void (^)(MTL::Device* pDevice,
                                                MTL::DeviceNotificationName notifyName);
using DeviceNotificationHandlerFunction =
    std::function<void(MTL::Device* pDevice, MTL::DeviceNotificationName notifyName)>;
...
using NewRenderPipelineStateCompletionHandlerFunction =
    std::function<void(MTL::RenderPipelineState*, NS::Error*)>;
...
using NewRenderPipelineStateWithReflectionCompletionHandlerFunction =
    std::function<void(MTL::RenderPipelineState*, MTL::RenderPipelineReflection*, NS::Error*)>;
...
using NewComputePipelineStateWithReflectionCompletionHandlerFunction =
    std::function<void(MTL::ComputePipelineState*, MTL::ComputePipelineReflection*, NS::Error*)>;
...
class Device : public NS::Referencing<Device> {
 public:
  ...
  void convertSparsePixelRegions(const MTL::Region* pixelRegions, MTL::Region* tileRegions,
                                 MTL::Size tileSize, MTL::SparseTextureRegionAlignmentMode mode,
                                 NS::UInteger numRegions);

  void convertSparseTileRegions(const MTL::Region* tileRegions, MTL::Region* pixelRegions,
  ...
  MTL4::ArgumentTable* newArgumentTable(const MTL4::ArgumentTableDescriptor* descriptor,
                                        NS::Error** error);

  BinaryArchive* newBinaryArchive(const MTL::BinaryArchiveDescriptor* descriptor,
                                  NS::Error** error);
  ...
  ComputePipelineState* newComputePipelineState(const MTL::Function* computeFunction,
                                                NS::Error** error);
  ...
  void newComputePipelineState(
      const MTL::Function* computeFunction, MTL::PipelineOption options,
      const MTL::NewComputePipelineStateWithReflectionCompletionHandler completionHandler);
  ComputePipelineState* newComputePipelineState(
  ...
  void newComputePipelineState(
      const MTL::Function* pFunction, MTL::PipelineOption options,
      const MTL::NewComputePipelineStateWithReflectionCompletionHandlerFunction& completionHandler);
  void newComputePipelineState(
      const MTL::ComputePipelineDescriptor* pDescriptor, MTL::PipelineOption options,
      const MTL::NewComputePipelineStateWithReflectionCompletionHandlerFunction& completionHandler);

  MTL4::CounterHeap* newCounterHeap(const MTL4::CounterHeapDescriptor* descriptor,
                                    NS::Error** error);
  ...
  IOCommandQueue* newIOCommandQueue(const MTL::IOCommandQueueDescriptor* descriptor,
                                    NS::Error** error);
  ...
  IOFileHandle* newIOHandle(const NS::URL* url, MTL::IOCompressionMethod compressionMethod,
                            NS::Error** error);

  IndirectCommandBuffer* newIndirectCommandBuffer(
      const MTL::IndirectCommandBufferDescriptor* descriptor, NS::UInteger maxCount,
  ...
  Library* newLibrary(const NS::String* source, const MTL::CompileOptions* options,
                      NS::Error** error);
  ...
  MTL4::CommandQueue* newMTL4CommandQueue(const MTL4::CommandQueueDescriptor* descriptor,
                                          NS::Error** error);

  MTL4::PipelineDataSetSerializer* newPipelineDataSetSerializer(
      const MTL4::PipelineDataSetSerializerDescriptor* descriptor);

  RasterizationRateMap* newRasterizationRateMap(
  ...
  void newRenderPipelineState(
      ...
      const MTL::NewRenderPipelineStateWithReflectionCompletionHandler completionHandler);
  void newRenderPipelineState(
      const MTL::RenderPipelineDescriptor* pDescriptor,
      const MTL::NewRenderPipelineStateCompletionHandlerFunction& completionHandler);
  void newRenderPipelineState(
      const MTL::RenderPipelineDescriptor* pDescriptor, MTL::PipelineOption options,
      const MTL::NewRenderPipelineStateWithReflectionCompletionHandlerFunction& completionHandler);
  void newRenderPipelineState(
      const MTL::TileRenderPipelineDescriptor* pDescriptor, MTL::PipelineOption options,
      const MTL::NewRenderPipelineStateWithReflectionCompletionHandlerFunction& completionHandler);
  ...
  Texture* newTexture(const MTL::TextureDescriptor* descriptor, const IOSurfaceRef iosurface,
                      NS::UInteger plane);
  TextureViewPool* newTextureViewPool(const MTL::ResourceViewPoolDescriptor* descriptor,
                                      NS::Error** error);
...
_NS_EXPORT NS::Array* MTL::CopyAllDevicesWithObserver(
    NS::Object** pOutObserver, const MTL::DeviceNotificationHandlerFunction& handler) {
  __block DeviceNotificationHandlerFunction function = handler;
  return CopyAllDevicesWithObserver(pOutObserver,
...
_MTL_INLINE bool MTL::Device::areProgrammableSamplePositionsSupported() const {
  return Object::sendMessageSafe<bool>(this,
                                       _MTL_PRIVATE_SEL(areProgrammableSamplePositionsSupported));
}
...
_MTL_INLINE MTL::ArgumentBuffersTier MTL::Device::argumentBuffersSupport() const {
  return Object::sendMessage<MTL::ArgumentBuffersTier>(this,
                                                       _MTL_PRIVATE_SEL(argumentBuffersSupport));
}
...
_MTL_INLINE void MTL::Device::convertSparsePixelRegions(const MTL::Region* pixelRegions,
                                                        MTL::Region* tileRegions,
                                                        MTL::Size tileSize,
...
_MTL_INLINE void MTL::Device::convertSparseTileRegions(const MTL::Region* tileRegions,
                                                       MTL::Region* pixelRegions,
                                                       MTL::Size tileSize,
                                                       NS::UInteger numRegions) {
  Object::sendMessage<void>(
      this, _MTL_PRIVATE_SEL(convertSparseTileRegions_toPixelRegions_withTileSize_numRegions_),
...
_MTL_INLINE bool MTL::Device::depth24Stencil8PixelFormatSupported() const {
  return Object::sendMessageSafe<bool>(this,
                                       _MTL_PRIVATE_SEL(isDepth24Stencil8PixelFormatSupported));
}
...
_MTL_INLINE void MTL::Device::getDefaultSamplePositions(MTL::SamplePosition* positions,
                                                        NS::UInteger count) {
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(getDefaultSamplePositions_count_), positions,
                            count);
}
...
_MTL_INLINE MTL::SizeAndAlign MTL::Device::heapBufferSizeAndAlign(NS::UInteger length,
                                                                  MTL::ResourceOptions options) {
  return Object::sendMessage<MTL::SizeAndAlign>(
      this, _MTL_PRIVATE_SEL(heapBufferSizeAndAlignWithLength_options_), length, options);
}

_MTL_INLINE MTL::SizeAndAlign MTL::Device::heapTextureSizeAndAlign(
    const MTL::TextureDescriptor* desc) {
  return Object::sendMessage<MTL::SizeAndAlign>(
...
_MTL_INLINE NS::UInteger MTL::Device::maximumConcurrentCompilationTaskCount() const {
  return Object::sendMessage<NS::UInteger>(this,
                                           _MTL_PRIVATE_SEL(maximumConcurrentCompilationTaskCount));
}

_MTL_INLINE NS::UInteger MTL::Device::minimumLinearTextureAlignmentForPixelFormat(
    MTL::PixelFormat format) {
  return Object::sendMessage<NS::UInteger>(
      this, _MTL_PRIVATE_SEL(minimumLinearTextureAlignmentForPixelFormat_), format);
}

_MTL_INLINE NS::UInteger MTL::Device::minimumTextureBufferAlignmentForPixelFormat(
    MTL::PixelFormat format) {
  return Object::sendMessage<NS::UInteger>(
...
_MTL_INLINE MTL4::Archive* MTL::Device::newArchive(const NS::URL* url, NS::Error** error) {
  return Object::sendMessage<MTL4::Archive*>(this, _MTL_PRIVATE_SEL(newArchiveWithURL_error_), url,
                                             error);
}
...
_MTL_INLINE MTL::ArgumentEncoder* MTL::Device::newArgumentEncoder(
    const MTL::BufferBinding* bufferBinding) {
  return Object::sendMessage<MTL::ArgumentEncoder*>(
...
_MTL_INLINE MTL4::ArgumentTable* MTL::Device::newArgumentTable(
    const MTL4::ArgumentTableDescriptor* descriptor, NS::Error** error) {
...
_MTL_INLINE MTL::BinaryArchive* MTL::Device::newBinaryArchive(
    const MTL::BinaryArchiveDescriptor* descriptor, NS::Error** error) {
...
_MTL_INLINE MTL::Buffer* MTL::Device::newBuffer(NS::UInteger length, MTL::ResourceOptions options) {
  return Object::sendMessage<MTL::Buffer*>(this, _MTL_PRIVATE_SEL(newBufferWithLength_options_),
                                           length, options);
}

_MTL_INLINE MTL::Buffer* MTL::Device::newBuffer(const void* pointer, NS::UInteger length,
                                                MTL::ResourceOptions options) {
  return Object::sendMessage<MTL::Buffer*>(
      this, _MTL_PRIVATE_SEL(newBufferWithBytes_length_options_), pointer, length, options);
}
...
_MTL_INLINE MTL::Buffer* MTL::Device::newBuffer(const void* pointer, NS::UInteger length,
                                                ...
                                                void (^deallocator)(void*, NS::UInteger)) {
  return Object::sendMessage<MTL::Buffer*>(
      this, _MTL_PRIVATE_SEL(newBufferWithBytesNoCopy_length_options_deallocator_), pointer, length,
      options, deallocator);
}
...
_MTL_INLINE MTL4::CommandAllocator* MTL::Device::newCommandAllocator(
    const MTL4::CommandAllocatorDescriptor* descriptor, NS::Error** error) {
...
_MTL_INLINE MTL::CommandQueue* MTL::Device::newCommandQueue(
    const MTL::CommandQueueDescriptor* descriptor) {
  return Object::sendMessage<MTL::CommandQueue*>(
...
_MTL_INLINE MTL::ComputePipelineState* MTL::Device::newComputePipelineState(
    ...
    const MTL::AutoreleasedComputePipelineReflection* reflection, NS::Error** error) {
  return Object::sendMessage<MTL::ComputePipelineState*>(
      this, _MTL_PRIVATE_SEL(newComputePipelineStateWithFunction_options_reflection_error_),
...
_MTL_INLINE void MTL::Device::newComputePipelineState(
    ...
    const MTL::NewComputePipelineStateWithReflectionCompletionHandler completionHandler) {
  Object::sendMessage<void>(
      this, _MTL_PRIVATE_SEL(newComputePipelineStateWithFunction_options_completionHandler_),
...
_MTL_INLINE MTL::ComputePipelineState* MTL::Device::newComputePipelineState(
    ...
    const MTL::AutoreleasedComputePipelineReflection* reflection, NS::Error** error) {
  return Object::sendMessage<MTL::ComputePipelineState*>(
      this, _MTL_PRIVATE_SEL(newComputePipelineStateWithDescriptor_options_reflection_error_),
...
_MTL_INLINE void MTL::Device::newComputePipelineState(
    ...
    const MTL::NewComputePipelineStateWithReflectionCompletionHandler completionHandler) {
  Object::sendMessage<void>(
      this, _MTL_PRIVATE_SEL(newComputePipelineStateWithDescriptor_options_completionHandler_),
...
_MTL_INLINE void MTL::Device::newComputePipelineState(
  ...
  __block MTL::NewComputePipelineStateCompletionHandlerFunction blockCompletionHandler =
      completionHandler;
  newComputePipelineState(pFunction,
                          ^(MTL::ComputePipelineState* pPipelineState, NS::Error* pError) {
...
_MTL_INLINE void MTL::Device::newComputePipelineState(
  ...
  newComputePipelineState(pFunction, options,
                          ^(MTL::ComputePipelineState* pPipelineState,
                            MTL::ComputePipelineReflection* pReflection, NS::Error* pError) {
...
_MTL_INLINE void MTL::Device::newComputePipelineState(
    const MTL::ComputePipelineDescriptor* pDescriptor, MTL::PipelineOption options,
    const MTL::NewComputePipelineStateWithReflectionCompletionHandlerFunction& completionHandler) {
  __block NewComputePipelineStateWithReflectionCompletionHandlerFunction blockCompletionHandler =
      completionHandler;
...
_MTL_INLINE MTL4::CounterHeap* MTL::Device::newCounterHeap(
    const MTL4::CounterHeapDescriptor* descriptor, NS::Error** error) {
...
_MTL_INLINE MTL::Library* MTL::Device::newDefaultLibrary(const NS::Bundle* bundle,
                                                         NS::Error** error) {
...
_MTL_INLINE MTL::DynamicLibrary* MTL::Device::newDynamicLibrary(const MTL::Library* library,
                                                                NS::Error** error) {
  return Object::sendMessage<MTL::DynamicLibrary*>(this, _MTL_PRIVATE_SEL(newDynamicLibrary_error_),
                                                   library, error);
}

_MTL_INLINE MTL::DynamicLibrary* MTL::Device::newDynamicLibrary(const NS::URL* url,
                                                                NS::Error** error) {
...
_MTL_INLINE MTL::IOCommandQueue* MTL::Device::newIOCommandQueue(
    const MTL::IOCommandQueueDescriptor* descriptor, NS::Error** error) {
...
_MTL_INLINE MTL::IOFileHandle* MTL::Device::newIOFileHandle(
    const NS::URL* url, MTL::IOCompressionMethod compressionMethod, NS::Error** error) {
  return Object::sendMessage<MTL::IOFileHandle*>(
...
_MTL_INLINE MTL::IOFileHandle* MTL::Device::newIOHandle(const NS::URL* url, NS::Error** error) {
  return Object::sendMessage<MTL::IOFileHandle*>(this, _MTL_PRIVATE_SEL(newIOHandleWithURL_error_),
                                                 url, error);
}
...
_MTL_INLINE MTL::IndirectCommandBuffer* MTL::Device::newIndirectCommandBuffer(
  ...
  return Object::sendMessage<MTL::IndirectCommandBuffer*>(
      this, _MTL_PRIVATE_SEL(newIndirectCommandBufferWithDescriptor_maxCommandCount_options_),
      descriptor, maxCount, options);
}

_MTL_INLINE MTL::Library* MTL::Device::newLibrary(const NS::String* filepath, NS::Error** error) {
  return Object::sendMessage<MTL::Library*>(this, _MTL_PRIVATE_SEL(newLibraryWithFile_error_),
                                            filepath, error);
}

_MTL_INLINE MTL::Library* MTL::Device::newLibrary(const NS::URL* url, NS::Error** error) {
  return Object::sendMessage<MTL::Library*>(this, _MTL_PRIVATE_SEL(newLibraryWithURL_error_), url,
                                            error);
}

_MTL_INLINE MTL::Library* MTL::Device::newLibrary(const dispatch_data_t data, NS::Error** error) {
  return Object::sendMessage<MTL::Library*>(this, _MTL_PRIVATE_SEL(newLibraryWithData_error_), data,
                                            error);
}
...
_MTL_INLINE MTL::Library* MTL::Device::newLibrary(const NS::String* source,
                                                  ...
                                                  NS::Error** error) {
  return Object::sendMessage<MTL::Library*>(
      this, _MTL_PRIVATE_SEL(newLibraryWithSource_options_error_), source, options, error);
}

_MTL_INLINE void MTL::Device::newLibrary(const NS::String* source,
                                         const MTL::CompileOptions* options,
                                         const MTL::NewLibraryCompletionHandler completionHandler) {
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(newLibraryWithSource_options_completionHandler_),
                            source, options, completionHandler);
}

_MTL_INLINE MTL::Library* MTL::Device::newLibrary(const MTL::StitchedLibraryDescriptor* descriptor,
                                                  NS::Error** error) {
  return Object::sendMessage<MTL::Library*>(
      this, _MTL_PRIVATE_SEL(newLibraryWithStitchedDescriptor_error_), descriptor, error);
}
...
_MTL_INLINE void MTL::Device::newLibrary(
    const NS::String* pSource, const MTL::CompileOptions* pOptions,
    const MTL::NewLibraryCompletionHandlerFunction& completionHandler) {
...
_MTL_INLINE void MTL::Device::newLibrary(
    const MTL::StitchedLibraryDescriptor* pDescriptor,
    const MTL::NewLibraryCompletionHandlerFunction& completionHandler) {
  __block MTL::NewLibraryCompletionHandlerFunction blockCompletionHandler = completionHandler;
...
_MTL_INLINE MTL::LogState* MTL::Device::newLogState(const MTL::LogStateDescriptor* descriptor,
                                                    NS::Error** error) {
...
_MTL_INLINE MTL4::CommandQueue* MTL::Device::newMTL4CommandQueue(
    const MTL4::CommandQueueDescriptor* descriptor, NS::Error** error) {
...
_MTL_INLINE MTL::RenderPipelineState* MTL::Device::newRenderPipelineState(
    ...
    const MTL::AutoreleasedRenderPipelineReflection* reflection, NS::Error** error) {
  return Object::sendMessage<MTL::RenderPipelineState*>(
      this, _MTL_PRIVATE_SEL(newRenderPipelineStateWithDescriptor_options_reflection_error_),
      descriptor, options, reflection, error);
}
...
_MTL_INLINE void MTL::Device::newRenderPipelineState(
    ...
    const MTL::NewRenderPipelineStateCompletionHandler completionHandler) {
  Object::sendMessage<void>(
      this, _MTL_PRIVATE_SEL(newRenderPipelineStateWithDescriptor_completionHandler_), descriptor,
      completionHandler);
}
...
_MTL_INLINE void MTL::Device::newRenderPipelineState(
    ...
    const MTL::NewRenderPipelineStateWithReflectionCompletionHandler completionHandler) {
  Object::sendMessage<void>(
      this, _MTL_PRIVATE_SEL(newRenderPipelineStateWithDescriptor_options_completionHandler_),
      descriptor, options, completionHandler);
}
...
_MTL_INLINE MTL::RenderPipelineState* MTL::Device::newRenderPipelineState(
    ...
    const MTL::AutoreleasedRenderPipelineReflection* reflection, NS::Error** error) {
  return Object::sendMessage<MTL::RenderPipelineState*>(
      this, _MTL_PRIVATE_SEL(newRenderPipelineStateWithTileDescriptor_options_reflection_error_),
      descriptor, options, reflection, error);
}
...
_MTL_INLINE void MTL::Device::newRenderPipelineState(
    ...
    const MTL::NewRenderPipelineStateWithReflectionCompletionHandler completionHandler) {
  Object::sendMessage<void>(
      this, _MTL_PRIVATE_SEL(newRenderPipelineStateWithTileDescriptor_options_completionHandler_),
      descriptor, options, completionHandler);
}
...
_MTL_INLINE MTL::RenderPipelineState* MTL::Device::newRenderPipelineState(
    ...
    const MTL::AutoreleasedRenderPipelineReflection* reflection, NS::Error** error) {
  return Object::sendMessage<MTL::RenderPipelineState*>(
      this, _MTL_PRIVATE_SEL(newRenderPipelineStateWithMeshDescriptor_options_reflection_error_),
      descriptor, options, reflection, error);
}
...
_MTL_INLINE void MTL::Device::newRenderPipelineState(
    ...
    const MTL::NewRenderPipelineStateWithReflectionCompletionHandler completionHandler) {
  Object::sendMessage<void>(
      this, _MTL_PRIVATE_SEL(newRenderPipelineStateWithMeshDescriptor_options_completionHandler_),
      descriptor, options, completionHandler);
}
...
_MTL_INLINE void MTL::Device::newRenderPipelineState(
  ...
  __block MTL::NewRenderPipelineStateCompletionHandlerFunction blockCompletionHandler =
      completionHandler;
  newRenderPipelineState(pDescriptor,
                         ^(MTL::RenderPipelineState* pPipelineState, NS::Error* pError) {
                           blockCompletionHandler(pPipelineState, pError);
                         });
}
...
_MTL_INLINE void MTL::Device::newRenderPipelineState(
  ...
  newRenderPipelineState(pDescriptor, options,
                         ^(MTL::RenderPipelineState* pPipelineState,
                           MTL::RenderPipelineReflection* pReflection, NS::Error* pError) {
                           blockCompletionHandler(pPipelineState, pReflection, pError);
                         });
}
...
_MTL_INLINE MTL::ResidencySet* MTL::Device::newResidencySet(const MTL::ResidencySetDescriptor* desc,
                                                            NS::Error** error) {
  return Object::sendMessage<MTL::ResidencySet*>(
      this, _MTL_PRIVATE_SEL(newResidencySetWithDescriptor_error_), desc, error);
}

_MTL_INLINE MTL::SamplerState* MTL::Device::newSamplerState(
    const MTL::SamplerDescriptor* descriptor) {
...
_MTL_INLINE MTL::SharedEvent* MTL::Device::newSharedEvent(
    const MTL::SharedEventHandle* sharedEventHandle) {
  return Object::sendMessage<MTL::SharedEvent*>(this, _MTL_PRIVATE_SEL(newSharedEventWithHandle_),
                                                sharedEventHandle);
}

_MTL_INLINE MTL::Texture* MTL::Device::newSharedTexture(const MTL::TextureDescriptor* descriptor) {
  return Object::sendMessage<MTL::Texture*>(this, _MTL_PRIVATE_SEL(newSharedTextureWithDescriptor_),
                                            descriptor);
}

_MTL_INLINE MTL::Texture* MTL::Device::newSharedTexture(
    const MTL::SharedTextureHandle* sharedHandle) {
  return Object::sendMessage<MTL::Texture*>(this, _MTL_PRIVATE_SEL(newSharedTextureWithHandle_),
                                            sharedHandle);
}

_MTL_INLINE MTL::Tensor* MTL::Device::newTensor(const MTL::TensorDescriptor* descriptor,
                                                NS::Error** error) {
  return Object::sendMessage<MTL::Tensor*>(this, _MTL_PRIVATE_SEL(newTensorWithDescriptor_error_),
                                           descriptor, error);
}

_MTL_INLINE MTL::Texture* MTL::Device::newTexture(const MTL::TextureDescriptor* descriptor) {
  return Object::sendMessage<MTL::Texture*>(this, _MTL_PRIVATE_SEL(newTextureWithDescriptor_),
                                            descriptor);
}
...
_MTL_INLINE MTL::Texture* MTL::Device::newTexture(const MTL::TextureDescriptor* descriptor,
  ...
  return Object::sendMessage<MTL::Texture*>(
      this, _MTL_PRIVATE_SEL(newTextureWithDescriptor_iosurface_plane_), descriptor, iosurface,
      plane);
}

_MTL_INLINE MTL::TextureViewPool* MTL::Device::newTextureViewPool(
    const MTL::ResourceViewPoolDescriptor* descriptor, NS::Error** error) {
...
_MTL_INLINE MTL::ReadWriteTextureTier MTL::Device::readWriteTextureSupport() const {
  return Object::sendMessage<MTL::ReadWriteTextureTier>(this,
                                                        _MTL_PRIVATE_SEL(readWriteTextureSupport));
}
...
_MTL_INLINE void MTL::Device::sampleTimestamps(MTL::Timestamp* cpuTimestamp,
  ...
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(sampleTimestamps_gpuTimestamp_), cpuTimestamp,
                            gpuTimestamp);
}
...
_MTL_INLINE MTL::Size MTL::Device::sparseTileSize(MTL::TextureType textureType,
  ...
  return Object::sendMessage<MTL::Size>(
      this, _MTL_PRIVATE_SEL(sparseTileSizeWithTextureType_pixelFormat_sampleCount_), textureType,
...
_MTL_INLINE MTL::Size MTL::Device::sparseTileSize(MTL::TextureType textureType,
  ...
  return Object::sendMessage<MTL::Size>(
      this, _MTL_PRIVATE_SEL(sparseTileSizeWithTextureType_pixelFormat_sampleCount_sparsePageSize_),
...
_MTL_INLINE bool MTL::Device::supportsShaderBarycentricCoordinates() const {
  return Object::sendMessageSafe<bool>(this,
                                       _MTL_PRIVATE_SEL(supportsShaderBarycentricCoordinates));
}

_MTL_INLINE bool MTL::Device::supportsTextureSampleCount(NS::UInteger sampleCount) {
  return Object::sendMessageSafe<bool>(this, _MTL_PRIVATE_SEL(supportsTextureSampleCount_),
                                       sampleCount);
}

_MTL_INLINE bool MTL::Device::supportsVertexAmplificationCount(NS::UInteger count) {
  return Object::sendMessageSafe<bool>(this, _MTL_PRIVATE_SEL(supportsVertexAmplificationCount_),
                                       count);
}

_MTL_INLINE MTL::SizeAndAlign MTL::Device::tensorSizeAndAlign(
    const MTL::TensorDescriptor* descriptor) {
  return Object::sendMessage<MTL::SizeAndAlign>(
