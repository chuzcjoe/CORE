...
_MTL_ENUM(NS::Integer, TensorDataType){
    TensorDataTypeNone = 0,       TensorDataTypeFloat32 = 3, TensorDataTypeFloat16 = 16,
    TensorDataTypeBFloat16 = 121, TensorDataTypeInt8 = 45,   TensorDataTypeUInt8 = 49,
    TensorDataTypeInt16 = 37,     TensorDataTypeUInt16 = 41, TensorDataTypeInt32 = 29,
...
class Tensor : public NS::Referencing<Tensor, Resource> {
 public:
  ...
  void getBytes(void* bytes, const MTL::TensorExtents* strides,
...
_MTL_INLINE NS::Integer MTL::TensorExtents::extentAtDimensionIndex(NS::UInteger dimensionIndex) {
  return Object::sendMessage<NS::Integer>(this, _MTL_PRIVATE_SEL(extentAtDimensionIndex_),
                                          dimensionIndex);
}
...
_MTL_INLINE MTL::TensorExtents* MTL::TensorExtents::init(NS::UInteger rank,
                                                         const NS::Integer* values) {
  return Object::sendMessage<MTL::TensorExtents*>(this, _MTL_PRIVATE_SEL(initWithRank_values_),
                                                  rank, values);
}
...
_MTL_INLINE void MTL::TensorDescriptor::setHazardTrackingMode(
...
_MTL_INLINE void MTL::Tensor::getBytes(void* bytes, const MTL::TensorExtents* strides,
  ...
  Object::sendMessage<void>(this,
                            ...
                            bytes, strides, sliceOrigin, sliceDimensions);
}
