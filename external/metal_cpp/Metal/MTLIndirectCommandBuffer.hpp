...
_MTL_INLINE NS::UInteger MTL::IndirectCommandBufferDescriptor::maxKernelThreadgroupMemoryBindCount()
    const {
...
_MTL_INLINE NS::UInteger MTL::IndirectCommandBufferDescriptor::maxObjectThreadgroupMemoryBindCount()
    const {
  return Object::sendMessage<NS::UInteger>(this,
                                           _MTL_PRIVATE_SEL(maxObjectThreadgroupMemoryBindCount));
}
...
_MTL_INLINE void MTL::IndirectCommandBufferDescriptor::setCommandTypes(
...
_MTL_INLINE void MTL::IndirectCommandBufferDescriptor::setInheritDepthClipMode(
    bool inheritDepthClipMode) {
...
_MTL_INLINE void MTL::IndirectCommandBufferDescriptor::setInheritDepthStencilState(
    bool inheritDepthStencilState) {
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setInheritDepthStencilState_),
                            inheritDepthStencilState);
}

_MTL_INLINE void MTL::IndirectCommandBufferDescriptor::setInheritFrontFacingWinding(
    bool inheritFrontFacingWinding) {
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setInheritFrontFacingWinding_),
                            inheritFrontFacingWinding);
}

_MTL_INLINE void MTL::IndirectCommandBufferDescriptor::setInheritPipelineState(
...
_MTL_INLINE void MTL::IndirectCommandBufferDescriptor::setInheritTriangleFillMode(
    bool inheritTriangleFillMode) {
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setInheritTriangleFillMode_),
...
_MTL_INLINE void MTL::IndirectCommandBufferDescriptor::setMaxFragmentBufferBindCount(
  ...
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setMaxFragmentBufferBindCount_),
...
_MTL_INLINE void MTL::IndirectCommandBufferDescriptor::setMaxKernelBufferBindCount(
  ...
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setMaxKernelBufferBindCount_),
...
_MTL_INLINE void MTL::IndirectCommandBufferDescriptor::setMaxMeshBufferBindCount(
    NS::UInteger maxMeshBufferBindCount) {
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setMaxMeshBufferBindCount_),
...
_MTL_INLINE void MTL::IndirectCommandBufferDescriptor::setMaxObjectBufferBindCount(
  ...
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setMaxObjectBufferBindCount_),
...
_MTL_INLINE void MTL::IndirectCommandBufferDescriptor::setMaxVertexBufferBindCount(
  ...
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setMaxVertexBufferBindCount_),
...
_MTL_INLINE void MTL::IndirectCommandBufferDescriptor::setSupportDynamicAttributeStride(
  ...
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setSupportDynamicAttributeStride_),
                            supportDynamicAttributeStride);
}

_MTL_INLINE void MTL::IndirectCommandBufferDescriptor::setSupportRayTracing(
