...
_MTL_INLINE void MTL4::PipelineOptions::setShaderReflection(
    MTL4::ShaderReflection shaderReflection) {
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setShaderReflection_), shaderReflection);
}

_MTL_INLINE void MTL4::PipelineOptions::setShaderValidation(
