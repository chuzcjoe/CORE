...
class ResourceViewPool : public NS::Referencing<ResourceViewPool> {
 public:
  ...
  ResourceID copyResourceViewsFromPool(const MTL::ResourceViewPool* sourcePool,
                                       NS::Range sourceRange, NS::UInteger destinationIndex);
...
_MTL_INLINE MTL::ResourceViewPoolDescriptor* MTL::ResourceViewPoolDescriptor::alloc() {
  return NS::Object::alloc<MTL::ResourceViewPoolDescriptor>(
      _MTL_PRIVATE_CLS(MTLResourceViewPoolDescriptor));
}
...
_MTL_INLINE void MTL::ResourceViewPoolDescriptor::setResourceViewCount(
    NS::UInteger resourceViewCount) {
...
_MTL_INLINE MTL::ResourceID MTL::ResourceViewPool::copyResourceViewsFromPool(
  ...
  return Object::sendMessage<MTL::ResourceID>(
      this, _MTL_PRIVATE_SEL(copyResourceViewsFromPool_sourceRange_destinationIndex_), sourcePool,
      sourceRange, destinationIndex);
}
