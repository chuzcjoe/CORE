...
class IndirectComputeCommand : public NS::Referencing<IndirectComputeCommand> {
 public:
  ...
  void concurrentDispatchThreadgroups(MTL::Size threadgroupsPerGrid,
  ...
  void setKernelBuffer(const MTL::Buffer* buffer, NS::UInteger offset, NS::UInteger stride,
                       NS::UInteger index);
...
_MTL_INLINE void MTL::IndirectRenderCommand::drawIndexedPatches(
  ...
  Object::sendMessage<void>(
      ...
      controlPointIndexBuffer, controlPointIndexBufferOffset, instanceCount, baseInstance, buffer,
      offset, instanceStride);
}

_MTL_INLINE void MTL::IndirectRenderCommand::drawIndexedPrimitives(
...
_MTL_INLINE void MTL::IndirectRenderCommand::drawMeshThreadgroups(
...
_MTL_INLINE void MTL::IndirectRenderCommand::drawPatches(
    NS::UInteger numberOfPatchControlPoints, NS::UInteger patchStart, NS::UInteger patchCount,
    const MTL::Buffer* patchIndexBuffer, NS::UInteger patchIndexBufferOffset,
    NS::UInteger instanceCount, NS::UInteger baseInstance, const MTL::Buffer* buffer,
    NS::UInteger offset, NS::UInteger instanceStride) {
  Object::sendMessage<void>(
      ...
      numberOfPatchControlPoints, patchStart, patchCount, patchIndexBuffer, patchIndexBufferOffset,
      instanceCount, baseInstance, buffer, offset, instanceStride);
}

_MTL_INLINE void MTL::IndirectRenderCommand::drawPrimitives(MTL::PrimitiveType primitiveType,
...
_MTL_INLINE void MTL::IndirectRenderCommand::setDepthBias(float depthBias, float slopeScale,
                                                          float clamp) {
...
_MTL_INLINE void MTL::IndirectRenderCommand::setDepthStencilState(
...
_MTL_INLINE void MTL::IndirectRenderCommand::setFragmentBuffer(const MTL::Buffer* buffer,
                                                               NS::UInteger offset,
                                                               NS::UInteger index) {
...
_MTL_INLINE void MTL::IndirectRenderCommand::setFrontFacingWinding(
    MTL::Winding frontFacingWindning) {
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setFrontFacingWinding_), frontFacingWindning);
}

_MTL_INLINE void MTL::IndirectRenderCommand::setMeshBuffer(const MTL::Buffer* buffer,
                                                           NS::UInteger offset,
                                                           NS::UInteger index) {
...
_MTL_INLINE void MTL::IndirectRenderCommand::setObjectBuffer(const MTL::Buffer* buffer,
                                                             NS::UInteger offset,
                                                             NS::UInteger index) {
...
_MTL_INLINE void MTL::IndirectRenderCommand::setObjectThreadgroupMemoryLength(NS::UInteger length,
                                                                              NS::UInteger index) {
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setObjectThreadgroupMemoryLength_atIndex_),
                            length, index);
}

_MTL_INLINE void MTL::IndirectRenderCommand::setRenderPipelineState(
...
_MTL_INLINE void MTL::IndirectRenderCommand::setVertexBuffer(const MTL::Buffer* buffer,
                                                             NS::UInteger offset,
                                                             NS::UInteger index) {
...
_MTL_INLINE void MTL::IndirectComputeCommand::concurrentDispatchThreads(
...
_MTL_INLINE void MTL::IndirectComputeCommand::setComputePipelineState(
    const MTL::ComputePipelineState* pipelineState) {
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setComputePipelineState_), pipelineState);
}

_MTL_INLINE void MTL::IndirectComputeCommand::setImageblockWidth(NS::UInteger width,
                                                                 NS::UInteger height) {
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setImageblockWidth_height_), width, height);
}

_MTL_INLINE void MTL::IndirectComputeCommand::setKernelBuffer(const MTL::Buffer* buffer,
                                                              NS::UInteger offset,
                                                              NS::UInteger index) {
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setKernelBuffer_offset_atIndex_), buffer, offset,
                            index);
}
...
_MTL_INLINE void MTL::IndirectComputeCommand::setKernelBuffer(const MTL::Buffer* buffer,
                                                              ...
                                                              NS::UInteger stride,
                                                              NS::UInteger index) {
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setKernelBuffer_offset_attributeStride_atIndex_),
                            buffer, offset, stride, index);
}
...
_MTL_INLINE void MTL::IndirectComputeCommand::setThreadgroupMemoryLength(NS::UInteger length,
                                                                         NS::UInteger index) {
