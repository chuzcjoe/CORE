...
namespace MTL4 {
class TileRenderPipelineDescriptor
    : public NS::Copying<TileRenderPipelineDescriptor, PipelineDescriptor> {
 public:
...
_MTL_INLINE MTL4::TileRenderPipelineDescriptor* MTL4::TileRenderPipelineDescriptor::alloc() {
  return NS::Object::alloc<MTL4::TileRenderPipelineDescriptor>(
      _MTL_PRIVATE_CLS(MTL4TileRenderPipelineDescriptor));
}
...
_MTL_INLINE void MTL4::TileRenderPipelineDescriptor::setRasterSampleCount(
...
_MTL_INLINE void MTL4::TileRenderPipelineDescriptor::setSupportBinaryLinking(
...
_MTL_INLINE void MTL4::TileRenderPipelineDescriptor::setTileFunctionDescriptor(
  ...
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setTileFunctionDescriptor_),
                            tileFunctionDescriptor);
}

_MTL_INLINE MTL4::StaticLinkingDescriptor*
MTL4::TileRenderPipelineDescriptor::staticLinkingDescriptor() const {
...
_MTL_INLINE MTL4::FunctionDescriptor* MTL4::TileRenderPipelineDescriptor::tileFunctionDescriptor()
    const {
  return Object::sendMessage<MTL4::FunctionDescriptor*>(this,
                                                        _MTL_PRIVATE_SEL(tileFunctionDescriptor));
}
