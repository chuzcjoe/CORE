...
MTL4::RenderPassDescriptor::colorAttachments() const {
...
_MTL_INLINE MTL::RenderPassDepthAttachmentDescriptor* MTL4::RenderPassDescriptor::depthAttachment()
    const {
  return Object::sendMessage<MTL::RenderPassDepthAttachmentDescriptor*>(
      this, _MTL_PRIVATE_SEL(depthAttachment));
}

_MTL_INLINE NS::UInteger MTL4::RenderPassDescriptor::getSamplePositions(
...
_MTL_INLINE void MTL4::RenderPassDescriptor::setImageblockSampleLength(
...
_MTL_INLINE void MTL4::RenderPassDescriptor::setRenderTargetHeight(
...
_MTL_INLINE void MTL4::RenderPassDescriptor::setSamplePositions(
    const MTL::SamplePosition* positions, NS::UInteger count) {
...
_MTL_INLINE void MTL4::RenderPassDescriptor::setVisibilityResultBuffer(
...
MTL4::RenderPassDescriptor::stencilAttachment() const {
