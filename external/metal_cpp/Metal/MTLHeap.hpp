...
class HeapDescriptor : public NS::Copying<HeapDescriptor> {
 public:
  ...
  void setMaxCompatiblePlacementSparsePageSize(
...
_MTL_INLINE MTL::SparsePageSize MTL::HeapDescriptor::maxCompatiblePlacementSparsePageSize() const {
  return Object::sendMessage<MTL::SparsePageSize>(
      this, _MTL_PRIVATE_SEL(maxCompatiblePlacementSparsePageSize));
}
...
_MTL_INLINE void MTL::HeapDescriptor::setHazardTrackingMode(
...
_MTL_INLINE NS::UInteger MTL::Heap::maxAvailableSize(NS::UInteger alignment) {
  return Object::sendMessage<NS::UInteger>(this, _MTL_PRIVATE_SEL(maxAvailableSizeWithAlignment_),
                                           alignment);
}
...
_MTL_INLINE MTL::PurgeableState MTL::Heap::setPurgeableState(MTL::PurgeableState state) {
  return Object::sendMessage<MTL::PurgeableState>(this, _MTL_PRIVATE_SEL(setPurgeableState_),
                                                  state);
}
