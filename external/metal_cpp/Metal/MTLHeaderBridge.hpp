...
_MTL_PRIVATE_DEF_SEL(accelerationStructureCommandEncoder, "accelerationStructureCommandEncoder");
_MTL_PRIVATE_DEF_SEL(accelerationStructureCommandEncoderWithDescriptor_,
                     "accelerationStructureCommandEncoderWithDescriptor:");
_MTL_PRIVATE_DEF_SEL(accelerationStructurePassDescriptor, "accelerationStructurePassDescriptor");
...
_MTL_PRIVATE_DEF_SEL(addAllocation_, "addAllocation:");
_MTL_PRIVATE_DEF_SEL(addAllocations_count_, "addAllocations:count:");
...
_MTL_PRIVATE_DEF_SEL(addFeedbackHandler_, "addFeedbackHandler:");
_MTL_PRIVATE_DEF_SEL(addFunctionWithDescriptor_library_error_,
                     "addFunctionWithDescriptor:library:error:");
_MTL_PRIVATE_DEF_SEL(addLibraryWithDescriptor_error_, "addLibraryWithDescriptor:error:");
_MTL_PRIVATE_DEF_SEL(addLogHandler_, "addLogHandler:");
...
_MTL_PRIVATE_DEF_SEL(addResidencySet_, "addResidencySet:");
_MTL_PRIVATE_DEF_SEL(addResidencySets_count_, "addResidencySets:count:");
...
_MTL_PRIVATE_DEF_SEL(allAllocations, "allAllocations");
_MTL_PRIVATE_DEF_SEL(allocatedSize, "allocatedSize");
_MTL_PRIVATE_DEF_SEL(allocationCount, "allocationCount");
...
_MTL_PRIVATE_DEF_SEL(allowReferencingUndefinedSymbols, "allowReferencingUndefinedSymbols");
_MTL_PRIVATE_DEF_SEL(alphaBlendOperation, "alphaBlendOperation");
_MTL_PRIVATE_DEF_SEL(alphaToCoverageState, "alphaToCoverageState");
_MTL_PRIVATE_DEF_SEL(alphaToOneState, "alphaToOneState");
_MTL_PRIVATE_DEF_SEL(architecture, "architecture");
_MTL_PRIVATE_DEF_SEL(areBarycentricCoordsSupported, "areBarycentricCoordsSupported");
_MTL_PRIVATE_DEF_SEL(areProgrammableSamplePositionsSupported,
                     "areProgrammableSamplePositionsSupported");
_MTL_PRIVATE_DEF_SEL(areRasterOrderGroupsSupported, "areRasterOrderGroupsSupported");
...
_MTL_PRIVATE_DEF_SEL(baseResourceID, "baseResourceID");
_MTL_PRIVATE_DEF_SEL(beginCommandBufferWithAllocator_, "beginCommandBufferWithAllocator:");
...
_MTL_PRIVATE_DEF_SEL(blitCommandEncoderWithDescriptor_, "blitCommandEncoderWithDescriptor:");
...
_MTL_PRIVATE_DEF_SEL(bufferSize, "bufferSize");
...
_MTL_PRIVATE_DEF_SEL(colorAttachmentMappingState, "colorAttachmentMappingState");
...
_MTL_PRIVATE_DEF_SEL(commandBufferWithDescriptor_, "commandBufferWithDescriptor:");
...
_MTL_PRIVATE_DEF_SEL(configuration, "configuration");
...
_MTL_PRIVATE_DEF_SEL(containsAllocation_, "containsAllocation:");
...
_MTL_PRIVATE_DEF_SEL(
    ...
    "copyFromTensor:sourceOrigin:sourceDimensions:toTensor:destinationOrigin:"
...
_MTL_PRIVATE_DEF_SEL(
    ...
    "copyFromTexture:sourceSlice:sourceLevel:toTexture:destinationSlice:destinationLevel:"
...
_MTL_PRIVATE_DEF_SEL(copyParameterDataToBuffer_offset_, "copyParameterDataToBuffer:offset:");
...
_MTL_PRIVATE_DEF_SEL(count, "count");
...
_MTL_PRIVATE_DEF_SEL(destinationAlphaBlendFactor, "destinationAlphaBlendFactor");
...
_MTL_PRIVATE_DEF_SEL(dimensions, "dimensions");
...
_MTL_PRIVATE_DEF_SEL(dispatchThreadsWithIndirectBuffer_, "dispatchThreadsWithIndirectBuffer:");
...
_MTL_PRIVATE_DEF_SEL(
    ...
    "drawIndexedPatches:patchIndexBuffer:patchIndexBufferOffset:controlPointIndexBuffer:"
...
_MTL_PRIVATE_DEF_SEL(
    ...
    "drawIndexedPatches:patchStart:patchCount:patchIndexBuffer:patchIndexBufferOffset:"
...
_MTL_PRIVATE_DEF_SEL(
    drawIndexedPrimitives_indexCount_indexType_indexBuffer_indexBufferLength_instanceCount_,
...
_MTL_PRIVATE_DEF_SEL(
    ...
    "baseVertex:baseInstance:");
_MTL_PRIVATE_DEF_SEL(
    drawIndexedPrimitives_indexType_indexBuffer_indexBufferLength_indirectBuffer_,
...
_MTL_PRIVATE_DEF_SEL(
    ...
    "drawMeshThreadgroupsWithIndirectBuffer:indirectBufferOffset:threadsPerObjectThreadgroup:"
    "threadsPerMeshThreadgroup:");
_MTL_PRIVATE_DEF_SEL(
    drawMeshThreadgroupsWithIndirectBuffer_threadsPerObjectThreadgroup_threadsPerMeshThreadgroup_,
    "drawMeshThreadgroupsWithIndirectBuffer:threadsPerObjectThreadgroup:"
    "threadsPerMeshThreadgroup:");
...
_MTL_PRIVATE_DEF_SEL(
    ...
    "drawPatches:patchStart:patchCount:patchIndexBuffer:patchIndexBufferOffset:instanceCount:"
    "baseInstance:");
_MTL_PRIVATE_DEF_SEL(
    ...
    "drawPatches:patchStart:patchCount:patchIndexBuffer:patchIndexBufferOffset:instanceCount:"
    "baseInstance:tessellationFactorBuffer:tessellationFactorBufferOffset:"
    "tessellationFactorBufferInstanceStride:");
_MTL_PRIVATE_DEF_SEL(drawPrimitives_indirectBuffer_, "drawPrimitives:indirectBuffer:");
...
_MTL_PRIVATE_DEF_SEL(elementTensorReferenceType, "elementTensorReferenceType");
_MTL_PRIVATE_DEF_SEL(elementTextureReferenceType, "elementTextureReferenceType");
_MTL_PRIVATE_DEF_SEL(elementType, "elementType");
_MTL_PRIVATE_DEF_SEL(enableLogging, "enableLogging");
...
_MTL_PRIVATE_DEF_SEL(endCommandBuffer, "endCommandBuffer");
...
_MTL_PRIVATE_DEF_SEL(endResidency, "endResidency");
...
_MTL_PRIVATE_DEF_SEL(executeCommandsInBuffer_withRange_, "executeCommandsInBuffer:withRange:");
_MTL_PRIVATE_DEF_SEL(extentAtDimensionIndex_, "extentAtDimensionIndex:");
_MTL_PRIVATE_DEF_SEL(fastMathEnabled, "fastMathEnabled");
_MTL_PRIVATE_DEF_SEL(feedbackQueue, "feedbackQueue");
...
_MTL_PRIVATE_DEF_SEL(fragmentAdditionalBinaryFunctions, "fragmentAdditionalBinaryFunctions");
...
_MTL_PRIVATE_DEF_SEL(fragmentFunctionDescriptor, "fragmentFunctionDescriptor");
_MTL_PRIVATE_DEF_SEL(fragmentLinkedFunctions, "fragmentLinkedFunctions");
_MTL_PRIVATE_DEF_SEL(fragmentLinkingDescriptor, "fragmentLinkingDescriptor");
_MTL_PRIVATE_DEF_SEL(fragmentPreloadedLibraries, "fragmentPreloadedLibraries");
_MTL_PRIVATE_DEF_SEL(fragmentStaticLinkingDescriptor, "fragmentStaticLinkingDescriptor");
_MTL_PRIVATE_DEF_SEL(frontFaceStencil, "frontFaceStencil");
_MTL_PRIVATE_DEF_SEL(function, "function");
_MTL_PRIVATE_DEF_SEL(functionConstantsDictionary, "functionConstantsDictionary");
_MTL_PRIVATE_DEF_SEL(functionCount, "functionCount");
_MTL_PRIVATE_DEF_SEL(functionDescriptor, "functionDescriptor");
_MTL_PRIVATE_DEF_SEL(functionDescriptors, "functionDescriptors");
_MTL_PRIVATE_DEF_SEL(functionGraph, "functionGraph");
_MTL_PRIVATE_DEF_SEL(functionGraphs, "functionGraphs");
_MTL_PRIVATE_DEF_SEL(functionHandleWithBinaryFunction_, "functionHandleWithBinaryFunction:");
_MTL_PRIVATE_DEF_SEL(functionHandleWithBinaryFunction_stage_,
                     "functionHandleWithBinaryFunction:stage:");
_MTL_PRIVATE_DEF_SEL(functionHandleWithFunction_, "functionHandleWithFunction:");
_MTL_PRIVATE_DEF_SEL(functionHandleWithFunction_stage_, "functionHandleWithFunction:stage:");
_MTL_PRIVATE_DEF_SEL(functionHandleWithName_, "functionHandleWithName:");
_MTL_PRIVATE_DEF_SEL(functionHandleWithName_stage_, "functionHandleWithName:stage:");
...
_MTL_PRIVATE_DEF_SEL(getDefaultSamplePositions_count_, "getDefaultSamplePositions:count:");
_MTL_PRIVATE_DEF_SEL(getPhysicalIndexForLogicalIndex_, "getPhysicalIndexForLogicalIndex:");
...
_MTL_PRIVATE_DEF_SEL(
    ...
    "getTextureAccessCounters:region:mipLevel:slice:resetCounters:countersBuffer:"
...
_MTL_PRIVATE_DEF_SEL(imageblockMemoryLengthForDimensions_, "imageblockMemoryLengthForDimensions:");
...
_MTL_PRIVATE_DEF_SEL(indirectComputeCommandAtIndex_, "indirectComputeCommandAtIndex:");
_MTL_PRIVATE_DEF_SEL(indirectRenderCommandAtIndex_, "indirectRenderCommandAtIndex:");
_MTL_PRIVATE_DEF_SEL(inheritBuffers, "inheritBuffers");
_MTL_PRIVATE_DEF_SEL(inheritCullMode, "inheritCullMode");
_MTL_PRIVATE_DEF_SEL(inheritDepthBias, "inheritDepthBias");
_MTL_PRIVATE_DEF_SEL(inheritDepthClipMode, "inheritDepthClipMode");
_MTL_PRIVATE_DEF_SEL(inheritDepthStencilState, "inheritDepthStencilState");
_MTL_PRIVATE_DEF_SEL(inheritFrontFacingWinding, "inheritFrontFacingWinding");
_MTL_PRIVATE_DEF_SEL(inheritPipelineState, "inheritPipelineState");
_MTL_PRIVATE_DEF_SEL(inheritTriangleFillMode, "inheritTriangleFillMode");
...
_MTL_PRIVATE_DEF_SEL(initWithRank_values_, "initWithRank:values:");
...
_MTL_PRIVATE_DEF_SEL(initialCapacity, "initialCapacity");
_MTL_PRIVATE_DEF_SEL(initializeBindings, "initializeBindings");
_MTL_PRIVATE_DEF_SEL(inputDimensionsAtBufferIndex_, "inputDimensionsAtBufferIndex:");
...
_MTL_PRIVATE_DEF_SEL(instanceDescriptorBufferOffset, "instanceDescriptorBufferOffset");
...
_MTL_PRIVATE_DEF_SEL(instanceTransformationMatrixLayout, "instanceTransformationMatrixLayout");
_MTL_PRIVATE_DEF_SEL(instancedAccelerationStructures, "instancedAccelerationStructures");
_MTL_PRIVATE_DEF_SEL(intermediatesHeapSize, "intermediatesHeapSize");
_MTL_PRIVATE_DEF_SEL(intersectionFunctionTableDescriptor, "intersectionFunctionTableDescriptor");
_MTL_PRIVATE_DEF_SEL(intersectionFunctionTableOffset, "intersectionFunctionTableOffset");
_MTL_PRIVATE_DEF_SEL(invalidateCounterRange_, "invalidateCounterRange:");
...
_MTL_PRIVATE_DEF_SEL(isTessellationFactorScaleEnabled, "isTessellationFactorScaleEnabled");
...
_MTL_PRIVATE_DEF_SEL(levelRange, "levelRange");
_MTL_PRIVATE_DEF_SEL(libraries, "libraries");
_MTL_PRIVATE_DEF_SEL(library, "library");
...
_MTL_PRIVATE_DEF_SEL(
    ...
    "loadTexture:slice:level:size:sourceBytesPerRow:sourceBytesPerImage:destinationOrigin:"
...
_MTL_PRIVATE_DEF_SEL(lodBias, "lodBias");
_MTL_PRIVATE_DEF_SEL(lodMaxClamp, "lodMaxClamp");
_MTL_PRIVATE_DEF_SEL(lodMinClamp, "lodMinClamp");
_MTL_PRIVATE_DEF_SEL(logState, "logState");
_MTL_PRIVATE_DEF_SEL(logs, "logs");
_MTL_PRIVATE_DEF_SEL(lookupArchives, "lookupArchives");
_MTL_PRIVATE_DEF_SEL(machineLearningCommandEncoder, "machineLearningCommandEncoder");
_MTL_PRIVATE_DEF_SEL(machineLearningFunctionDescriptor, "machineLearningFunctionDescriptor");
...
_MTL_PRIVATE_DEF_SEL(mathFloatingPointFunctions, "mathFloatingPointFunctions");
_MTL_PRIVATE_DEF_SEL(mathMode, "mathMode");
_MTL_PRIVATE_DEF_SEL(maxAnisotropy, "maxAnisotropy");
_MTL_PRIVATE_DEF_SEL(maxArgumentBufferSamplerCount, "maxArgumentBufferSamplerCount");
_MTL_PRIVATE_DEF_SEL(maxAvailableSizeWithAlignment_, "maxAvailableSizeWithAlignment:");
_MTL_PRIVATE_DEF_SEL(maxBufferBindCount, "maxBufferBindCount");
...
_MTL_PRIVATE_DEF_SEL(maxCompatiblePlacementSparsePageSize, "maxCompatiblePlacementSparsePageSize");
...
_MTL_PRIVATE_DEF_SEL(maxKernelThreadgroupMemoryBindCount, "maxKernelThreadgroupMemoryBindCount");
...
_MTL_PRIVATE_DEF_SEL(maxObjectThreadgroupMemoryBindCount, "maxObjectThreadgroupMemoryBindCount");
_MTL_PRIVATE_DEF_SEL(maxSampleCount, "maxSampleCount");
_MTL_PRIVATE_DEF_SEL(maxSamplerStateBindCount, "maxSamplerStateBindCount");
_MTL_PRIVATE_DEF_SEL(maxTessellationFactor, "maxTessellationFactor");
_MTL_PRIVATE_DEF_SEL(maxTextureBindCount, "maxTextureBindCount");
...
_MTL_PRIVATE_DEF_SEL(maxTotalThreadgroupsPerMeshGrid, "maxTotalThreadgroupsPerMeshGrid");
_MTL_PRIVATE_DEF_SEL(maxTotalThreadsPerMeshThreadgroup, "maxTotalThreadsPerMeshThreadgroup");
_MTL_PRIVATE_DEF_SEL(maxTotalThreadsPerObjectThreadgroup, "maxTotalThreadsPerObjectThreadgroup");
_MTL_PRIVATE_DEF_SEL(maxTotalThreadsPerThreadgroup, "maxTotalThreadsPerThreadgroup");
_MTL_PRIVATE_DEF_SEL(maxTransferRate, "maxTransferRate");
_MTL_PRIVATE_DEF_SEL(maxVertexAmplificationCount, "maxVertexAmplificationCount");
...
_MTL_PRIVATE_DEF_SEL(memoryBarrierWithResources_count_, "memoryBarrierWithResources:count:");
...
_MTL_PRIVATE_DEF_SEL(meshAdditionalBinaryFunctions, "meshAdditionalBinaryFunctions");
...
_MTL_PRIVATE_DEF_SEL(meshFunctionDescriptor, "meshFunctionDescriptor");
_MTL_PRIVATE_DEF_SEL(meshLinkedFunctions, "meshLinkedFunctions");
_MTL_PRIVATE_DEF_SEL(meshLinkingDescriptor, "meshLinkingDescriptor");
_MTL_PRIVATE_DEF_SEL(meshStaticLinkingDescriptor, "meshStaticLinkingDescriptor");
...
_MTL_PRIVATE_DEF_SEL(motionTransformBufferOffset, "motionTransformBufferOffset");
...
_MTL_PRIVATE_DEF_SEL(motionTransformCountBufferOffset, "motionTransformCountBufferOffset");
_MTL_PRIVATE_DEF_SEL(motionTransformStride, "motionTransformStride");
_MTL_PRIVATE_DEF_SEL(motionTransformType, "motionTransformType");
_MTL_PRIVATE_DEF_SEL(
    ...
    "moveTextureMappingsFromTexture:sourceSlice:sourceLevel:sourceOrigin:sourceSize:toTexture:"
    "destinationSlice:destinationLevel:destinationOrigin:");
...
_MTL_PRIVATE_DEF_SEL(newArchiveWithURL_error_, "newArchiveWithURL:error:");
_MTL_PRIVATE_DEF_SEL(newArgumentEncoderForBufferAtIndex_, "newArgumentEncoderForBufferAtIndex:");
_MTL_PRIVATE_DEF_SEL(newArgumentEncoderWithArguments_, "newArgumentEncoderWithArguments:");
_MTL_PRIVATE_DEF_SEL(newArgumentEncoderWithBufferBinding_, "newArgumentEncoderWithBufferBinding:");
_MTL_PRIVATE_DEF_SEL(newArgumentEncoderWithBufferIndex_, "newArgumentEncoderWithBufferIndex:");
...
_MTL_PRIVATE_DEF_SEL(newBufferWithBytes_length_options_, "newBufferWithBytes:length:options:");
...
_MTL_PRIVATE_DEF_SEL(newBufferWithLength_options_offset_, "newBufferWithLength:options:offset:");
...
_MTL_PRIVATE_DEF_SEL(newCaptureScopeWithCommandQueue_, "newCaptureScopeWithCommandQueue:");
_MTL_PRIVATE_DEF_SEL(newCaptureScopeWithDevice_, "newCaptureScopeWithDevice:");
_MTL_PRIVATE_DEF_SEL(newCaptureScopeWithMTL4CommandQueue_, "newCaptureScopeWithMTL4CommandQueue:");
_MTL_PRIVATE_DEF_SEL(newCommandAllocator, "newCommandAllocator");
_MTL_PRIVATE_DEF_SEL(newCommandAllocatorWithDescriptor_error_,
                     "newCommandAllocatorWithDescriptor:error:");
_MTL_PRIVATE_DEF_SEL(newCommandBuffer, "newCommandBuffer");
_MTL_PRIVATE_DEF_SEL(newCommandQueue, "newCommandQueue");
_MTL_PRIVATE_DEF_SEL(newCommandQueueWithDescriptor_, "newCommandQueueWithDescriptor:");
_MTL_PRIVATE_DEF_SEL(newCommandQueueWithMaxCommandBufferCount_,
                     "newCommandQueueWithMaxCommandBufferCount:");
_MTL_PRIVATE_DEF_SEL(newCompilerWithDescriptor_error_, "newCompilerWithDescriptor:error:");
...
_MTL_PRIVATE_DEF_SEL(
    ...
    "newComputePipelineStateWithDescriptor:dynamicLinkingDescriptor:compilerTaskOptions:"
    "completionHandler:");
_MTL_PRIVATE_DEF_SEL(
...
_MTL_PRIVATE_DEF_SEL(newCounterHeapWithDescriptor_error_, "newCounterHeapWithDescriptor:error:");
...
_MTL_PRIVATE_DEF_SEL(newDefaultLibraryWithBundle_error_, "newDefaultLibraryWithBundle:error:");
_MTL_PRIVATE_DEF_SEL(newDepthStencilStateWithDescriptor_, "newDepthStencilStateWithDescriptor:");
_MTL_PRIVATE_DEF_SEL(newDynamicLibrary_completionHandler_, "newDynamicLibrary:completionHandler:");
...
_MTL_PRIVATE_DEF_SEL(newDynamicLibraryWithURL_error_, "newDynamicLibraryWithURL:error:");
...
_MTL_PRIVATE_DEF_SEL(newFunctionWithDescriptor_error_, "newFunctionWithDescriptor:error:");
...
_MTL_PRIVATE_DEF_SEL(newIOFileHandleWithURL_error_, "newIOFileHandleWithURL:error:");
...
_MTL_PRIVATE_DEF_SEL(newLibraryWithDescriptor_error_, "newLibraryWithDescriptor:error:");
...
_MTL_PRIVATE_DEF_SEL(newLibraryWithSource_options_error_, "newLibraryWithSource:options:error:");
...
_MTL_PRIVATE_DEF_SEL(newLogStateWithDescriptor_error_, "newLogStateWithDescriptor:error:");
...
_MTL_PRIVATE_DEF_SEL(newRemoteBufferViewForDevice_, "newRemoteBufferViewForDevice:");
_MTL_PRIVATE_DEF_SEL(newRemoteTextureViewForDevice_, "newRemoteTextureViewForDevice:");
...
_MTL_PRIVATE_DEF_SEL(
    ...
    "newRenderPipelineStateWithDescriptor:dynamicLinkingDescriptor:compilerTaskOptions:"
    "completionHandler:");
_MTL_PRIVATE_DEF_SEL(
...
_MTL_PRIVATE_DEF_SEL(newResidencySetWithDescriptor_error_, "newResidencySetWithDescriptor:error:");
_MTL_PRIVATE_DEF_SEL(newSamplerStateWithDescriptor_, "newSamplerStateWithDescriptor:");
_MTL_PRIVATE_DEF_SEL(newScratchBufferWithMinimumSize_, "newScratchBufferWithMinimumSize:");
...
_MTL_PRIVATE_DEF_SEL(newSharedTextureWithDescriptor_, "newSharedTextureWithDescriptor:");
_MTL_PRIVATE_DEF_SEL(newSharedTextureWithHandle_, "newSharedTextureWithHandle:");
_MTL_PRIVATE_DEF_SEL(newTensorWithDescriptor_error_, "newTensorWithDescriptor:error:");
...
_MTL_PRIVATE_DEF_SEL(newTextureViewWithDescriptor_, "newTextureViewWithDescriptor:");
_MTL_PRIVATE_DEF_SEL(newTextureViewWithPixelFormat_, "newTextureViewWithPixelFormat:");
...
_MTL_PRIVATE_DEF_SEL(newTextureWithDescriptor_offset_, "newTextureWithDescriptor:offset:");
...
_MTL_PRIVATE_DEF_SEL(notifyListener_atValue_block_, "notifyListener:atValue:block:");
_MTL_PRIVATE_DEF_SEL(objectAdditionalBinaryFunctions, "objectAdditionalBinaryFunctions");
...
_MTL_PRIVATE_DEF_SEL(objectFunctionDescriptor, "objectFunctionDescriptor");
_MTL_PRIVATE_DEF_SEL(objectLinkedFunctions, "objectLinkedFunctions");
_MTL_PRIVATE_DEF_SEL(objectLinkingDescriptor, "objectLinkingDescriptor");
...
_MTL_PRIVATE_DEF_SEL(objectStaticLinkingDescriptor, "objectStaticLinkingDescriptor");
...
_MTL_PRIVATE_DEF_SEL(optimizeContentsForCPUAccess_, "optimizeContentsForCPUAccess:");
_MTL_PRIVATE_DEF_SEL(optimizeContentsForCPUAccess_slice_level_,
                     "optimizeContentsForCPUAccess:slice:level:");
_MTL_PRIVATE_DEF_SEL(optimizeContentsForGPUAccess_, "optimizeContentsForGPUAccess:");
...
_MTL_PRIVATE_DEF_SEL(parameterBufferSizeAndAlign, "parameterBufferSizeAndAlign");
...
_MTL_PRIVATE_DEF_SEL(placementSparsePageSize, "placementSparsePageSize");
...
_MTL_PRIVATE_DEF_SEL(presentAfterMinimumDuration_, "presentAfterMinimumDuration:");
...
_MTL_PRIVATE_DEF_SEL(privateFunctionDescriptors, "privateFunctionDescriptors");
_MTL_PRIVATE_DEF_SEL(privateFunctions, "privateFunctions");
_MTL_PRIVATE_DEF_SEL(pushDebugGroup_, "pushDebugGroup:");
_MTL_PRIVATE_DEF_SEL(queryTimestampFrequency, "queryTimestampFrequency");
...
_MTL_PRIVATE_DEF_SEL(rank, "rank");
...
_MTL_PRIVATE_DEF_SEL(recommendedMaxWorkingSetSize, "recommendedMaxWorkingSetSize");
_MTL_PRIVATE_DEF_SEL(reductionMode, "reductionMode");
...
_MTL_PRIVATE_DEF_SEL(reflection, "reflection");
_MTL_PRIVATE_DEF_SEL(reflectionForFunctionWithName_, "reflectionForFunctionWithName:");
...
_MTL_PRIVATE_DEF_SEL(removeAllAllocations, "removeAllAllocations");
_MTL_PRIVATE_DEF_SEL(removeAllDebugMarkers, "removeAllDebugMarkers");
_MTL_PRIVATE_DEF_SEL(removeAllocation_, "removeAllocation:");
_MTL_PRIVATE_DEF_SEL(removeAllocations_count_, "removeAllocations:count:");
_MTL_PRIVATE_DEF_SEL(removeResidencySet_, "removeResidencySet:");
_MTL_PRIVATE_DEF_SEL(removeResidencySets_count_, "removeResidencySets:count:");
_MTL_PRIVATE_DEF_SEL(renderCommandEncoder, "renderCommandEncoder");
_MTL_PRIVATE_DEF_SEL(renderCommandEncoderWithDescriptor_, "renderCommandEncoderWithDescriptor:");
...
_MTL_PRIVATE_DEF_SEL(requestResidency, "requestResidency");
_MTL_PRIVATE_DEF_SEL(required, "required");
_MTL_PRIVATE_DEF_SEL(requiredThreadsPerMeshThreadgroup, "requiredThreadsPerMeshThreadgroup");
_MTL_PRIVATE_DEF_SEL(requiredThreadsPerObjectThreadgroup, "requiredThreadsPerObjectThreadgroup");
_MTL_PRIVATE_DEF_SEL(requiredThreadsPerThreadgroup, "requiredThreadsPerThreadgroup");
_MTL_PRIVATE_DEF_SEL(requiredThreadsPerTileThreadgroup, "requiredThreadsPerTileThreadgroup");
_MTL_PRIVATE_DEF_SEL(reset, "reset");
_MTL_PRIVATE_DEF_SEL(resetCommandsInBuffer_withRange_, "resetCommandsInBuffer:withRange:");
...
_MTL_PRIVATE_DEF_SEL(resourceStateCommandEncoder, "resourceStateCommandEncoder");
_MTL_PRIVATE_DEF_SEL(resourceStateCommandEncoderWithDescriptor_,
                     "resourceStateCommandEncoderWithDescriptor:");
_MTL_PRIVATE_DEF_SEL(resourceStatePassDescriptor, "resourceStatePassDescriptor");
_MTL_PRIVATE_DEF_SEL(resourceViewCount, "resourceViewCount");
...
_MTL_PRIVATE_DEF_SEL(sampleTimestamps_gpuTimestamp_, "sampleTimestamps:gpuTimestamp:");
...
_MTL_PRIVATE_DEF_SEL(serializeAsPipelinesScriptWithError_, "serializeAsPipelinesScriptWithError:");
...
_MTL_PRIVATE_DEF_SEL(setAccelerationStructure_atIndex_, "setAccelerationStructure:atIndex:");
_MTL_PRIVATE_DEF_SEL(setAccess_, "setAccess:");
_MTL_PRIVATE_DEF_SEL(setAddress_atIndex_, "setAddress:atIndex:");
_MTL_PRIVATE_DEF_SEL(setAddress_attributeStride_atIndex_, "setAddress:attributeStride:atIndex:");
_MTL_PRIVATE_DEF_SEL(setAllowDuplicateIntersectionFunctionInvocation_,
                     "setAllowDuplicateIntersectionFunctionInvocation:");
_MTL_PRIVATE_DEF_SEL(setAllowGPUOptimizedContents_, "setAllowGPUOptimizedContents:");
_MTL_PRIVATE_DEF_SEL(setAllowReferencingUndefinedSymbols_, "setAllowReferencingUndefinedSymbols:");
...
_MTL_PRIVATE_DEF_SEL(setAlphaToCoverageState_, "setAlphaToCoverageState:");
_MTL_PRIVATE_DEF_SEL(setAlphaToOneEnabled_, "setAlphaToOneEnabled:");
_MTL_PRIVATE_DEF_SEL(setAlphaToOneState_, "setAlphaToOneState:");
...
_MTL_PRIVATE_DEF_SEL(setArgumentTable_, "setArgumentTable:");
_MTL_PRIVATE_DEF_SEL(setArgumentTable_atStages_, "setArgumentTable:atStages:");
...
_MTL_PRIVATE_DEF_SEL(setBinaryLinkedFunctions_, "setBinaryLinkedFunctions:");
_MTL_PRIVATE_DEF_SEL(setBlendColorRed_green_blue_alpha_, "setBlendColorRed:green:blue:alpha:");
_MTL_PRIVATE_DEF_SEL(setBlendingEnabled_, "setBlendingEnabled:");
_MTL_PRIVATE_DEF_SEL(setBlendingState_, "setBlendingState:");
_MTL_PRIVATE_DEF_SEL(setBorderColor_, "setBorderColor:");
_MTL_PRIVATE_DEF_SEL(setBoundingBoxBuffer_, "setBoundingBoxBuffer:");
_MTL_PRIVATE_DEF_SEL(setBoundingBoxBufferOffset_, "setBoundingBoxBufferOffset:");
...
_MTL_PRIVATE_DEF_SEL(setBufferSize_, "setBufferSize:");
_MTL_PRIVATE_DEF_SEL(setBuffers_offsets_attributeStrides_withRange_,
                     "setBuffers:offsets:attributeStrides:withRange:");
_MTL_PRIVATE_DEF_SEL(setBuffers_offsets_withRange_, "setBuffers:offsets:withRange:");
...
_MTL_PRIVATE_DEF_SEL(setColorAttachmentMap_, "setColorAttachmentMap:");
_MTL_PRIVATE_DEF_SEL(setColorAttachmentMappingState_, "setColorAttachmentMappingState:");
_MTL_PRIVATE_DEF_SEL(setColorStoreAction_atIndex_, "setColorStoreAction:atIndex:");
_MTL_PRIVATE_DEF_SEL(setColorStoreActionOptions_atIndex_, "setColorStoreActionOptions:atIndex:");
_MTL_PRIVATE_DEF_SEL(setCommandTypes_, "setCommandTypes:");
_MTL_PRIVATE_DEF_SEL(setCompareFunction_, "setCompareFunction:");
_MTL_PRIVATE_DEF_SEL(setCompileSymbolVisibility_, "setCompileSymbolVisibility:");
_MTL_PRIVATE_DEF_SEL(setCompressionType_, "setCompressionType:");
_MTL_PRIVATE_DEF_SEL(setComputeFunction_, "setComputeFunction:");
_MTL_PRIVATE_DEF_SEL(setComputeFunctionDescriptor_, "setComputeFunctionDescriptor:");
_MTL_PRIVATE_DEF_SEL(setComputePipelineState_, "setComputePipelineState:");
_MTL_PRIVATE_DEF_SEL(setComputePipelineState_atIndex_, "setComputePipelineState:atIndex:");
_MTL_PRIVATE_DEF_SEL(setComputePipelineStates_withRange_, "setComputePipelineStates:withRange:");
_MTL_PRIVATE_DEF_SEL(setConfiguration_, "setConfiguration:");
_MTL_PRIVATE_DEF_SEL(setConstantBlockAlignment_, "setConstantBlockAlignment:");
_MTL_PRIVATE_DEF_SEL(setConstantValue_type_atIndex_, "setConstantValue:type:atIndex:");
_MTL_PRIVATE_DEF_SEL(setConstantValue_type_withName_, "setConstantValue:type:withName:");
_MTL_PRIVATE_DEF_SEL(setConstantValues_, "setConstantValues:");
_MTL_PRIVATE_DEF_SEL(setConstantValues_type_withRange_, "setConstantValues:type:withRange:");
...
_MTL_PRIVATE_DEF_SEL(setControlPointBufferOffset_, "setControlPointBufferOffset:");
...
_MTL_PRIVATE_DEF_SEL(setCount_, "setCount:");
...
_MTL_PRIVATE_DEF_SEL(setDefaultRasterSampleCount_, "setDefaultRasterSampleCount:");
_MTL_PRIVATE_DEF_SEL(setDepth_, "setDepth:");
_MTL_PRIVATE_DEF_SEL(setDepthAttachment_, "setDepthAttachment:");
_MTL_PRIVATE_DEF_SEL(setDepthAttachmentPixelFormat_, "setDepthAttachmentPixelFormat:");
_MTL_PRIVATE_DEF_SEL(setDepthBias_slopeScale_clamp_, "setDepthBias:slopeScale:clamp:");
...
_MTL_PRIVATE_DEF_SEL(setDepthStencilPassOperation_, "setDepthStencilPassOperation:");
_MTL_PRIVATE_DEF_SEL(setDepthStencilState_, "setDepthStencilState:");
_MTL_PRIVATE_DEF_SEL(setDepthStencilState_atIndex_, "setDepthStencilState:atIndex:");
_MTL_PRIVATE_DEF_SEL(setDepthStencilStates_withRange_, "setDepthStencilStates:withRange:");
_MTL_PRIVATE_DEF_SEL(setDepthStoreAction_, "setDepthStoreAction:");
_MTL_PRIVATE_DEF_SEL(setDepthStoreActionOptions_, "setDepthStoreActionOptions:");
_MTL_PRIVATE_DEF_SEL(setDepthTestMinBound_maxBound_, "setDepthTestMinBound:maxBound:");
_MTL_PRIVATE_DEF_SEL(setDepthWriteEnabled_, "setDepthWriteEnabled:");
_MTL_PRIVATE_DEF_SEL(setDestination_, "setDestination:");
_MTL_PRIVATE_DEF_SEL(setDestinationAlphaBlendFactor_, "setDestinationAlphaBlendFactor:");
_MTL_PRIVATE_DEF_SEL(setDestinationRGBBlendFactor_, "setDestinationRGBBlendFactor:");
_MTL_PRIVATE_DEF_SEL(setDimensions_, "setDimensions:");
_MTL_PRIVATE_DEF_SEL(setDispatchType_, "setDispatchType:");
_MTL_PRIVATE_DEF_SEL(setEnableLogging_, "setEnableLogging:");
_MTL_PRIVATE_DEF_SEL(setEndOfEncoderSampleIndex_, "setEndOfEncoderSampleIndex:");
_MTL_PRIVATE_DEF_SEL(setEndOfFragmentSampleIndex_, "setEndOfFragmentSampleIndex:");
...
_MTL_PRIVATE_DEF_SEL(setFeedbackQueue_, "setFeedbackQueue:");
...
_MTL_PRIVATE_DEF_SEL(setFragmentBuffer_offset_atIndex_, "setFragmentBuffer:offset:atIndex:");
_MTL_PRIVATE_DEF_SEL(setFragmentBufferOffset_atIndex_, "setFragmentBufferOffset:atIndex:");
_MTL_PRIVATE_DEF_SEL(setFragmentBuffers_offsets_withRange_,
                     "setFragmentBuffers:offsets:withRange:");
_MTL_PRIVATE_DEF_SEL(setFragmentBytes_length_atIndex_, "setFragmentBytes:length:atIndex:");
_MTL_PRIVATE_DEF_SEL(setFragmentFunction_, "setFragmentFunction:");
_MTL_PRIVATE_DEF_SEL(setFragmentFunctionDescriptor_, "setFragmentFunctionDescriptor:");
...
_MTL_PRIVATE_DEF_SEL(setFragmentLinkedFunctions_, "setFragmentLinkedFunctions:");
_MTL_PRIVATE_DEF_SEL(setFragmentPreloadedLibraries_, "setFragmentPreloadedLibraries:");
_MTL_PRIVATE_DEF_SEL(setFragmentSamplerState_atIndex_, "setFragmentSamplerState:atIndex:");
...
_MTL_PRIVATE_DEF_SEL(setFragmentSamplerStates_withRange_, "setFragmentSamplerStates:withRange:");
_MTL_PRIVATE_DEF_SEL(setFragmentStaticLinkingDescriptor_, "setFragmentStaticLinkingDescriptor:");
_MTL_PRIVATE_DEF_SEL(setFragmentTexture_atIndex_, "setFragmentTexture:atIndex:");
_MTL_PRIVATE_DEF_SEL(setFragmentTextures_withRange_, "setFragmentTextures:withRange:");
...
_MTL_PRIVATE_DEF_SEL(setFunctionDescriptor_, "setFunctionDescriptor:");
_MTL_PRIVATE_DEF_SEL(setFunctionDescriptors_, "setFunctionDescriptors:");
_MTL_PRIVATE_DEF_SEL(setFunctionGraph_, "setFunctionGraph:");
...
_MTL_PRIVATE_DEF_SEL(setIndirectCommandBuffer_atIndex_, "setIndirectCommandBuffer:atIndex:");
_MTL_PRIVATE_DEF_SEL(setIndirectCommandBuffers_withRange_, "setIndirectCommandBuffers:withRange:");
_MTL_PRIVATE_DEF_SEL(setInheritBuffers_, "setInheritBuffers:");
_MTL_PRIVATE_DEF_SEL(setInheritCullMode_, "setInheritCullMode:");
_MTL_PRIVATE_DEF_SEL(setInheritDepthBias_, "setInheritDepthBias:");
_MTL_PRIVATE_DEF_SEL(setInheritDepthClipMode_, "setInheritDepthClipMode:");
_MTL_PRIVATE_DEF_SEL(setInheritDepthStencilState_, "setInheritDepthStencilState:");
_MTL_PRIVATE_DEF_SEL(setInheritFrontFacingWinding_, "setInheritFrontFacingWinding:");
_MTL_PRIVATE_DEF_SEL(setInheritPipelineState_, "setInheritPipelineState:");
_MTL_PRIVATE_DEF_SEL(setInheritTriangleFillMode_, "setInheritTriangleFillMode:");
_MTL_PRIVATE_DEF_SEL(setInitialCapacity_, "setInitialCapacity:");
_MTL_PRIVATE_DEF_SEL(setInitializeBindings_, "setInitializeBindings:");
_MTL_PRIVATE_DEF_SEL(setInputDimensions_atBufferIndex_, "setInputDimensions:atBufferIndex:");
_MTL_PRIVATE_DEF_SEL(setInputDimensions_withRange_, "setInputDimensions:withRange:");
...
_MTL_PRIVATE_DEF_SEL(setInstanceCountBufferOffset_, "setInstanceCountBufferOffset:");
_MTL_PRIVATE_DEF_SEL(setInstanceDescriptorBuffer_, "setInstanceDescriptorBuffer:");
_MTL_PRIVATE_DEF_SEL(setInstanceDescriptorBufferOffset_, "setInstanceDescriptorBufferOffset:");
_MTL_PRIVATE_DEF_SEL(setInstanceDescriptorStride_, "setInstanceDescriptorStride:");
...
_MTL_PRIVATE_DEF_SEL(setIntersectionFunctionTableOffset_, "setIntersectionFunctionTableOffset:");
...
_MTL_PRIVATE_DEF_SEL(setKernelBuffer_offset_atIndex_, "setKernelBuffer:offset:atIndex:");
...
_MTL_PRIVATE_DEF_SEL(setLevelRange_, "setLevelRange:");
_MTL_PRIVATE_DEF_SEL(setLibraries_, "setLibraries:");
_MTL_PRIVATE_DEF_SEL(setLibrary_, "setLibrary:");
...
_MTL_PRIVATE_DEF_SEL(setLodBias_, "setLodBias:");
_MTL_PRIVATE_DEF_SEL(setLodMaxClamp_, "setLodMaxClamp:");
_MTL_PRIVATE_DEF_SEL(setLodMinClamp_, "setLodMinClamp:");
_MTL_PRIVATE_DEF_SEL(setLogState_, "setLogState:");
_MTL_PRIVATE_DEF_SEL(setLookupArchives_, "setLookupArchives:");
...
_MTL_PRIVATE_DEF_SEL(setMathFloatingPointFunctions_, "setMathFloatingPointFunctions:");
_MTL_PRIVATE_DEF_SEL(setMathMode_, "setMathMode:");
_MTL_PRIVATE_DEF_SEL(setMaxAnisotropy_, "setMaxAnisotropy:");
_MTL_PRIVATE_DEF_SEL(setMaxBufferBindCount_, "setMaxBufferBindCount:");
...
_MTL_PRIVATE_DEF_SEL(setMaxFragmentBufferBindCount_, "setMaxFragmentBufferBindCount:");
_MTL_PRIVATE_DEF_SEL(setMaxFragmentCallStackDepth_, "setMaxFragmentCallStackDepth:");
_MTL_PRIVATE_DEF_SEL(setMaxInstanceCount_, "setMaxInstanceCount:");
_MTL_PRIVATE_DEF_SEL(setMaxKernelBufferBindCount_, "setMaxKernelBufferBindCount:");
...
_MTL_PRIVATE_DEF_SEL(setMaxObjectBufferBindCount_, "setMaxObjectBufferBindCount:");
_MTL_PRIVATE_DEF_SEL(setMaxObjectThreadgroupMemoryBindCount_,
                     "setMaxObjectThreadgroupMemoryBindCount:");
_MTL_PRIVATE_DEF_SEL(setMaxSamplerStateBindCount_, "setMaxSamplerStateBindCount:");
_MTL_PRIVATE_DEF_SEL(setMaxTessellationFactor_, "setMaxTessellationFactor:");
_MTL_PRIVATE_DEF_SEL(setMaxTextureBindCount_, "setMaxTextureBindCount:");
_MTL_PRIVATE_DEF_SEL(setMaxTotalThreadgroupsPerMeshGrid_, "setMaxTotalThreadgroupsPerMeshGrid:");
...
_MTL_PRIVATE_DEF_SEL(setMaxTotalThreadsPerThreadgroup_, "setMaxTotalThreadsPerThreadgroup:");
_MTL_PRIVATE_DEF_SEL(setMaxVertexAmplificationCount_, "setMaxVertexAmplificationCount:");
_MTL_PRIVATE_DEF_SEL(setMaxVertexBufferBindCount_, "setMaxVertexBufferBindCount:");
_MTL_PRIVATE_DEF_SEL(setMaxVertexCallStackDepth_, "setMaxVertexCallStackDepth:");
_MTL_PRIVATE_DEF_SEL(setMeshAdditionalBinaryFunctions_, "setMeshAdditionalBinaryFunctions:");
_MTL_PRIVATE_DEF_SEL(setMeshBuffer_offset_atIndex_, "setMeshBuffer:offset:atIndex:");
_MTL_PRIVATE_DEF_SEL(setMeshBufferOffset_atIndex_, "setMeshBufferOffset:atIndex:");
_MTL_PRIVATE_DEF_SEL(setMeshBuffers_offsets_withRange_, "setMeshBuffers:offsets:withRange:");
_MTL_PRIVATE_DEF_SEL(setMeshBytes_length_atIndex_, "setMeshBytes:length:atIndex:");
_MTL_PRIVATE_DEF_SEL(setMeshFunction_, "setMeshFunction:");
_MTL_PRIVATE_DEF_SEL(setMeshFunctionDescriptor_, "setMeshFunctionDescriptor:");
_MTL_PRIVATE_DEF_SEL(setMeshLinkedFunctions_, "setMeshLinkedFunctions:");
_MTL_PRIVATE_DEF_SEL(setMeshSamplerState_atIndex_, "setMeshSamplerState:atIndex:");
...
_MTL_PRIVATE_DEF_SEL(setMeshSamplerStates_withRange_, "setMeshSamplerStates:withRange:");
_MTL_PRIVATE_DEF_SEL(setMeshStaticLinkingDescriptor_, "setMeshStaticLinkingDescriptor:");
...
_MTL_PRIVATE_DEF_SEL(setMotionTransformBufferOffset_, "setMotionTransformBufferOffset:");
_MTL_PRIVATE_DEF_SEL(setMotionTransformCount_, "setMotionTransformCount:");
_MTL_PRIVATE_DEF_SEL(setMotionTransformCountBuffer_, "setMotionTransformCountBuffer:");
_MTL_PRIVATE_DEF_SEL(setMotionTransformCountBufferOffset_, "setMotionTransformCountBufferOffset:");
_MTL_PRIVATE_DEF_SEL(setMotionTransformStride_, "setMotionTransformStride:");
_MTL_PRIVATE_DEF_SEL(setMotionTransformType_, "setMotionTransformType:");
...
_MTL_PRIVATE_DEF_SEL(setObject_atIndexedSubscript_, "setObject:atIndexedSubscript:");
_MTL_PRIVATE_DEF_SEL(setObjectAdditionalBinaryFunctions_, "setObjectAdditionalBinaryFunctions:");
_MTL_PRIVATE_DEF_SEL(setObjectBuffer_offset_atIndex_, "setObjectBuffer:offset:atIndex:");
_MTL_PRIVATE_DEF_SEL(setObjectBufferOffset_atIndex_, "setObjectBufferOffset:atIndex:");
_MTL_PRIVATE_DEF_SEL(setObjectBuffers_offsets_withRange_, "setObjectBuffers:offsets:withRange:");
_MTL_PRIVATE_DEF_SEL(setObjectBytes_length_atIndex_, "setObjectBytes:length:atIndex:");
_MTL_PRIVATE_DEF_SEL(setObjectFunction_, "setObjectFunction:");
_MTL_PRIVATE_DEF_SEL(setObjectFunctionDescriptor_, "setObjectFunctionDescriptor:");
_MTL_PRIVATE_DEF_SEL(setObjectLinkedFunctions_, "setObjectLinkedFunctions:");
_MTL_PRIVATE_DEF_SEL(setObjectSamplerState_atIndex_, "setObjectSamplerState:atIndex:");
...
_MTL_PRIVATE_DEF_SEL(setObjectSamplerStates_withRange_, "setObjectSamplerStates:withRange:");
_MTL_PRIVATE_DEF_SEL(setObjectStaticLinkingDescriptor_, "setObjectStaticLinkingDescriptor:");
_MTL_PRIVATE_DEF_SEL(setObjectTexture_atIndex_, "setObjectTexture:atIndex:");
_MTL_PRIVATE_DEF_SEL(setObjectTextures_withRange_, "setObjectTextures:withRange:");
...
_MTL_PRIVATE_DEF_SEL(setOwnerWithIdentity_, "setOwnerWithIdentity:");
_MTL_PRIVATE_DEF_SEL(setPayloadMemoryLength_, "setPayloadMemoryLength:");
_MTL_PRIVATE_DEF_SEL(setPhysicalIndex_forLogicalIndex_, "setPhysicalIndex:forLogicalIndex:");
_MTL_PRIVATE_DEF_SEL(setPipelineDataSetSerializer_, "setPipelineDataSetSerializer:");
_MTL_PRIVATE_DEF_SEL(setPipelineState_, "setPipelineState:");
_MTL_PRIVATE_DEF_SEL(setPixelFormat_, "setPixelFormat:");
_MTL_PRIVATE_DEF_SEL(setPlacementSparsePageSize_, "setPlacementSparsePageSize:");
...
_MTL_PRIVATE_DEF_SEL(setPrimitiveDataBufferOffset_, "setPrimitiveDataBufferOffset:");
_MTL_PRIVATE_DEF_SEL(setPrimitiveDataElementSize_, "setPrimitiveDataElementSize:");
_MTL_PRIVATE_DEF_SEL(setPrimitiveDataStride_, "setPrimitiveDataStride:");
_MTL_PRIVATE_DEF_SEL(setPriority_, "setPriority:");
_MTL_PRIVATE_DEF_SEL(setPrivateFunctionDescriptors_, "setPrivateFunctionDescriptors:");
...
_MTL_PRIVATE_DEF_SEL(setReductionMode_, "setReductionMode:");
_MTL_PRIVATE_DEF_SEL(setRenderPipelineState_, "setRenderPipelineState:");
_MTL_PRIVATE_DEF_SEL(setRenderPipelineState_atIndex_, "setRenderPipelineState:atIndex:");
_MTL_PRIVATE_DEF_SEL(setRenderPipelineStates_withRange_, "setRenderPipelineStates:withRange:");
_MTL_PRIVATE_DEF_SEL(setRenderTargetArrayLength_, "setRenderTargetArrayLength:");
...
_MTL_PRIVATE_DEF_SEL(setRequiredThreadsPerThreadgroup_, "setRequiredThreadsPerThreadgroup:");
...
_MTL_PRIVATE_DEF_SEL(setResource_atBufferIndex_, "setResource:atBufferIndex:");
_MTL_PRIVATE_DEF_SEL(setResourceOptions_, "setResourceOptions:");
_MTL_PRIVATE_DEF_SEL(setResourceViewCount_, "setResourceViewCount:");
...
_MTL_PRIVATE_DEF_SEL(setSamplerStates_withRange_, "setSamplerStates:withRange:");
...
_MTL_PRIVATE_DEF_SEL(setShaderReflection_, "setShaderReflection:");
_MTL_PRIVATE_DEF_SEL(setShaderValidation_, "setShaderValidation:");
...
_MTL_PRIVATE_DEF_SEL(setSliceRange_, "setSliceRange:");
_MTL_PRIVATE_DEF_SEL(setSource_, "setSource:");
...
_MTL_PRIVATE_DEF_SEL(setStartOfEncoderSampleIndex_, "setStartOfEncoderSampleIndex:");
_MTL_PRIVATE_DEF_SEL(setStartOfFragmentSampleIndex_, "setStartOfFragmentSampleIndex:");
_MTL_PRIVATE_DEF_SEL(setStartOfVertexSampleIndex_, "setStartOfVertexSampleIndex:");
_MTL_PRIVATE_DEF_SEL(setStaticLinkingDescriptor_, "setStaticLinkingDescriptor:");
_MTL_PRIVATE_DEF_SEL(setStencilAttachment_, "setStencilAttachment:");
_MTL_PRIVATE_DEF_SEL(setStencilAttachmentPixelFormat_, "setStencilAttachmentPixelFormat:");
_MTL_PRIVATE_DEF_SEL(setStencilCompareFunction_, "setStencilCompareFunction:");
_MTL_PRIVATE_DEF_SEL(setStencilFailureOperation_, "setStencilFailureOperation:");
...
_MTL_PRIVATE_DEF_SEL(setStencilStoreActionOptions_, "setStencilStoreActionOptions:");
...
_MTL_PRIVATE_DEF_SEL(setStrides_, "setStrides:");
_MTL_PRIVATE_DEF_SEL(setSupportAddingBinaryFunctions_, "setSupportAddingBinaryFunctions:");
...
_MTL_PRIVATE_DEF_SEL(setSupportAttributeStrides_, "setSupportAttributeStrides:");
_MTL_PRIVATE_DEF_SEL(setSupportBinaryLinking_, "setSupportBinaryLinking:");
_MTL_PRIVATE_DEF_SEL(setSupportColorAttachmentMapping_, "setSupportColorAttachmentMapping:");
_MTL_PRIVATE_DEF_SEL(setSupportDynamicAttributeStride_, "setSupportDynamicAttributeStride:");
_MTL_PRIVATE_DEF_SEL(setSupportFragmentBinaryLinking_, "setSupportFragmentBinaryLinking:");
_MTL_PRIVATE_DEF_SEL(setSupportIndirectCommandBuffers_, "setSupportIndirectCommandBuffers:");
_MTL_PRIVATE_DEF_SEL(setSupportMeshBinaryLinking_, "setSupportMeshBinaryLinking:");
_MTL_PRIVATE_DEF_SEL(setSupportObjectBinaryLinking_, "setSupportObjectBinaryLinking:");
_MTL_PRIVATE_DEF_SEL(setSupportRayTracing_, "setSupportRayTracing:");
_MTL_PRIVATE_DEF_SEL(setSupportVertexBinaryLinking_, "setSupportVertexBinaryLinking:");
...
_MTL_PRIVATE_DEF_SEL(setTessellationFactorFormat_, "setTessellationFactorFormat:");
_MTL_PRIVATE_DEF_SEL(setTessellationFactorScale_, "setTessellationFactorScale:");
_MTL_PRIVATE_DEF_SEL(setTessellationFactorScaleEnabled_, "setTessellationFactorScaleEnabled:");
_MTL_PRIVATE_DEF_SEL(setTessellationFactorStepFunction_, "setTessellationFactorStepFunction:");
_MTL_PRIVATE_DEF_SEL(setTessellationOutputWindingOrder_, "setTessellationOutputWindingOrder:");
_MTL_PRIVATE_DEF_SEL(setTessellationPartitionMode_, "setTessellationPartitionMode:");
...
_MTL_PRIVATE_DEF_SEL(setTextureView_atIndex_, "setTextureView:atIndex:");
_MTL_PRIVATE_DEF_SEL(setTextureView_descriptor_atIndex_, "setTextureView:descriptor:atIndex:");
...
_MTL_PRIVATE_DEF_SEL(setThreadgroupMemoryLength_, "setThreadgroupMemoryLength:");
_MTL_PRIVATE_DEF_SEL(setThreadgroupMemoryLength_atIndex_, "setThreadgroupMemoryLength:atIndex:");
_MTL_PRIVATE_DEF_SEL(setThreadgroupMemoryLength_offset_atIndex_,
                     "setThreadgroupMemoryLength:offset:atIndex:");
_MTL_PRIVATE_DEF_SEL(setThreadgroupSizeMatchesTileSize_, "setThreadgroupSizeMatchesTileSize:");
_MTL_PRIVATE_DEF_SEL(setTileAccelerationStructure_atBufferIndex_,
                     "setTileAccelerationStructure:atBufferIndex:");
_MTL_PRIVATE_DEF_SEL(setTileAdditionalBinaryFunctions_, "setTileAdditionalBinaryFunctions:");
_MTL_PRIVATE_DEF_SEL(setTileBuffer_offset_atIndex_, "setTileBuffer:offset:atIndex:");
_MTL_PRIVATE_DEF_SEL(setTileBufferOffset_atIndex_, "setTileBufferOffset:atIndex:");
_MTL_PRIVATE_DEF_SEL(setTileBuffers_offsets_withRange_, "setTileBuffers:offsets:withRange:");
_MTL_PRIVATE_DEF_SEL(setTileBytes_length_atIndex_, "setTileBytes:length:atIndex:");
_MTL_PRIVATE_DEF_SEL(setTileFunction_, "setTileFunction:");
_MTL_PRIVATE_DEF_SEL(setTileFunctionDescriptor_, "setTileFunctionDescriptor:");
...
_MTL_PRIVATE_DEF_SEL(setTileSamplerState_atIndex_, "setTileSamplerState:atIndex:");
...
_MTL_PRIVATE_DEF_SEL(setTileSamplerStates_withRange_, "setTileSamplerStates:withRange:");
...
_MTL_PRIVATE_DEF_SEL(setTransformationMatrixBuffer_, "setTransformationMatrixBuffer:");
_MTL_PRIVATE_DEF_SEL(setTransformationMatrixBufferOffset_, "setTransformationMatrixBufferOffset:");
_MTL_PRIVATE_DEF_SEL(setTransformationMatrixLayout_, "setTransformationMatrixLayout:");
...
_MTL_PRIVATE_DEF_SEL(setVertexAdditionalBinaryFunctions_, "setVertexAdditionalBinaryFunctions:");
...
_MTL_PRIVATE_DEF_SEL(setVertexBuffer_offset_atIndex_, "setVertexBuffer:offset:atIndex:");
...
_MTL_PRIVATE_DEF_SEL(setVertexBufferOffset_atIndex_, "setVertexBufferOffset:atIndex:");
...
_MTL_PRIVATE_DEF_SEL(setVertexBuffers_offsets_withRange_, "setVertexBuffers:offsets:withRange:");
_MTL_PRIVATE_DEF_SEL(setVertexBytes_length_atIndex_, "setVertexBytes:length:atIndex:");
...
_MTL_PRIVATE_DEF_SEL(setVertexFunctionDescriptor_, "setVertexFunctionDescriptor:");
...
_MTL_PRIVATE_DEF_SEL(setVertexPreloadedLibraries_, "setVertexPreloadedLibraries:");
_MTL_PRIVATE_DEF_SEL(setVertexSamplerState_atIndex_, "setVertexSamplerState:atIndex:");
...
_MTL_PRIVATE_DEF_SEL(setVertexSamplerStates_withRange_, "setVertexSamplerStates:withRange:");
_MTL_PRIVATE_DEF_SEL(setVertexStaticLinkingDescriptor_, "setVertexStaticLinkingDescriptor:");
...
_MTL_PRIVATE_DEF_SEL(setVertexTextures_withRange_, "setVertexTextures:withRange:");
...
_MTL_PRIVATE_DEF_SEL(setVisibilityResultMode_offset_, "setVisibilityResultMode:offset:");
_MTL_PRIVATE_DEF_SEL(setVisibilityResultType_, "setVisibilityResultType:");
_MTL_PRIVATE_DEF_SEL(setVisibleFunctionTable_atBufferIndex_,
                     "setVisibleFunctionTable:atBufferIndex:");
_MTL_PRIVATE_DEF_SEL(setVisibleFunctionTable_atIndex_, "setVisibleFunctionTable:atIndex:");
_MTL_PRIVATE_DEF_SEL(setVisibleFunctionTables_withBufferRange_,
                     "setVisibleFunctionTables:withBufferRange:");
_MTL_PRIVATE_DEF_SEL(setVisibleFunctionTables_withRange_, "setVisibleFunctionTables:withRange:");
_MTL_PRIVATE_DEF_SEL(setWidth_, "setWidth:");
_MTL_PRIVATE_DEF_SEL(setWriteMask_, "setWriteMask:");
_MTL_PRIVATE_DEF_SEL(shaderReflection, "shaderReflection");
_MTL_PRIVATE_DEF_SEL(shaderValidation, "shaderValidation");
_MTL_PRIVATE_DEF_SEL(sharedCaptureManager, "sharedCaptureManager");
_MTL_PRIVATE_DEF_SEL(sharedListener, "sharedListener");
_MTL_PRIVATE_DEF_SEL(shouldMaximizeConcurrentCompilation, "shouldMaximizeConcurrentCompilation");
_MTL_PRIVATE_DEF_SEL(signalDrawable_, "signalDrawable:");
...
_MTL_PRIVATE_DEF_SEL(sizeOfCounterHeapEntry_, "sizeOfCounterHeapEntry:");
_MTL_PRIVATE_DEF_SEL(slice, "slice");
_MTL_PRIVATE_DEF_SEL(sliceRange, "sliceRange");
_MTL_PRIVATE_DEF_SEL(source, "source");
...
_MTL_PRIVATE_DEF_SEL(sparseBufferTier, "sparseBufferTier");
_MTL_PRIVATE_DEF_SEL(sparsePageSize, "sparsePageSize");
_MTL_PRIVATE_DEF_SEL(sparseTextureTier, "sparseTextureTier");
...
_MTL_PRIVATE_DEF_SEL(stages, "stages");
_MTL_PRIVATE_DEF_SEL(startCaptureWithCommandQueue_, "startCaptureWithCommandQueue:");
_MTL_PRIVATE_DEF_SEL(startCaptureWithDescriptor_error_, "startCaptureWithDescriptor:error:");
...
_MTL_PRIVATE_DEF_SEL(staticLinkingDescriptor, "staticLinkingDescriptor");
_MTL_PRIVATE_DEF_SEL(staticThreadgroupMemoryLength, "staticThreadgroupMemoryLength");
...
_MTL_PRIVATE_DEF_SEL(strides, "strides");
_MTL_PRIVATE_DEF_SEL(structType, "structType");
_MTL_PRIVATE_DEF_SEL(supportAddingBinaryFunctions, "supportAddingBinaryFunctions");
_MTL_PRIVATE_DEF_SEL(supportAddingFragmentBinaryFunctions, "supportAddingFragmentBinaryFunctions");
_MTL_PRIVATE_DEF_SEL(supportAddingVertexBinaryFunctions, "supportAddingVertexBinaryFunctions");
_MTL_PRIVATE_DEF_SEL(supportArgumentBuffers, "supportArgumentBuffers");
_MTL_PRIVATE_DEF_SEL(supportAttributeStrides, "supportAttributeStrides");
...
_MTL_PRIVATE_DEF_SEL(supportFragmentBinaryLinking, "supportFragmentBinaryLinking");
_MTL_PRIVATE_DEF_SEL(supportIndirectCommandBuffers, "supportIndirectCommandBuffers");
_MTL_PRIVATE_DEF_SEL(supportMeshBinaryLinking, "supportMeshBinaryLinking");
_MTL_PRIVATE_DEF_SEL(supportObjectBinaryLinking, "supportObjectBinaryLinking");
_MTL_PRIVATE_DEF_SEL(supportRayTracing, "supportRayTracing");
_MTL_PRIVATE_DEF_SEL(supportVertexBinaryLinking, "supportVertexBinaryLinking");
_MTL_PRIVATE_DEF_SEL(supports32BitFloatFiltering, "supports32BitFloatFiltering");
_MTL_PRIVATE_DEF_SEL(supports32BitMSAA, "supports32BitMSAA");
_MTL_PRIVATE_DEF_SEL(supportsBCTextureCompression, "supportsBCTextureCompression");
...
_MTL_PRIVATE_DEF_SEL(supportsFunctionPointersFromRender, "supportsFunctionPointersFromRender");
_MTL_PRIVATE_DEF_SEL(supportsPrimitiveMotionBlur, "supportsPrimitiveMotionBlur");
_MTL_PRIVATE_DEF_SEL(supportsPullModelInterpolation, "supportsPullModelInterpolation");
...
_MTL_PRIVATE_DEF_SEL(supportsRaytracingFromRender, "supportsRaytracingFromRender");
_MTL_PRIVATE_DEF_SEL(supportsRenderDynamicLibraries, "supportsRenderDynamicLibraries");
_MTL_PRIVATE_DEF_SEL(supportsShaderBarycentricCoordinates, "supportsShaderBarycentricCoordinates");
_MTL_PRIVATE_DEF_SEL(supportsTextureSampleCount_, "supportsTextureSampleCount:");
_MTL_PRIVATE_DEF_SEL(supportsVertexAmplificationCount_, "supportsVertexAmplificationCount:");
_MTL_PRIVATE_DEF_SEL(swizzle, "swizzle");
_MTL_PRIVATE_DEF_SEL(synchronizeResource_, "synchronizeResource:");
_MTL_PRIVATE_DEF_SEL(synchronizeTexture_slice_level_, "synchronizeTexture:slice:level:");
_MTL_PRIVATE_DEF_SEL(tAddressMode, "tAddressMode");
_MTL_PRIVATE_DEF_SEL(tailSizeInBytes, "tailSizeInBytes");
_MTL_PRIVATE_DEF_SEL(tensorDataType, "tensorDataType");
_MTL_PRIVATE_DEF_SEL(tensorReferenceType, "tensorReferenceType");
_MTL_PRIVATE_DEF_SEL(tensorSizeAndAlignWithDescriptor_, "tensorSizeAndAlignWithDescriptor:");
_MTL_PRIVATE_DEF_SEL(tessellationControlPointIndexType, "tessellationControlPointIndexType");
_MTL_PRIVATE_DEF_SEL(tessellationFactorFormat, "tessellationFactorFormat");
_MTL_PRIVATE_DEF_SEL(tessellationFactorStepFunction, "tessellationFactorStepFunction");
_MTL_PRIVATE_DEF_SEL(tessellationOutputWindingOrder, "tessellationOutputWindingOrder");
...
_MTL_PRIVATE_DEF_SEL(threadgroupSizeMatchesTileSize, "threadgroupSizeMatchesTileSize");
_MTL_PRIVATE_DEF_SEL(tileAdditionalBinaryFunctions, "tileAdditionalBinaryFunctions");
...
_MTL_PRIVATE_DEF_SEL(tileFunctionDescriptor, "tileFunctionDescriptor");
_MTL_PRIVATE_DEF_SEL(tileHeight, "tileHeight");
_MTL_PRIVATE_DEF_SEL(tileLinkingDescriptor, "tileLinkingDescriptor");
_MTL_PRIVATE_DEF_SEL(tileWidth, "tileWidth");
_MTL_PRIVATE_DEF_SEL(transformationMatrixBuffer, "transformationMatrixBuffer");
_MTL_PRIVATE_DEF_SEL(transformationMatrixBufferOffset, "transformationMatrixBufferOffset");
_MTL_PRIVATE_DEF_SEL(transformationMatrixLayout, "transformationMatrixLayout");
...
_MTL_PRIVATE_DEF_SEL(updateFence_afterEncoderStages_, "updateFence:afterEncoderStages:");
...
_MTL_PRIVATE_DEF_SEL(useResidencySet_, "useResidencySet:");
_MTL_PRIVATE_DEF_SEL(useResidencySets_count_, "useResidencySets:count:");
...
_MTL_PRIVATE_DEF_SEL(useResources_count_usage_stages_, "useResources:count:usage:stages:");
...
_MTL_PRIVATE_DEF_SEL(vertexFunctionDescriptor, "vertexFunctionDescriptor");
_MTL_PRIVATE_DEF_SEL(vertexLinkedFunctions, "vertexLinkedFunctions");
_MTL_PRIVATE_DEF_SEL(vertexLinkingDescriptor, "vertexLinkingDescriptor");
_MTL_PRIVATE_DEF_SEL(vertexPreloadedLibraries, "vertexPreloadedLibraries");
_MTL_PRIVATE_DEF_SEL(vertexStaticLinkingDescriptor, "vertexStaticLinkingDescriptor");
...
_MTL_PRIVATE_DEF_SEL(visibilityResultType, "visibilityResultType");
_MTL_PRIVATE_DEF_SEL(visibleFunctionTableDescriptor, "visibleFunctionTableDescriptor");
_MTL_PRIVATE_DEF_SEL(waitForDrawable_, "waitForDrawable:");
_MTL_PRIVATE_DEF_SEL(waitForEvent_value_, "waitForEvent:value:");
_MTL_PRIVATE_DEF_SEL(waitForFence_, "waitForFence:");
_MTL_PRIVATE_DEF_SEL(waitForFence_beforeEncoderStages_, "waitForFence:beforeEncoderStages:");
...
_MTL_PRIVATE_DEF_SEL(waitUntilSignaledValue_timeoutMS_, "waitUntilSignaledValue:timeoutMS:");
...
_MTL_PRIVATE_DEF_SEL(writeTimestampIntoHeap_atIndex_, "writeTimestampIntoHeap:atIndex:");
