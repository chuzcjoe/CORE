...
namespace MTL4 {
class StitchedFunctionDescriptor
    : public NS::Copying<StitchedFunctionDescriptor, FunctionDescriptor> {
 public:
...
_MTL_INLINE MTL4::StitchedFunctionDescriptor* MTL4::StitchedFunctionDescriptor::alloc() {
  return NS::Object::alloc<MTL4::StitchedFunctionDescriptor>(
      _MTL_PRIVATE_CLS(MTL4StitchedFunctionDescriptor));
}
...
_MTL_INLINE void MTL4::StitchedFunctionDescriptor::setFunctionDescriptors(
...
_MTL_INLINE void MTL4::StitchedFunctionDescriptor::setFunctionGraph(
    const MTL::FunctionStitchingGraph* functionGraph) {
