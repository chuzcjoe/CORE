...
class PipelineDataSetSerializerDescriptor
    : public NS::Copying<PipelineDataSetSerializerDescriptor> {
 public:
...
_MTL_INLINE MTL4::PipelineDataSetSerializerDescriptor*
MTL4::PipelineDataSetSerializerDescriptor::alloc() {
...
MTL4::PipelineDataSetSerializerDescriptor::configuration() const {
  return Object::sendMessage<MTL4::PipelineDataSetSerializerConfiguration>(
      this, _MTL_PRIVATE_SEL(configuration));
}

_MTL_INLINE MTL4::PipelineDataSetSerializerDescriptor*
MTL4::PipelineDataSetSerializerDescriptor::init() {
...
_MTL_INLINE bool MTL4::PipelineDataSetSerializer::serializeAsArchiveAndFlushToURL(
    const NS::URL* url, NS::Error** error) {
  return Object::sendMessage<bool>(this, _MTL_PRIVATE_SEL(serializeAsArchiveAndFlushToURL_error_),
                                   url, error);
}

_MTL_INLINE NS::Data* MTL4::PipelineDataSetSerializer::serializeAsPipelinesScript(
    NS::Error** error) {
  return Object::sendMessage<NS::Data*>(
      this, _MTL_PRIVATE_SEL(serializeAsPipelinesScriptWithError_), error);
}
