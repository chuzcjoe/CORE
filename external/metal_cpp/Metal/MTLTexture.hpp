...
struct TextureSwizzleChannels {
  ...
  static TextureSwizzleChannels Make(MTL::TextureSwizzle r, MTL::TextureSwizzle g,
...
class TextureDescriptor : public NS::Copying<TextureDescriptor> {
 public:
  ...
  static TextureDescriptor* textureBufferDescriptor(MTL::PixelFormat pixelFormat,
                                                    NS::UInteger width,
                                                    MTL::ResourceOptions resourceOptions,
                                                    MTL::TextureUsage usage);

  static TextureDescriptor* textureCubeDescriptor(MTL::PixelFormat pixelFormat, NS::UInteger size,
                                                  bool mipmapped);
...
class Texture : public NS::Referencing<Texture, Resource> {
 public:
  ...
  void getBytes(void* pixelBytes, NS::UInteger bytesPerRow, NS::UInteger bytesPerImage,
  ...
  Texture* newTextureView(MTL::PixelFormat pixelFormat, MTL::TextureType textureType,
  ...
  void replaceRegion(MTL::Region region, NS::UInteger level, const void* pixelBytes,
...
_MTL_INLINE MTL::TextureSwizzleChannels::TextureSwizzleChannels(MTL::TextureSwizzle r,
                                                                MTL::TextureSwizzle g,
                                                                MTL::TextureSwizzle b,
                                                                MTL::TextureSwizzle a)
...
_MTL_INLINE MTL::TextureSwizzleChannels MTL::TextureSwizzleChannels::Make(MTL::TextureSwizzle r,
                                                                          MTL::TextureSwizzle g,
                                                                          MTL::TextureSwizzle b,
                                                                          MTL::TextureSwizzle a) {
...
_MTL_INLINE void MTL::TextureDescriptor::setAllowGPUOptimizedContents(
  ...
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setAllowGPUOptimizedContents_),
...
_MTL_INLINE void MTL::TextureDescriptor::setCompressionType(
    MTL::TextureCompressionType compressionType) {
...
_MTL_INLINE void MTL::TextureDescriptor::setPlacementSparsePageSize(
    MTL::SparsePageSize placementSparsePageSize) {
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setPlacementSparsePageSize_),
...
_MTL_INLINE MTL::TextureDescriptor* MTL::TextureDescriptor::texture2DDescriptor(
  ...
  return Object::sendMessage<MTL::TextureDescriptor*>(
...
_MTL_INLINE void MTL::Texture::getBytes(void* pixelBytes, NS::UInteger bytesPerRow,
                                        NS::UInteger bytesPerImage, MTL::Region region,
                                        NS::UInteger level, NS::UInteger slice) {
  Object::sendMessage<void>(
      this, _MTL_PRIVATE_SEL(getBytes_bytesPerRow_bytesPerImage_fromRegion_mipmapLevel_slice_),
...
_MTL_INLINE MTL::Texture* MTL::Texture::newRemoteTextureViewForDevice(const MTL::Device* device) {
  return Object::sendMessage<MTL::Texture*>(this, _MTL_PRIVATE_SEL(newRemoteTextureViewForDevice_),
                                            device);
}

_MTL_INLINE MTL::SharedTextureHandle* MTL::Texture::newSharedTextureHandle() {
  return Object::sendMessage<MTL::SharedTextureHandle*>(this,
                                                        _MTL_PRIVATE_SEL(newSharedTextureHandle));
}

_MTL_INLINE MTL::Texture* MTL::Texture::newTextureView(MTL::PixelFormat pixelFormat) {
  return Object::sendMessage<MTL::Texture*>(this, _MTL_PRIVATE_SEL(newTextureViewWithPixelFormat_),
                                            pixelFormat);
}
...
_MTL_INLINE MTL::Texture* MTL::Texture::newTextureView(MTL::PixelFormat pixelFormat,
  ...
  return Object::sendMessage<MTL::Texture*>(
      this, _MTL_PRIVATE_SEL(newTextureViewWithPixelFormat_textureType_levels_slices_), pixelFormat,
      textureType, levelRange, sliceRange);
}

_MTL_INLINE MTL::Texture* MTL::Texture::newTextureView(
    const MTL::TextureViewDescriptor* descriptor) {
  return Object::sendMessage<MTL::Texture*>(this, _MTL_PRIVATE_SEL(newTextureViewWithDescriptor_),
                                            descriptor);
}
...
_MTL_INLINE MTL::Texture* MTL::Texture::newTextureView(MTL::PixelFormat pixelFormat,
                                                       ...
                                                       MTL::TextureSwizzleChannels swizzle) {
  return Object::sendMessage<MTL::Texture*>(
      this, _MTL_PRIVATE_SEL(newTextureViewWithPixelFormat_textureType_levels_slices_swizzle_),
...
_MTL_INLINE void MTL::Texture::replaceRegion(MTL::Region region, NS::UInteger level,
  ...
  Object::sendMessage<void>(
      this, _MTL_PRIVATE_SEL(replaceRegion_mipmapLevel_slice_withBytes_bytesPerRow_bytesPerImage_),
...
_MTL_INLINE void MTL::Texture::replaceRegion(MTL::Region region, NS::UInteger level,
  ...
  Object::sendMessage<void>(this,
                            ...
                            region, level, pixelBytes, bytesPerRow);
}
