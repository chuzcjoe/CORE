...
using NewDynamicLibraryCompletionHandlerFunction =
    std::function<void(MTL::DynamicLibrary*, NS::Error*)>;
}  // namespace MTL
...
using NewBinaryFunctionCompletionHandlerFunction =
    std::function<void(MTL4::BinaryFunction*, NS::Error*)>;
...
class Compiler : public NS::Referencing<Compiler> {
 public:
  ...
  CompilerTask* newRenderPipelineState(
      ...
      const MTL::NewRenderPipelineStateCompletionHandler completionHandler);
  CompilerTask* newRenderPipelineState(
      const MTL4::PipelineDescriptor* pDescriptor, const MTL4::CompilerTaskOptions* options,
...
_MTL_INLINE MTL4::PipelineDataSetSerializer* MTL4::CompilerDescriptor::pipelineDataSetSerializer()
    const {
...
_MTL_INLINE MTL4::BinaryFunction* MTL4::Compiler::newBinaryFunction(
  ...
  return Object::sendMessage<MTL4::BinaryFunction*>(
      this, _MTL_PRIVATE_SEL(newBinaryFunctionWithDescriptor_compilerTaskOptions_error_),
...
_MTL_INLINE MTL::ComputePipelineState* MTL4::Compiler::newComputePipelineState(
  ...
  return Object::sendMessage<MTL::ComputePipelineState*>(
      this, _MTL_PRIVATE_SEL(newComputePipelineStateWithDescriptor_compilerTaskOptions_error_),
      descriptor, compilerTaskOptions, error);
}
...
_MTL_INLINE MTL4::CompilerTask* MTL4::Compiler::newComputePipelineState(
  ...
  return newComputePipelineState(pDescriptor, options,
                                 ^(MTL::ComputePipelineState* pPipeline, NS::Error* pError) {
                                   blockFunction(pPipeline, pError);
                                 });
}

_MTL_INLINE MTL::DynamicLibrary* MTL4::Compiler::newDynamicLibrary(const MTL::Library* library,
                                                                   NS::Error** error) {
  return Object::sendMessage<MTL::DynamicLibrary*>(this, _MTL_PRIVATE_SEL(newDynamicLibrary_error_),
                                                   library, error);
}

_MTL_INLINE MTL::DynamicLibrary* MTL4::Compiler::newDynamicLibrary(const NS::URL* url,
                                                                   NS::Error** error) {
...
_MTL_INLINE MTL::Library* MTL4::Compiler::newLibrary(const MTL4::LibraryDescriptor* descriptor,
                                                     NS::Error** error) {
  return Object::sendMessage<MTL::Library*>(this, _MTL_PRIVATE_SEL(newLibraryWithDescriptor_error_),
                                            descriptor, error);
}

_MTL_INLINE MTL4::CompilerTask* MTL4::Compiler::newLibrary(
    const MTL4::LibraryDescriptor* descriptor,
    const MTL::NewLibraryCompletionHandler completionHandler) {
  return Object::sendMessage<MTL4::CompilerTask*>(
...
_MTL_INLINE MTL4::CompilerTask* MTL4::Compiler::newLibrary(
    const MTL4::LibraryDescriptor* pDescriptor,
    const MTL::NewLibraryCompletionHandlerFunction& function) {
...
_MTL_INLINE MTL4::MachineLearningPipelineState* MTL4::Compiler::newMachineLearningPipelineState(
  ...
  return Object::sendMessage<MTL4::MachineLearningPipelineState*>(
      this, _MTL_PRIVATE_SEL(newMachineLearningPipelineStateWithDescriptor_error_), descriptor,
      error);
}
...
_MTL_INLINE MTL4::CompilerTask* MTL4::Compiler::newMachineLearningPipelineState(
    ...
    const MTL4::NewMachineLearningPipelineStateCompletionHandler completionHandler) {
  return Object::sendMessage<MTL4::CompilerTask*>(
      this, _MTL_PRIVATE_SEL(newMachineLearningPipelineStateWithDescriptor_completionHandler_),
...
_MTL_INLINE MTL::RenderPipelineState* MTL4::Compiler::newRenderPipelineState(
  ...
  return Object::sendMessage<MTL::RenderPipelineState*>(
      this, _MTL_PRIVATE_SEL(newRenderPipelineStateWithDescriptor_compilerTaskOptions_error_),
      descriptor, compilerTaskOptions, error);
}
...
_MTL_INLINE MTL4::CompilerTask* MTL4::Compiler::newRenderPipelineState(
  ...
  return newRenderPipelineState(pDescriptor, options,
                                ^(MTL::RenderPipelineState* pPipeline, NS::Error* pError) {
                                  blockFunction(pPipeline, pError);
                                });
}
...
_MTL_INLINE MTL::RenderPipelineState* MTL4::Compiler::newRenderPipelineStateBySpecialization(
    ...
    NS::Error** error) {
  return Object::sendMessage<MTL::RenderPipelineState*>(
      this, _MTL_PRIVATE_SEL(newRenderPipelineStateBySpecializationWithDescriptor_pipeline_error_),
