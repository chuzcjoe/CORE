...
class BlitCommandEncoder : public NS::Referencing<BlitCommandEncoder, CommandEncoder> {
 public:
  ...
  void getTextureAccessCounters(const MTL::Texture* texture, MTL::Region region,
  ...
  void resetTextureAccessCounters(const MTL::Texture* texture, MTL::Region region,
...
_MTL_INLINE void MTL::BlitCommandEncoder::copyFromBuffer(
...
_MTL_INLINE void MTL::BlitCommandEncoder::copyFromTensor(
...
_MTL_INLINE void MTL::BlitCommandEncoder::copyFromTexture(
...
_MTL_INLINE void MTL::BlitCommandEncoder::copyIndirectCommandBuffer(
...
_MTL_INLINE void MTL::BlitCommandEncoder::fillBuffer(const MTL::Buffer* buffer, NS::Range range,
                                                     uint8_t value) {
...
_MTL_INLINE void MTL::BlitCommandEncoder::getTextureAccessCounters(
    const MTL::Texture* texture, MTL::Region region, NS::UInteger mipLevel, NS::UInteger slice,
    bool resetCounters, const MTL::Buffer* countersBuffer, NS::UInteger countersBufferOffset) {
  Object::sendMessage<void>(
      this,
      _MTL_PRIVATE_SEL(
...
_MTL_INLINE void MTL::BlitCommandEncoder::optimizeContentsForCPUAccess(
...
_MTL_INLINE void MTL::BlitCommandEncoder::optimizeContentsForGPUAccess(
    const MTL::Texture* texture) {
...
_MTL_INLINE void MTL::BlitCommandEncoder::resetCommandsInBuffer(
...
_MTL_INLINE void MTL::BlitCommandEncoder::resetTextureAccessCounters(const MTL::Texture* texture,
  ...
  Object::sendMessage<void>(this,
                            _MTL_PRIVATE_SEL(resetTextureAccessCounters_region_mipLevel_slice_),
                            texture, region, mipLevel, slice);
}

_MTL_INLINE void MTL::BlitCommandEncoder::resolveCounters(
    const MTL::CounterSampleBuffer* sampleBuffer, NS::Range range,
    const MTL::Buffer* destinationBuffer, NS::UInteger destinationOffset) {
  Object::sendMessage<void>(
      this, _MTL_PRIVATE_SEL(resolveCounters_inRange_destinationBuffer_destinationOffset_),
      sampleBuffer, range, destinationBuffer, destinationOffset);
}

_MTL_INLINE void MTL::BlitCommandEncoder::sampleCountersInBuffer(
...
_MTL_INLINE void MTL::BlitCommandEncoder::synchronizeTexture(const MTL::Texture* texture,
                                                             NS::UInteger slice,
                                                             NS::UInteger level) {
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(synchronizeTexture_slice_level_), texture, slice,
                            level);
}
