...
class PipelineStageDynamicLinkingDescriptor
    : public NS::Copying<PipelineStageDynamicLinkingDescriptor> {
 public:
...
class RenderPipelineDynamicLinkingDescriptor
    : public NS::Copying<RenderPipelineDynamicLinkingDescriptor> {
 public:
...
_MTL_INLINE MTL4::StaticLinkingDescriptor* MTL4::StaticLinkingDescriptor::alloc() {
  return NS::Object::alloc<MTL4::StaticLinkingDescriptor>(
      _MTL_PRIVATE_CLS(MTL4StaticLinkingDescriptor));
}
...
_MTL_INLINE void MTL4::StaticLinkingDescriptor::setFunctionDescriptors(
    const NS::Array* functionDescriptors) {
...
_MTL_INLINE void MTL4::StaticLinkingDescriptor::setPrivateFunctionDescriptors(
  ...
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setPrivateFunctionDescriptors_),
                            privateFunctionDescriptors);
}

_MTL_INLINE MTL4::PipelineStageDynamicLinkingDescriptor*
MTL4::PipelineStageDynamicLinkingDescriptor::alloc() {
...
_MTL_INLINE MTL4::PipelineStageDynamicLinkingDescriptor*
MTL4::PipelineStageDynamicLinkingDescriptor::init() {
...
_MTL_INLINE void MTL4::PipelineStageDynamicLinkingDescriptor::setBinaryLinkedFunctions(
  ...
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setBinaryLinkedFunctions_),
...
_MTL_INLINE MTL4::RenderPipelineDynamicLinkingDescriptor*
MTL4::RenderPipelineDynamicLinkingDescriptor::alloc() {
...
_MTL_INLINE MTL4::RenderPipelineDynamicLinkingDescriptor*
MTL4::RenderPipelineDynamicLinkingDescriptor::init() {
