...
class ComputePipelineDescriptor
    : public NS::Copying<ComputePipelineDescriptor, PipelineDescriptor> {
 public:
...
_MTL_INLINE MTL4::ComputePipelineDescriptor* MTL4::ComputePipelineDescriptor::alloc() {
  return NS::Object::alloc<MTL4::ComputePipelineDescriptor>(
      _MTL_PRIVATE_CLS(MTL4ComputePipelineDescriptor));
}

_MTL_INLINE MTL4::FunctionDescriptor* MTL4::ComputePipelineDescriptor::computeFunctionDescriptor()
    const {
  return Object::sendMessage<MTL4::FunctionDescriptor*>(
      this, _MTL_PRIVATE_SEL(computeFunctionDescriptor));
}
...
_MTL_INLINE void MTL4::ComputePipelineDescriptor::setComputeFunctionDescriptor(
  ...
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setComputeFunctionDescriptor_),
...
_MTL_INLINE void MTL4::ComputePipelineDescriptor::setStaticLinkingDescriptor(
  ...
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setStaticLinkingDescriptor_),
                            staticLinkingDescriptor);
}

_MTL_INLINE void MTL4::ComputePipelineDescriptor::setSupportBinaryLinking(
    bool supportBinaryLinking) {
...
_MTL_INLINE void
MTL4::ComputePipelineDescriptor::setThreadGroupSizeIsMultipleOfThreadExecutionWidth(
    bool threadGroupSizeIsMultipleOfThreadExecutionWidth) {
...
MTL4::ComputePipelineDescriptor::staticLinkingDescriptor() const {
  return Object::sendMessage<MTL4::StaticLinkingDescriptor*>(
      this, _MTL_PRIVATE_SEL(staticLinkingDescriptor));
}
...
_MTL_INLINE bool MTL4::ComputePipelineDescriptor::threadGroupSizeIsMultipleOfThreadExecutionWidth()
    const {
