...
_MTLFX_ENUM(NS::Integer, SpatialScalerColorProcessingMode){
    SpatialScalerColorProcessingModePerceptual = 0, SpatialScalerColorProcessingModeLinear = 1,
...
class SpatialScalerDescriptor : public NS::Copying<SpatialScalerDescriptor> {
 public:
  ...
  MTL4FX::SpatialScaler* newSpatialScaler(const MTL::Device* pDevice,
...
_MTLFX_INLINE MTLFX::SpatialScalerDescriptor* MTLFX::SpatialScalerDescriptor::alloc() {
  return NS::Object::alloc<SpatialScalerDescriptor>(
      _MTLFX_PRIVATE_CLS(MTLFXSpatialScalerDescriptor));
}
...
_MTLFX_INLINE MTLFX::SpatialScalerColorProcessingMode
MTLFX::SpatialScalerDescriptor::colorProcessingMode() const {
  return Object::sendMessage<SpatialScalerColorProcessingMode>(
      this, _MTLFX_PRIVATE_SEL(colorProcessingMode));
}

//-------------------------------------------------------------------------------------------------------------------------------------------------------------

_MTLFX_INLINE void MTLFX::SpatialScalerDescriptor::setColorProcessingMode(
    SpatialScalerColorProcessingMode mode) {
  Object::sendMessage<void>(this, _MTLFX_PRIVATE_SEL(setColorProcessingMode_), mode);
}

//-------------------------------------------------------------------------------------------------------------------------------------------------------------

_MTLFX_INLINE MTLFX::SpatialScaler* MTLFX::SpatialScalerDescriptor::newSpatialScaler(
    const MTL::Device* pDevice) const {
  return Object::sendMessage<SpatialScaler*>(this, _MTLFX_PRIVATE_SEL(newSpatialScalerWithDevice_),
                                             pDevice);
}
...
_MTLFX_INLINE MTL4FX::SpatialScaler* MTLFX::SpatialScalerDescriptor::newSpatialScaler(
  ...
  return Object::sendMessage<MTL4FX::SpatialScaler*>(
      this, _MTLFX_PRIVATE_SEL(newSpatialScalerWithDevice_compiler_), pDevice, pCompiler);
}
...
_MTLFX_INLINE MTLFX::SpatialScalerColorProcessingMode
MTLFX::SpatialScalerBase::colorProcessingMode() const {
  return Object::sendMessage<SpatialScalerColorProcessingMode>(
      this, _MTLFX_PRIVATE_SEL(colorProcessingMode));
}
