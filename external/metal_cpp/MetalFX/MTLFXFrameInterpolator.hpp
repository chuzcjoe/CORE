...
_MTLFX_INLINE MTLFX::FrameInterpolatorDescriptor* MTLFX::FrameInterpolatorDescriptor::alloc() {
  return NS::Object::alloc<FrameInterpolatorDescriptor>(
      _MTLFX_PRIVATE_CLS(MTLFXFrameInterpolatorDescriptor));
}
...
_MTLFX_INLINE void MTLFX::FrameInterpolatorDescriptor::setColorTextureFormat(
    MTL::PixelFormat colorTextureFormat) {
...
_MTLFX_INLINE void MTLFX::FrameInterpolatorDescriptor::setOutputTextureFormat(
...
_MTLFX_INLINE void MTLFX::FrameInterpolatorDescriptor::setDepthTextureFormat(
    MTL::PixelFormat depthTextureFormat) {
...
_MTLFX_INLINE void MTLFX::FrameInterpolatorDescriptor::setMotionTextureFormat(
    MTL::PixelFormat motionTextureFormat) {
...
_MTLFX_INLINE void MTLFX::FrameInterpolatorDescriptor::setUITextureFormat(
    MTL::PixelFormat uiTextureFormat) {
  return NS::Object::sendMessage<void>(this, _MTLFX_PRIVATE_SEL(setUITextureFormat_),
                                       uiTextureFormat);
}
...
_MTLFX_INLINE MTLFX::FrameInterpolatableScaler* MTLFX::FrameInterpolatorDescriptor::scaler() const {
  return NS::Object::sendMessage<MTLFX::FrameInterpolatableScaler*>(this,
                                                                    _MTLFX_PRIVATE_SEL(scaler));
}

_MTLFX_INLINE void MTLFX::FrameInterpolatorDescriptor::setScaler(
    MTLFX::FrameInterpolatableScaler* scaler) {
...
_MTLFX_INLINE void MTLFX::FrameInterpolatorBase::setPrevColorTexture(
    MTL::Texture* prevColorTexture) {
  return NS::Object::sendMessage<void>(this, _MTLFX_PRIVATE_SEL(setPrevColorTexture_),
                                       prevColorTexture);
}
...
_MTLFX_INLINE void MTLFX::FrameInterpolatorBase::setIsUITextureComposited(
    bool uiTextureComposited) {
  NS::Object::sendMessage<void>(this, _MTLFX_PRIVATE_SEL(setIsUITextureComposited_),
                                uiTextureComposited);
}
...
_MTLFX_INLINE void MTLFX::FrameInterpolator::encodeToCommandBuffer(
