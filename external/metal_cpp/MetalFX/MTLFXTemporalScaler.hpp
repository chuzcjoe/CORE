...
class TemporalScalerDescriptor : public NS::Copying<TemporalScalerDescriptor> {
 public:
  ...
  MTL4FX::TemporalScaler* newTemporalScaler(const MTL::Device* pDevice,
...
_MTLFX_INLINE MTLFX::TemporalScalerDescriptor* MTLFX::TemporalScalerDescriptor::alloc() {
  return NS::Object::alloc<TemporalScalerDescriptor>(
      _MTLFX_PRIVATE_CLS(MTLFXTemporalScalerDescriptor));
}
...
_MTLFX_INLINE void MTLFX::TemporalScalerDescriptor::setMotionTextureFormat(
...
_MTLFX_INLINE void MTLFX::TemporalScalerDescriptor::setOutputTextureFormat(
    MTL::PixelFormat format) {
...
_MTLFX_INLINE void MTLFX::TemporalScalerDescriptor::setReactiveMaskTextureFormat(
...
_MTLFX_INLINE MTLFX::TemporalScaler* MTLFX::TemporalScalerDescriptor::newTemporalScaler(
  ...
  return Object::sendMessage<TemporalScaler*>(
      this, _MTLFX_PRIVATE_SEL(newTemporalScalerWithDevice_), pDevice);
}
...
_MTLFX_INLINE float MTLFX::TemporalScalerDescriptor::supportedInputContentMinScale(
    const MTL::Device* pDevice) {
  float scale = 1.0f;

  if (nullptr !=
      methodSignatureForSelector(_NS_PRIVATE_CLS(MTLFXTemporalScalerDescriptor),
                                 _MTLFX_PRIVATE_SEL(supportedInputContentMinScaleForDevice_))) {
    scale =
        sendMessage<float>(_NS_PRIVATE_CLS(MTLFXTemporalScalerDescriptor),
...
_MTLFX_INLINE float MTLFX::TemporalScalerDescriptor::supportedInputContentMaxScale(
    const MTL::Device* pDevice) {
  float scale = 1.0f;
...
_MTLFX_INLINE void MTLFX::TemporalScalerBase::setReactiveMaskTexture(
...
_MTLFX_INLINE void MTLFX::TemporalScaler::encodeToCommandBuffer(
