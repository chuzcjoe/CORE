...
_CA_PRIVATE_DEF_SEL(colorspace, "colorspace");
_CA_PRIVATE_DEF_SEL(device, "device");
_CA_PRIVATE_DEF_SEL(displaySyncEnabled, "displaySyncEnabled");
...
_CA_PRIVATE_DEF_SEL(residencySet, "residencySet");
_CA_PRIVATE_DEF_SEL(setAllowsNextDrawableTimeout_, "setAllowsNextDrawableTimeout:");
_CA_PRIVATE_DEF_SEL(setColorspace_, "setColorspace:");
