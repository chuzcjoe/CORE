...
typedef VkResult(VKAPI_PTR *PFN_vkNegotiateLoaderLayerInterfaceVersion)(
...
typedef VkResult(VKAPI_PTR *PFN_vkLayerCreateDevice)(
    VkInstance instance, VkPhysicalDevice physicalDevice, const VkDeviceCreateInfo *pCreateInfo,
    const VkAllocationCallbacks *pAllocator, VkDevice *pDevice, PFN_vkGetInstanceProcAddr layerGIPA,
...
typedef struct VkEnumerateInstanceExtensionPropertiesChain {
  ...
  inline VkResult CallDown(const char *pLayerName, uint32_t *pPropertyCount,
