...
// The number of bits into which the format is packed. A single image element in this format can be
// stored in the same space as a scalar type of this bit width.
...
// The relative height of this plane. A value of k means that this plane is 1/k the height of the
// overall format.
VULKAN_HPP_CONSTEXPR_14 uint8_t planeHeightDivisor(Format format, uint8_t plane);

// The relative width of this plane. A value of k means that this plane is 1/k the width of the
// overall format.
...
VULKAN_HPP_INLINE VULKAN_HPP_CONSTEXPR_14 char const* compatibilityClass(Format format) {
  switch (format) {
    ...
    case Format::eR14X2G14X2B14X2A14X2Unorm4Pack16ARM:
      return "64-bit R14G14B14A14";
    case Format::eG14X2B14X2R14X22Plane420Unorm3Pack16ARM:
      return "14-bit 2-plane 420";
    case Format::eG14X2B14X2R14X22Plane422Unorm3Pack16ARM:
      return "14-bit 2-plane 422";
...
// The name of the component
VULKAN_HPP_INLINE VULKAN_HPP_CONSTEXPR_14 char const* componentName(Format format,
                                                                    uint8_t component) {
  switch (format) {
    case Format::eR4G4UnormPack8:
      switch (component) {
...
// The numeric format of the component
VULKAN_HPP_INLINE VULKAN_HPP_CONSTEXPR_14 char const* componentNumericFormat(Format format,
                                                                             uint8_t component) {
  switch (format) {
    case Format::eR4G4UnormPack8:
      switch (component) {
...
// The plane this component lies in.
VULKAN_HPP_INLINE VULKAN_HPP_CONSTEXPR_14 uint8_t componentPlaneIndex(Format format,
                                                                      uint8_t component) {
  switch (format) {
    case Format::eG8B8R83Plane420Unorm:
      switch (component) {
...
VULKAN_HPP_INLINE std::vector<Format> const& getDepthFormats() {
  static std::vector<Format> depthFormats = {Format::eD16Unorm,       Format::eX8D24UnormPack32,
                                             Format::eD32Sfloat,      Format::eD16UnormS8Uint,
                                             Format::eD24UnormS8Uint, Format::eD32SfloatS8Uint};
  return depthFormats;
}

// Get all formats with a depth and a stencil component
VULKAN_HPP_INLINE std::vector<Format> const& getDepthStencilFormats() {
  static std::vector<Format> depthStencilFormats = {
...
VULKAN_HPP_INLINE std::vector<Format> const& getStencilFormats() {
  static std::vector<Format> stencilFormats = {Format::eS8Uint, Format::eD16UnormS8Uint,
                                               Format::eD24UnormS8Uint, Format::eD32SfloatS8Uint};
...
VULKAN_HPP_INLINE VULKAN_HPP_CONSTEXPR_14 bool isColor(Format format) {
  return hasRedComponent(format) || hasGreenComponent(format) || hasBlueComponent(format) ||
         hasAlphaComponent(format);
}
...
// The single-plane format that this plane is compatible with.
VULKAN_HPP_INLINE VULKAN_HPP_CONSTEXPR_14 Format planeCompatibleFormat(Format format,
                                                                       uint8_t plane) {
  switch (format) {
    case Format::eG8B8R83Plane420Unorm:
      switch (plane) {
    ...
    case Format::eG10X6B10X6R10X63Plane420Unorm3Pack16:
      switch (plane) {
        case 0:
          return Format::eR10X6UnormPack16;
        case 1:
          return Format::eR10X6UnormPack16;
        case 2:
          return Format::eR10X6UnormPack16;
    ...
    case Format::eG10X6B10X6R10X62Plane420Unorm3Pack16:
      switch (plane) {
        case 0:
          return Format::eR10X6UnormPack16;
        case 1:
          return Format::eR10X6G10X6Unorm2Pack16;
        default:
          VULKAN_HPP_ASSERT(false);
          return Format::eUndefined;
      }
    ...
    case Format::eG12X4B12X4R12X43Plane420Unorm3Pack16:
      switch (plane) {
        case 0:
          return Format::eR12X4UnormPack16;
        case 1:
          return Format::eR12X4UnormPack16;
        case 2:
          return Format::eR12X4UnormPack16;
    ...
    case Format::eG12X4B12X4R12X42Plane420Unorm3Pack16:
      switch (plane) {
        case 0:
          return Format::eR12X4UnormPack16;
        case 1:
          return Format::eR12X4G12X4Unorm2Pack16;
        default:
          VULKAN_HPP_ASSERT(false);
          return Format::eUndefined;
      }
    ...
    case Format::eG14X2B14X2R14X22Plane420Unorm3Pack16ARM:
      switch (plane) {
        case 0:
          return Format::eR14X2UnormPack16ARM;
        case 1:
          return Format::eR14X2G14X2Unorm2Pack16ARM;
        default:
          VULKAN_HPP_ASSERT(false);
          return Format::eUndefined;
      }
