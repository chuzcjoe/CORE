...
int main(int argc, char** argv) {
  ...
  // We will also call ImGui_ImplGLUT_InstallFuncs() to get all the other functions installed for
  // us, otherwise it is possible to install our own functions and call the imgui_impl_glut.h
  // functions ourselves.
...
void MainLoopStep() {
  ...
  // glUseProgram(0); // You may want this if using this code in an OpenGL 3+ context where shaders
  // may be bound, but prefer using the GL3+ code.
