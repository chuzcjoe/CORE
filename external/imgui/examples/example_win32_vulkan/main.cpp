...
int main(int, char**) {
  ...
  WNDCLASSEXW wc = {sizeof(wc),
                    ...
                    nullptr};
  ::RegisterClassExW(&wc);
  HWND hwnd = ::CreateWindowW(wc.lpszClassName, L"Dear ImGui Win32+Vulkan Example",
      ...
      if (g_Device != VK_NULL_HANDLE && wParam != SIZE_MINIMIZED) {
        ...
        if (fb_width > 0 && fb_height > 0 &&
          ...
          ImGui_ImplVulkanH_CreateOrResizeWindow(
              g_Instance, g_PhysicalDevice, g_Device, &g_MainWindowData, g_QueueFamily, g_Allocator,
              fb_width, fb_height, g_MinImageCount, g_SwapChainImageUsage);
