...
int main(int, char**) {
  // Setup SDL
  // (Some versions of SDL before <2.0.10 appears to have performance/stalling issues on a minority
  // of Windows systems, depending on whether SDL_INIT_GAMECONTROLLER is enabled or disabled..
  // updating to the latest version of SDL is recommended!)
#ifdef _WIN32
  ::SetProcessDPIAware();
#endif
