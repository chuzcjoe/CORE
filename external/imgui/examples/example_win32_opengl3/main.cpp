...
int main(int, char**) {
  ...
  // ImGui_ImplWin32_EnableDpiAwareness(); // FIXME: This somehow doesn't work in the Win32+OpenGL
  // example. Why?
  ...
  WNDCLASSEXW wc = {sizeof(wc),
                    ...
                    nullptr};
  ::RegisterClassExW(&wc);
  HWND hwnd = ::CreateWindowW(wc.lpszClassName, L"Dear ImGui Win32+OpenGL3 Example",
