...
int main(int, char**) {
  ...
  WNDCLASSEXW wc = {sizeof(wc),
                    ...
                    nullptr};
  ::RegisterClassExW(&wc);
  HWND hwnd = ::CreateWindowW(wc.lpszClassName, L"Dear ImGui DirectX9 Example", WS_OVERLAPPEDWINDOW,
                              100, 100, (int)(1280 * main_scale), (int)(800 * main_scale), nullptr,
...
bool CreateDeviceD3D(HWND hWnd) {
  ...
  g_d3dpp.BackBufferFormat = D3DFMT_UNKNOWN;  // Need to use an explicit format with alpha if
