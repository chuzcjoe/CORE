...
// This requirement will be removed once WebGPU stabilizes and backends converge on a unified
// interface.
...
// ImGui_ImplWGPU_RenderDrawData() call. (Please open an issue if you feel you need access to more
// data)
