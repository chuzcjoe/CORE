...
// - Not well tested. If you want a portable application, prefer using the GLFW or SDL platform
// Backends on Mac.
...
//  ImGuiKey values to all key functions e.g. ImGui::IsKeyPressed(ImGuiKey_Space). [Legacy kVK_*
...
//  with 'io.ConfigFlags |= ImGuiConfigFlags_NoMouseCursorChange'. [X] Platform: IME support.
