...
// engine/app.
// - Unlike other backends, the user must call the function ImGui_ImplSDLGPU_PrepareDrawData BEFORE
// issuing a SDL_GPURenderPass containing ImGui_ImplSDLGPU_RenderDrawData.
...
// - Remember to set ColorTargetFormat to the correct format. If you're rendering to the swapchain,
// call SDL_GetGPUSwapchainTextureFormat() to query the right value
...
IMGUI_IMPL_API void ImGui_ImplSDLGPU3_PrepareDrawData(ImDrawData* draw_data,
                                                      SDL_GPUCommandBuffer* command_buffer);
IMGUI_IMPL_API void ImGui_ImplSDLGPU3_RenderDrawData(ImDrawData* draw_data,
                                                     SDL_GPUCommandBuffer* command_buffer,
...
// ImGui_ImplSDLGPU3_RenderDrawData() call. (Please open an issue if you feel you need access to
// more data)
