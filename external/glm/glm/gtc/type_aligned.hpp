...
#error \
    "GLM: Aligned gentypes require to enable C++ language extensions. Define GLM_FORCE_ALIGNED_GENTYPES before including GLM headers to use aligned types."
#endif
...
/// 1 component vector aligned in memory of single-precision floating-point numbers using high
/// precision arithmetic in term of ULPs.
typedef vec<1, float, aligned_highp> aligned_highp_vec1;

/// 1 component vector aligned in memory of single-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef vec<1, float, aligned_mediump> aligned_mediump_vec1;

/// 1 component vector aligned in memory of single-precision floating-point numbers using low
/// precision arithmetic in term of ULPs.
typedef vec<1, float, aligned_lowp> aligned_lowp_vec1;

/// 1 component vector aligned in memory of double-precision floating-point numbers using high
/// precision arithmetic in term of ULPs.
typedef vec<1, double, aligned_highp> aligned_highp_dvec1;

/// 1 component vector aligned in memory of double-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef vec<1, double, aligned_mediump> aligned_mediump_dvec1;

/// 1 component vector aligned in memory of double-precision floating-point numbers using low
/// precision arithmetic in term of ULPs.
...
/// 1 component vector tightly packed in memory of single-precision floating-point numbers using
/// high precision arithmetic in term of ULPs.
typedef vec<1, float, packed_highp> packed_highp_vec1;

/// 1 component vector tightly packed in memory of single-precision floating-point numbers using
/// medium precision arithmetic in term of ULPs.
typedef vec<1, float, packed_mediump> packed_mediump_vec1;

/// 1 component vector tightly packed in memory of single-precision floating-point numbers using low
/// precision arithmetic in term of ULPs.
typedef vec<1, float, packed_lowp> packed_lowp_vec1;

/// 1 component vector tightly packed in memory of double-precision floating-point numbers using
/// high precision arithmetic in term of ULPs.
...
/// 1 component vector tightly packed in memory of double-precision floating-point numbers using low
/// precision arithmetic in term of ULPs.
...
/// 2 components vector aligned in memory of single-precision floating-point numbers using high
/// precision arithmetic in term of ULPs.
typedef vec<2, float, aligned_highp> aligned_highp_vec2;

/// 2 components vector aligned in memory of single-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef vec<2, float, aligned_mediump> aligned_mediump_vec2;

/// 2 components vector aligned in memory of single-precision floating-point numbers using low
/// precision arithmetic in term of ULPs.
typedef vec<2, float, aligned_lowp> aligned_lowp_vec2;

/// 2 components vector aligned in memory of double-precision floating-point numbers using high
/// precision arithmetic in term of ULPs.
typedef vec<2, double, aligned_highp> aligned_highp_dvec2;

/// 2 components vector aligned in memory of double-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef vec<2, double, aligned_mediump> aligned_mediump_dvec2;

/// 2 components vector aligned in memory of double-precision floating-point numbers using low
/// precision arithmetic in term of ULPs.
...
/// 2 components vector tightly packed in memory of single-precision floating-point numbers using
/// high precision arithmetic in term of ULPs.
...
/// 2 components vector tightly packed in memory of single-precision floating-point numbers using
/// low precision arithmetic in term of ULPs.
typedef vec<2, float, packed_lowp> packed_lowp_vec2;

/// 2 components vector tightly packed in memory of double-precision floating-point numbers using
/// high precision arithmetic in term of ULPs.
...
/// 3 components vector aligned in memory of single-precision floating-point numbers using high
/// precision arithmetic in term of ULPs.
typedef vec<3, float, aligned_highp> aligned_highp_vec3;

/// 3 components vector aligned in memory of single-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef vec<3, float, aligned_mediump> aligned_mediump_vec3;

/// 3 components vector aligned in memory of single-precision floating-point numbers using low
/// precision arithmetic in term of ULPs.
typedef vec<3, float, aligned_lowp> aligned_lowp_vec3;

/// 3 components vector aligned in memory of double-precision floating-point numbers using high
/// precision arithmetic in term of ULPs.
typedef vec<3, double, aligned_highp> aligned_highp_dvec3;

/// 3 components vector aligned in memory of double-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef vec<3, double, aligned_mediump> aligned_mediump_dvec3;

/// 3 components vector aligned in memory of double-precision floating-point numbers using low
/// precision arithmetic in term of ULPs.
...
/// 3 components vector tightly packed in memory of single-precision floating-point numbers using
/// high precision arithmetic in term of ULPs.
...
/// 3 components vector tightly packed in memory of double-precision floating-point numbers using
/// high precision arithmetic in term of ULPs.
...
/// 4 components vector aligned in memory of single-precision floating-point numbers using high
/// precision arithmetic in term of ULPs.
typedef vec<4, float, aligned_highp> aligned_highp_vec4;

/// 4 components vector aligned in memory of single-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef vec<4, float, aligned_mediump> aligned_mediump_vec4;

/// 4 components vector aligned in memory of single-precision floating-point numbers using low
/// precision arithmetic in term of ULPs.
typedef vec<4, float, aligned_lowp> aligned_lowp_vec4;

/// 4 components vector aligned in memory of double-precision floating-point numbers using high
/// precision arithmetic in term of ULPs.
typedef vec<4, double, aligned_highp> aligned_highp_dvec4;

/// 4 components vector aligned in memory of double-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef vec<4, double, aligned_mediump> aligned_mediump_dvec4;

/// 4 components vector aligned in memory of double-precision floating-point numbers using low
/// precision arithmetic in term of ULPs.
...
/// 4 components vector tightly packed in memory of single-precision floating-point numbers using
/// high precision arithmetic in term of ULPs.
...
/// 4 components vector tightly packed in memory of double-precision floating-point numbers using
/// high precision arithmetic in term of ULPs.
...
/// 2 by 2 matrix aligned in memory of single-precision floating-point numbers using high precision
/// arithmetic in term of ULPs.
typedef mat<2, 2, float, aligned_highp> aligned_highp_mat2;

/// 2 by 2 matrix aligned in memory of single-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef mat<2, 2, float, aligned_mediump> aligned_mediump_mat2;

/// 2 by 2 matrix aligned in memory of single-precision floating-point numbers using low precision
/// arithmetic in term of ULPs.
typedef mat<2, 2, float, aligned_lowp> aligned_lowp_mat2;

/// 2 by 2 matrix aligned in memory of double-precision floating-point numbers using high precision
/// arithmetic in term of ULPs.
typedef mat<2, 2, double, aligned_highp> aligned_highp_dmat2;

/// 2 by 2 matrix aligned in memory of double-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef mat<2, 2, double, aligned_mediump> aligned_mediump_dmat2;

/// 2 by 2 matrix aligned in memory of double-precision floating-point numbers using low precision
/// arithmetic in term of ULPs.
typedef mat<2, 2, double, aligned_lowp> aligned_lowp_dmat2;

/// 2 by 2 matrix tightly packed in memory of single-precision floating-point numbers using high
/// precision arithmetic in term of ULPs.
typedef mat<2, 2, float, packed_highp> packed_highp_mat2;

/// 2 by 2 matrix tightly packed in memory of single-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef mat<2, 2, float, packed_mediump> packed_mediump_mat2;

/// 2 by 2 matrix tightly packed in memory of single-precision floating-point numbers using low
/// precision arithmetic in term of ULPs.
typedef mat<2, 2, float, packed_lowp> packed_lowp_mat2;

/// 2 by 2 matrix tightly packed in memory of double-precision floating-point numbers using high
/// precision arithmetic in term of ULPs.
typedef mat<2, 2, double, packed_highp> packed_highp_dmat2;

/// 2 by 2 matrix tightly packed in memory of double-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef mat<2, 2, double, packed_mediump> packed_mediump_dmat2;

/// 2 by 2 matrix tightly packed in memory of double-precision floating-point numbers using low
/// precision arithmetic in term of ULPs.
typedef mat<2, 2, double, packed_lowp> packed_lowp_dmat2;

// -- *mat3 --

/// 3 by 3 matrix aligned in memory of single-precision floating-point numbers using high precision
/// arithmetic in term of ULPs.
typedef mat<3, 3, float, aligned_highp> aligned_highp_mat3;

/// 3 by 3 matrix aligned in memory of single-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef mat<3, 3, float, aligned_mediump> aligned_mediump_mat3;

/// 3 by 3 matrix aligned in memory of single-precision floating-point numbers using low precision
/// arithmetic in term of ULPs.
typedef mat<3, 3, float, aligned_lowp> aligned_lowp_mat3;

/// 3 by 3 matrix aligned in memory of double-precision floating-point numbers using high precision
/// arithmetic in term of ULPs.
typedef mat<3, 3, double, aligned_highp> aligned_highp_dmat3;

/// 3 by 3 matrix aligned in memory of double-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef mat<3, 3, double, aligned_mediump> aligned_mediump_dmat3;

/// 3 by 3 matrix aligned in memory of double-precision floating-point numbers using low precision
/// arithmetic in term of ULPs.
typedef mat<3, 3, double, aligned_lowp> aligned_lowp_dmat3;

/// 3 by 3 matrix tightly packed in memory of single-precision floating-point numbers using high
/// precision arithmetic in term of ULPs.
typedef mat<3, 3, float, packed_highp> packed_highp_mat3;

/// 3 by 3 matrix tightly packed in memory of single-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef mat<3, 3, float, packed_mediump> packed_mediump_mat3;

/// 3 by 3 matrix tightly packed in memory of single-precision floating-point numbers using low
/// precision arithmetic in term of ULPs.
typedef mat<3, 3, float, packed_lowp> packed_lowp_mat3;

/// 3 by 3 matrix tightly packed in memory of double-precision floating-point numbers using high
/// precision arithmetic in term of ULPs.
typedef mat<3, 3, double, packed_highp> packed_highp_dmat3;

/// 3 by 3 matrix tightly packed in memory of double-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef mat<3, 3, double, packed_mediump> packed_mediump_dmat3;

/// 3 by 3 matrix tightly packed in memory of double-precision floating-point numbers using low
/// precision arithmetic in term of ULPs.
typedef mat<3, 3, double, packed_lowp> packed_lowp_dmat3;

// -- *mat4 --

/// 4 by 4 matrix aligned in memory of single-precision floating-point numbers using high precision
/// arithmetic in term of ULPs.
typedef mat<4, 4, float, aligned_highp> aligned_highp_mat4;

/// 4 by 4 matrix aligned in memory of single-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef mat<4, 4, float, aligned_mediump> aligned_mediump_mat4;

/// 4 by 4 matrix aligned in memory of single-precision floating-point numbers using low precision
/// arithmetic in term of ULPs.
typedef mat<4, 4, float, aligned_lowp> aligned_lowp_mat4;

/// 4 by 4 matrix aligned in memory of double-precision floating-point numbers using high precision
/// arithmetic in term of ULPs.
typedef mat<4, 4, double, aligned_highp> aligned_highp_dmat4;

/// 4 by 4 matrix aligned in memory of double-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef mat<4, 4, double, aligned_mediump> aligned_mediump_dmat4;

/// 4 by 4 matrix aligned in memory of double-precision floating-point numbers using low precision
/// arithmetic in term of ULPs.
typedef mat<4, 4, double, aligned_lowp> aligned_lowp_dmat4;

/// 4 by 4 matrix tightly packed in memory of single-precision floating-point numbers using high
/// precision arithmetic in term of ULPs.
typedef mat<4, 4, float, packed_highp> packed_highp_mat4;

/// 4 by 4 matrix tightly packed in memory of single-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef mat<4, 4, float, packed_mediump> packed_mediump_mat4;

/// 4 by 4 matrix tightly packed in memory of single-precision floating-point numbers using low
/// precision arithmetic in term of ULPs.
typedef mat<4, 4, float, packed_lowp> packed_lowp_mat4;

/// 4 by 4 matrix tightly packed in memory of double-precision floating-point numbers using high
/// precision arithmetic in term of ULPs.
typedef mat<4, 4, double, packed_highp> packed_highp_dmat4;

/// 4 by 4 matrix tightly packed in memory of double-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef mat<4, 4, double, packed_mediump> packed_mediump_dmat4;

/// 4 by 4 matrix tightly packed in memory of double-precision floating-point numbers using low
/// precision arithmetic in term of ULPs.
...
/// 2 by 3 matrix aligned in memory of single-precision floating-point numbers using high precision
/// arithmetic in term of ULPs.
typedef mat<2, 3, float, aligned_highp> aligned_highp_mat2x3;

/// 2 by 3 matrix aligned in memory of single-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef mat<2, 3, float, aligned_mediump> aligned_mediump_mat2x3;

/// 2 by 3 matrix aligned in memory of single-precision floating-point numbers using low precision
/// arithmetic in term of ULPs.
typedef mat<2, 3, float, aligned_lowp> aligned_lowp_mat2x3;

/// 2 by 3 matrix aligned in memory of double-precision floating-point numbers using high precision
/// arithmetic in term of ULPs.
typedef mat<2, 3, double, aligned_highp> aligned_highp_dmat2x3;

/// 2 by 3 matrix aligned in memory of double-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef mat<2, 3, double, aligned_mediump> aligned_mediump_dmat2x3;

/// 2 by 3 matrix aligned in memory of double-precision floating-point numbers using low precision
/// arithmetic in term of ULPs.
typedef mat<2, 3, double, aligned_lowp> aligned_lowp_dmat2x3;

/// 2 by 3 matrix tightly packed in memory of single-precision floating-point numbers using high
/// precision arithmetic in term of ULPs.
typedef mat<2, 3, float, packed_highp> packed_highp_mat2x3;

/// 2 by 3 matrix tightly packed in memory of single-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef mat<2, 3, float, packed_mediump> packed_mediump_mat2x3;

/// 2 by 3 matrix tightly packed in memory of single-precision floating-point numbers using low
/// precision arithmetic in term of ULPs.
typedef mat<2, 3, float, packed_lowp> packed_lowp_mat2x3;

/// 2 by 3 matrix tightly packed in memory of double-precision floating-point numbers using high
/// precision arithmetic in term of ULPs.
typedef mat<2, 3, double, packed_highp> packed_highp_dmat2x3;

/// 2 by 3 matrix tightly packed in memory of double-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef mat<2, 3, double, packed_mediump> packed_mediump_dmat2x3;

/// 2 by 3 matrix tightly packed in memory of double-precision floating-point numbers using low
/// precision arithmetic in term of ULPs.
typedef mat<2, 3, double, packed_lowp> packed_lowp_dmat2x3;

// -- *mat2x4 --

/// 2 by 4 matrix aligned in memory of single-precision floating-point numbers using high precision
/// arithmetic in term of ULPs.
typedef mat<2, 4, float, aligned_highp> aligned_highp_mat2x4;

/// 2 by 4 matrix aligned in memory of single-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef mat<2, 4, float, aligned_mediump> aligned_mediump_mat2x4;

/// 2 by 4 matrix aligned in memory of single-precision floating-point numbers using low precision
/// arithmetic in term of ULPs.
typedef mat<2, 4, float, aligned_lowp> aligned_lowp_mat2x4;

/// 2 by 4 matrix aligned in memory of double-precision floating-point numbers using high precision
/// arithmetic in term of ULPs.
typedef mat<2, 4, double, aligned_highp> aligned_highp_dmat2x4;

/// 2 by 4 matrix aligned in memory of double-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef mat<2, 4, double, aligned_mediump> aligned_mediump_dmat2x4;

/// 2 by 4 matrix aligned in memory of double-precision floating-point numbers using low precision
/// arithmetic in term of ULPs.
typedef mat<2, 4, double, aligned_lowp> aligned_lowp_dmat2x4;

/// 2 by 4 matrix tightly packed in memory of single-precision floating-point numbers using high
/// precision arithmetic in term of ULPs.
typedef mat<2, 4, float, packed_highp> packed_highp_mat2x4;

/// 2 by 4 matrix tightly packed in memory of single-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef mat<2, 4, float, packed_mediump> packed_mediump_mat2x4;

/// 2 by 4 matrix tightly packed in memory of single-precision floating-point numbers using low
/// precision arithmetic in term of ULPs.
typedef mat<2, 4, float, packed_lowp> packed_lowp_mat2x4;

/// 2 by 4 matrix tightly packed in memory of double-precision floating-point numbers using high
/// precision arithmetic in term of ULPs.
typedef mat<2, 4, double, packed_highp> packed_highp_dmat2x4;

/// 2 by 4 matrix tightly packed in memory of double-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef mat<2, 4, double, packed_mediump> packed_mediump_dmat2x4;

/// 2 by 4 matrix tightly packed in memory of double-precision floating-point numbers using low
/// precision arithmetic in term of ULPs.
typedef mat<2, 4, double, packed_lowp> packed_lowp_dmat2x4;

// -- *mat3x2 --

/// 3 by 2 matrix aligned in memory of single-precision floating-point numbers using high precision
/// arithmetic in term of ULPs.
typedef mat<3, 2, float, aligned_highp> aligned_highp_mat3x2;

/// 3 by 2 matrix aligned in memory of single-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef mat<3, 2, float, aligned_mediump> aligned_mediump_mat3x2;

/// 3 by 2 matrix aligned in memory of single-precision floating-point numbers using low precision
/// arithmetic in term of ULPs.
typedef mat<3, 2, float, aligned_lowp> aligned_lowp_mat3x2;

/// 3 by 2 matrix aligned in memory of double-precision floating-point numbers using high precision
/// arithmetic in term of ULPs.
typedef mat<3, 2, double, aligned_highp> aligned_highp_dmat3x2;

/// 3 by 2 matrix aligned in memory of double-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef mat<3, 2, double, aligned_mediump> aligned_mediump_dmat3x2;

/// 3 by 2 matrix aligned in memory of double-precision floating-point numbers using low precision
/// arithmetic in term of ULPs.
typedef mat<3, 2, double, aligned_lowp> aligned_lowp_dmat3x2;

/// 3 by 2 matrix tightly packed in memory of single-precision floating-point numbers using high
/// precision arithmetic in term of ULPs.
typedef mat<3, 2, float, packed_highp> packed_highp_mat3x2;

/// 3 by 2 matrix tightly packed in memory of single-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef mat<3, 2, float, packed_mediump> packed_mediump_mat3x2;

/// 3 by 2 matrix tightly packed in memory of single-precision floating-point numbers using low
/// precision arithmetic in term of ULPs.
typedef mat<3, 2, float, packed_lowp> packed_lowp_mat3x2;

/// 3 by 2 matrix tightly packed in memory of double-precision floating-point numbers using high
/// precision arithmetic in term of ULPs.
typedef mat<3, 2, double, packed_highp> packed_highp_dmat3x2;

/// 3 by 2 matrix tightly packed in memory of double-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef mat<3, 2, double, packed_mediump> packed_mediump_dmat3x2;

/// 3 by 2 matrix tightly packed in memory of double-precision floating-point numbers using low
/// precision arithmetic in term of ULPs.
...
/// 3 by 4 matrix aligned in memory of single-precision floating-point numbers using high precision
/// arithmetic in term of ULPs.
typedef mat<3, 4, float, aligned_highp> aligned_highp_mat3x4;

/// 3 by 4 matrix aligned in memory of single-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef mat<3, 4, float, aligned_mediump> aligned_mediump_mat3x4;

/// 3 by 4 matrix aligned in memory of single-precision floating-point numbers using low precision
/// arithmetic in term of ULPs.
typedef mat<3, 4, float, aligned_lowp> aligned_lowp_mat3x4;

/// 3 by 4 matrix aligned in memory of double-precision floating-point numbers using high precision
/// arithmetic in term of ULPs.
typedef mat<3, 4, double, aligned_highp> aligned_highp_dmat3x4;

/// 3 by 4 matrix aligned in memory of double-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef mat<3, 4, double, aligned_mediump> aligned_mediump_dmat3x4;

/// 3 by 4 matrix aligned in memory of double-precision floating-point numbers using low precision
/// arithmetic in term of ULPs.
typedef mat<3, 4, double, aligned_lowp> aligned_lowp_dmat3x4;

/// 3 by 4 matrix tightly packed in memory of single-precision floating-point numbers using high
/// precision arithmetic in term of ULPs.
typedef mat<3, 4, float, packed_highp> packed_highp_mat3x4;

/// 3 by 4 matrix tightly packed in memory of single-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef mat<3, 4, float, packed_mediump> packed_mediump_mat3x4;

/// 3 by 4 matrix tightly packed in memory of single-precision floating-point numbers using low
/// precision arithmetic in term of ULPs.
typedef mat<3, 4, float, packed_lowp> packed_lowp_mat3x4;

/// 3 by 4 matrix tightly packed in memory of double-precision floating-point numbers using high
/// precision arithmetic in term of ULPs.
typedef mat<3, 4, double, packed_highp> packed_highp_dmat3x4;

/// 3 by 4 matrix tightly packed in memory of double-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef mat<3, 4, double, packed_mediump> packed_mediump_dmat3x4;

/// 3 by 4 matrix tightly packed in memory of double-precision floating-point numbers using low
/// precision arithmetic in term of ULPs.
typedef mat<3, 4, double, packed_lowp> packed_lowp_dmat3x4;

// -- *mat4x2 --

/// 4 by 2 matrix aligned in memory of single-precision floating-point numbers using high precision
/// arithmetic in term of ULPs.
typedef mat<4, 2, float, aligned_highp> aligned_highp_mat4x2;

/// 4 by 2 matrix aligned in memory of single-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef mat<4, 2, float, aligned_mediump> aligned_mediump_mat4x2;

/// 4 by 2 matrix aligned in memory of single-precision floating-point numbers using low precision
/// arithmetic in term of ULPs.
typedef mat<4, 2, float, aligned_lowp> aligned_lowp_mat4x2;

/// 4 by 2 matrix aligned in memory of double-precision floating-point numbers using high precision
/// arithmetic in term of ULPs.
typedef mat<4, 2, double, aligned_highp> aligned_highp_dmat4x2;

/// 4 by 2 matrix aligned in memory of double-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef mat<4, 2, double, aligned_mediump> aligned_mediump_dmat4x2;

/// 4 by 2 matrix aligned in memory of double-precision floating-point numbers using low precision
/// arithmetic in term of ULPs.
typedef mat<4, 2, double, aligned_lowp> aligned_lowp_dmat4x2;

/// 4 by 2 matrix tightly packed in memory of single-precision floating-point numbers using high
/// precision arithmetic in term of ULPs.
typedef mat<4, 2, float, packed_highp> packed_highp_mat4x2;

/// 4 by 2 matrix tightly packed in memory of single-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef mat<4, 2, float, packed_mediump> packed_mediump_mat4x2;

/// 4 by 2 matrix tightly packed in memory of single-precision floating-point numbers using low
/// precision arithmetic in term of ULPs.
typedef mat<4, 2, float, packed_lowp> packed_lowp_mat4x2;

/// 4 by 2 matrix tightly packed in memory of double-precision floating-point numbers using high
/// precision arithmetic in term of ULPs.
typedef mat<4, 2, double, packed_highp> packed_highp_dmat4x2;

/// 4 by 2 matrix tightly packed in memory of double-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef mat<4, 2, double, packed_mediump> packed_mediump_dmat4x2;

/// 4 by 2 matrix tightly packed in memory of double-precision floating-point numbers using low
/// precision arithmetic in term of ULPs.
typedef mat<4, 2, double, packed_lowp> packed_lowp_dmat4x2;

// -- *mat4x3 --

/// 4 by 3 matrix aligned in memory of single-precision floating-point numbers using high precision
/// arithmetic in term of ULPs.
typedef mat<4, 3, float, aligned_highp> aligned_highp_mat4x3;

/// 4 by 3 matrix aligned in memory of single-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef mat<4, 3, float, aligned_mediump> aligned_mediump_mat4x3;

/// 4 by 3 matrix aligned in memory of single-precision floating-point numbers using low precision
/// arithmetic in term of ULPs.
typedef mat<4, 3, float, aligned_lowp> aligned_lowp_mat4x3;

/// 4 by 3 matrix aligned in memory of double-precision floating-point numbers using high precision
/// arithmetic in term of ULPs.
typedef mat<4, 3, double, aligned_highp> aligned_highp_dmat4x3;

/// 4 by 3 matrix aligned in memory of double-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef mat<4, 3, double, aligned_mediump> aligned_mediump_dmat4x3;

/// 4 by 3 matrix aligned in memory of double-precision floating-point numbers using low precision
/// arithmetic in term of ULPs.
typedef mat<4, 3, double, aligned_lowp> aligned_lowp_dmat4x3;

/// 4 by 3 matrix tightly packed in memory of single-precision floating-point numbers using high
/// precision arithmetic in term of ULPs.
typedef mat<4, 3, float, packed_highp> packed_highp_mat4x3;

/// 4 by 3 matrix tightly packed in memory of single-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef mat<4, 3, float, packed_mediump> packed_mediump_mat4x3;

/// 4 by 3 matrix tightly packed in memory of single-precision floating-point numbers using low
/// precision arithmetic in term of ULPs.
typedef mat<4, 3, float, packed_lowp> packed_lowp_mat4x3;

/// 4 by 3 matrix tightly packed in memory of double-precision floating-point numbers using high
/// precision arithmetic in term of ULPs.
typedef mat<4, 3, double, packed_highp> packed_highp_dmat4x3;

/// 4 by 3 matrix tightly packed in memory of double-precision floating-point numbers using medium
/// precision arithmetic in term of ULPs.
typedef mat<4, 3, double, packed_mediump> packed_mediump_dmat4x3;

/// 4 by 3 matrix tightly packed in memory of double-precision floating-point numbers using low
/// precision arithmetic in term of ULPs.
