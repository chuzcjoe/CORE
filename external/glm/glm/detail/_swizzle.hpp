...
struct _swizzle_base1<2, T, Q, E0, E1, -1, -2, Aligned> : public _swizzle_base0<T, 2> {
  GLM_FUNC_QUALIFIER vec<2, T, Q> operator()() const {
    return vec<2, T, Q>(this->elem(E0), this->elem(E1));
  }
};
...
struct _swizzle_base1<3, T, Q, E0, E1, E2, -1, Aligned> : public _swizzle_base0<T, 3> {
  GLM_FUNC_QUALIFIER vec<3, T, Q> operator()() const {
    return vec<3, T, Q>(this->elem(E0), this->elem(E1), this->elem(E2));
  }
};
...
struct _swizzle_base1<4, T, Q, E0, E1, E2, E3, Aligned> : public _swizzle_base0<T, 4> {
  GLM_FUNC_QUALIFIER vec<4, T, Q> operator()() const {
    return vec<4, T, Q>(this->elem(E0), this->elem(E1), this->elem(E2), this->elem(E3));
  }
};
...
struct _swizzle_base2
    : public _swizzle_base1<N, T, Q, E0, E1, E2, E3, detail::is_aligned<Q>::value> {
  struct op_equal {
 ...
 public:
  ...
  GLM_FUNC_QUALIFIER void operator-=(vec<N, T, Q> const& that) { _apply_op(that, op_minus()); }

  GLM_FUNC_QUALIFIER void operator+=(vec<N, T, Q> const& that) { _apply_op(that, op_plus()); }

  GLM_FUNC_QUALIFIER void operator*=(vec<N, T, Q> const& that) { _apply_op(that, op_mul()); }

  GLM_FUNC_QUALIFIER void operator/=(vec<N, T, Q> const& that) { _apply_op(that, op_div()); }
...
struct _swizzle_base2<N, T, Q, E0, E1, E2, E3, 1>
    : public _swizzle_base1<N, T, Q, E0, E1, E2, E3, detail::is_aligned<Q>::value> {
  struct Stub {};
...
template <int N, typename T, qualifier Q, int E0, int E1, int E2, int E3>
struct _swizzle : public _swizzle_base2<N, T, Q, E0, E1, E2, E3,
                                        (E0 == E1 || E0 == E2 || E0 == E3 || E1 == E2 || E1 == E3 ||
                                         E2 == E3)> {
  typedef _swizzle_base2<N, T, Q, E0, E1, E2, E3,
...
//
#define GLM_SWIZZLE_TEMPLATE1 \
  template <int N, typename T, qualifier Q, int E0, int E1, int E2, int E3>
#define GLM_SWIZZLE_TEMPLATE2                                                               \
  template <int N, typename T, qualifier Q, int E0, int E1, int E2, int E3, int F0, int F1, \
            int F2, int F3>
...
#define GLM_SWIZZLE_VECTOR_BINARY_OPERATOR_IMPLEMENTATION(OPERAND)                \
  ...
  GLM_FUNC_QUALIFIER vec<N, T, Q> operator OPERAND(const GLM_SWIZZLE_TYPE1 & a,   \
                                                   const GLM_SWIZZLE_TYPE2 & b) { \
    return a() OPERAND b();                                                       \
  }                                                                               \
...
#define GLM_SWIZZLE_FUNCTION_1_ARGS(RETURN_TYPE, FUNCTION)             \
  GLM_SWIZZLE_TEMPLATE1                                                \
  GLM_FUNC_QUALIFIER typename GLM_SWIZZLE_TYPE1::RETURN_TYPE FUNCTION( \
      const GLM_SWIZZLE_TYPE1& a) {                                    \
    return FUNCTION(a());                                              \
  }
...
#define GLM_SWIZZLE_FUNCTION_2_ARGS(RETURN_TYPE, FUNCTION)                                        \
  GLM_SWIZZLE_TEMPLATE2                                                                           \
  GLM_FUNC_QUALIFIER typename GLM_SWIZZLE_TYPE1::RETURN_TYPE FUNCTION(                            \
      const GLM_SWIZZLE_TYPE1& a, const GLM_SWIZZLE_TYPE2& b) {                                   \
    return FUNCTION(a(), b());                                                                    \
  }                                                                                               \
  GLM_SWIZZLE_TEMPLATE1                                                                           \
  GLM_FUNC_QUALIFIER typename GLM_SWIZZLE_TYPE1::RETURN_TYPE FUNCTION(                            \
      const GLM_SWIZZLE_TYPE1& a, const GLM_SWIZZLE_TYPE1& b) {                                   \
    return FUNCTION(a(), b());                                                                    \
  }                                                                                               \
  GLM_SWIZZLE_TEMPLATE1                                                                           \
  ...
  GLM_SWIZZLE_TEMPLATE1                                                                           \
  GLM_FUNC_QUALIFIER typename GLM_SWIZZLE_TYPE1::RETURN_TYPE FUNCTION(                            \
      const V& a, const GLM_SWIZZLE_TYPE1& b) {                                                   \
    return FUNCTION(a, b());                                                                      \
  }
...
#define GLM_SWIZZLE_FUNCTION_2_ARGS_SCALAR(RETURN_TYPE, FUNCTION)               \
  GLM_SWIZZLE_TEMPLATE2                                                         \
  GLM_FUNC_QUALIFIER typename GLM_SWIZZLE_TYPE1::RETURN_TYPE FUNCTION(          \
      const GLM_SWIZZLE_TYPE1& a, const GLM_SWIZZLE_TYPE2& b, const T& c) {     \
    return FUNCTION(a(), b(), c);                                               \
  }                                                                             \
  GLM_SWIZZLE_TEMPLATE1                                                         \
  GLM_FUNC_QUALIFIER typename GLM_SWIZZLE_TYPE1::RETURN_TYPE FUNCTION(          \
      const GLM_SWIZZLE_TYPE1& a, const GLM_SWIZZLE_TYPE1& b, const T& c) {     \
    return FUNCTION(a(), b(), c);                                               \
  }                                                                             \
  GLM_SWIZZLE_TEMPLATE1                                                         \
  GLM_FUNC_QUALIFIER typename GLM_SWIZZLE_TYPE1::RETURN_TYPE FUNCTION(          \
      const GLM_SWIZZLE_TYPE1& a, const typename S0::vec_type& b, const T& c) { \
    return FUNCTION(a(), b, c);                                                 \
  }                                                                             \
  GLM_SWIZZLE_TEMPLATE1                                                         \
  GLM_FUNC_QUALIFIER typename GLM_SWIZZLE_TYPE1::RETURN_TYPE FUNCTION(          \
      const typename V& a, const GLM_SWIZZLE_TYPE1& b, const T& c) {            \
    return FUNCTION(a, b(), c);                                                 \
  }
...
#define GLM_SWIZZLE3_3_MEMBERS(T, Q, E0, E1, E2)       \
  ...
  struct {                                             \
    detail::_swizzle<3, T, Q, 0, 0, 2, -1> E0##E0##E2; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 0, 1, 0, -1> E0##E1##E0; \
  };                                                   \
  ...
  struct {                                             \
    detail::_swizzle<3, T, Q, 0, 1, 2, -1> E0##E1##E2; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 0, 2, 0, -1> E0##E2##E0; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 0, 2, 1, -1> E0##E2##E1; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 0, 2, 2, -1> E0##E2##E2; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 1, 0, 0, -1> E1##E0##E0; \
  };                                                   \
  ...
  struct {                                             \
    detail::_swizzle<3, T, Q, 1, 0, 2, -1> E1##E0##E2; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 1, 1, 0, -1> E1##E1##E0; \
  };                                                   \
  ...
  struct {                                             \
    detail::_swizzle<3, T, Q, 1, 1, 2, -1> E1##E1##E2; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 1, 2, 0, -1> E1##E2##E0; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 1, 2, 1, -1> E1##E2##E1; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 1, 2, 2, -1> E1##E2##E2; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 2, 0, 0, -1> E2##E0##E0; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 2, 0, 1, -1> E2##E0##E1; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 2, 0, 2, -1> E2##E0##E2; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 2, 1, 0, -1> E2##E1##E0; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 2, 1, 1, -1> E2##E1##E1; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 2, 1, 2, -1> E2##E1##E2; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 2, 2, 0, -1> E2##E2##E0; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 2, 2, 1, -1> E2##E2##E1; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 2, 2, 2, -1> E2##E2##E2; \
  };
...
#define GLM_SWIZZLE4_3_MEMBERS(T, Q, E0, E1, E2, E3)   \
  ...
  struct {                                             \
    detail::_swizzle<3, T, Q, 0, 0, 3, -1> E0##E0##E3; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 0, 1, 0, -1> E0##E1##E0; \
  };                                                   \
  ...
  struct {                                             \
    detail::_swizzle<3, T, Q, 0, 1, 3, -1> E0##E1##E3; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 0, 2, 0, -1> E0##E2##E0; \
  };                                                   \
  ...
  struct {                                             \
    detail::_swizzle<3, T, Q, 0, 2, 3, -1> E0##E2##E3; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 0, 3, 0, -1> E0##E3##E0; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 0, 3, 1, -1> E0##E3##E1; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 0, 3, 2, -1> E0##E3##E2; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 0, 3, 3, -1> E0##E3##E3; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 1, 0, 0, -1> E1##E0##E0; \
  };                                                   \
  ...
  struct {                                             \
    detail::_swizzle<3, T, Q, 1, 0, 3, -1> E1##E0##E3; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 1, 1, 0, -1> E1##E1##E0; \
  };                                                   \
  ...
  struct {                                             \
    detail::_swizzle<3, T, Q, 1, 1, 3, -1> E1##E1##E3; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 1, 2, 0, -1> E1##E2##E0; \
  };                                                   \
  ...
  struct {                                             \
    detail::_swizzle<3, T, Q, 1, 2, 3, -1> E1##E2##E3; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 1, 3, 0, -1> E1##E3##E0; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 1, 3, 1, -1> E1##E3##E1; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 1, 3, 2, -1> E1##E3##E2; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 1, 3, 3, -1> E1##E3##E3; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 2, 0, 0, -1> E2##E0##E0; \
  };                                                   \
  ...
  struct {                                             \
    detail::_swizzle<3, T, Q, 2, 0, 3, -1> E2##E0##E3; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 2, 1, 0, -1> E2##E1##E0; \
  };                                                   \
  ...
  struct {                                             \
    detail::_swizzle<3, T, Q, 2, 1, 3, -1> E2##E1##E3; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 2, 2, 0, -1> E2##E2##E0; \
  };                                                   \
  ...
  struct {                                             \
    detail::_swizzle<3, T, Q, 2, 2, 3, -1> E2##E2##E3; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 2, 3, 0, -1> E2##E3##E0; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 2, 3, 1, -1> E2##E3##E1; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 2, 3, 2, -1> E2##E3##E2; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 2, 3, 3, -1> E2##E3##E3; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 3, 0, 0, -1> E3##E0##E0; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 3, 0, 1, -1> E3##E0##E1; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 3, 0, 2, -1> E3##E0##E2; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 3, 0, 3, -1> E3##E0##E3; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 3, 1, 0, -1> E3##E1##E0; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 3, 1, 1, -1> E3##E1##E1; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 3, 1, 2, -1> E3##E1##E2; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 3, 1, 3, -1> E3##E1##E3; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 3, 2, 0, -1> E3##E2##E0; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 3, 2, 1, -1> E3##E2##E1; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 3, 2, 2, -1> E3##E2##E2; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 3, 2, 3, -1> E3##E2##E3; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 3, 3, 0, -1> E3##E3##E0; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 3, 3, 1, -1> E3##E3##E1; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 3, 3, 2, -1> E3##E3##E2; \
  };                                                   \
  struct {                                             \
    detail::_swizzle<3, T, Q, 3, 3, 3, -1> E3##E3##E3; \
  };
