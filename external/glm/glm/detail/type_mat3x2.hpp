...
struct mat<3, 2, T, Q> {
 ...
 public:
  ...
  GLM_CTOR_DECL mat(T x0, T y0, T x1, T y1, T x2, T y2);
  GLM_CTOR_DECL mat(col_type const& v0, col_type const& v1, col_type const& v2);

  // -- Conversions --

  template <typename X1, typename Y1, typename X2, typename Y2, typename X3, typename Y3>
  GLM_CTOR_DECL mat(X1 x1, Y1 y1, X2 x2, Y2 y2, X3 x3, Y3 y3);

  template <typename V1, typename V2, typename V3>
  GLM_CTOR_DECL mat(vec<2, V1, Q> const& v1, vec<2, V2, Q> const& v2, vec<2, V3, Q> const& v3);
...
template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR mat<3, 2, T, Q> operator+(mat<3, 2, T, Q> const& m1,
...
template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR typename mat<3, 2, T, Q>::col_type operator*(
    mat<3, 2, T, Q> const& m, typename mat<3, 2, T, Q>::row_type const& v);

template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR typename mat<3, 2, T, Q>::row_type operator*(
    typename mat<3, 2, T, Q>::col_type const& v, mat<3, 2, T, Q> const& m);

template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR mat<2, 2, T, Q> operator*(mat<3, 2, T, Q> const& m1,
...
template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR mat<4, 2, T, Q> operator*(mat<3, 2, T, Q> const& m1,
