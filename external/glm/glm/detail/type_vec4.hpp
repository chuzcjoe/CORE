...
#pragma warning(pop)
  ...
  /// Explicit conversions (From section 5.4.1 Conversion and scalar constructors of GLSL 1.30.08
  /// specification)
  ...
  GLM_FUNC_DISCARD_DECL vec(detail::_swizzle<2, T, Q, E0, E1, -1, -2> const& v,
                            detail::_swizzle<2, T, Q, F0, F1, -1, -2> const& u) {
    *this = vec<4, T, Q>(v(), u());
  }

  template <int E0, int E1>
  GLM_FUNC_DISCARD_DECL vec(T const& x, T const& y,
                            detail::_swizzle<2, T, Q, E0, E1, -1, -2> const& v) {
    *this = vec<4, T, Q>(x, y, v());
  }

  template <int E0, int E1>
  GLM_FUNC_DISCARD_DECL vec(T const& x, detail::_swizzle<2, T, Q, E0, E1, -1, -2> const& v,
                            T const& w) {
    *this = vec<4, T, Q>(x, v(), w);
  }

  template <int E0, int E1>
  GLM_FUNC_DISCARD_DECL vec(detail::_swizzle<2, T, Q, E0, E1, -1, -2> const& v, T const& z,
                            T const& w) {
...
template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR vec<4, T, Q> operator%(vec<1, T, Q> const& scalar,
                                                   vec<4, T, Q> const& v);
...
GLM_FUNC_DECL GLM_CONSTEXPR vec<4, bool, Q> operator&&(vec<4, bool, Q> const& v1,
