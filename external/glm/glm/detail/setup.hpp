...
#define GLM_VERSION_COMPLETE \
  GLM_MAKE_API_VERSION(0, GLM_VERSION_MAJOR, GLM_VERSION_MINOR, GLM_VERSION_PATCH)
...
#if defined(_M_ARM64) || defined(__LP64__) || defined(_M_X64) || defined(__ppc64__) || \
    defined(__x86_64__)
...
// GLM_FORCE_CXX17, GLM_FORCE_CXX2A
...
#define GLM_LANG (GLM_LANG_CXX17 | GLM_LANG_EXT)
#elif __cplusplus == 201402L || __cplusplus == 201406L || __cplusplus == 201500L || \
    GLM_LANG_PLATFORM == 201402L
#define GLM_LANG (GLM_LANG_CXX14 | GLM_LANG_EXT)
...
#define GLM_HAS_CXX11_STL                                                             \
  ((GLM_LANG & GLM_LANG_CXX0X_FLAG) &&                                                \
   (((GLM_COMPILER & GLM_COMPILER_GCC) && (GLM_COMPILER >= GLM_COMPILER_GCC48)) ||    \
    ...
    ((GLM_PLATFORM != GLM_PLATFORM_WINDOWS) && (GLM_COMPILER & GLM_COMPILER_INTEL) && \
     (GLM_COMPILER >= GLM_COMPILER_INTEL15))))
#endif
...
#define GLM_HAS_STATIC_ASSERT                                                     \
  ((GLM_LANG & GLM_LANG_CXX0X_FLAG) &&                                            \
   (((GLM_COMPILER & GLM_COMPILER_CUDA)) || ((GLM_COMPILER & GLM_COMPILER_VC)) || \
...
#define GLM_HAS_INITIALIZER_LISTS                                                      \
  ((GLM_LANG & GLM_LANG_CXX0X_FLAG) &&                                                 \
   (((GLM_COMPILER & GLM_COMPILER_VC) && (GLM_COMPILER >= GLM_COMPILER_VC15)) ||       \
    ...
    ((GLM_COMPILER & GLM_COMPILER_CUDA)) || ((GLM_COMPILER & GLM_COMPILER_HIP))))
#endif
...
#define GLM_HAS_UNRESTRICTED_UNIONS                                                \
  (GLM_LANG & GLM_LANG_CXX0X_FLAG) &&                                              \
      ((GLM_COMPILER & GLM_COMPILER_VC) || ((GLM_COMPILER & GLM_COMPILER_CUDA)) || \
       ((GLM_COMPILER & GLM_COMPILER_HIP)))
#endif
...
#define GLM_HAS_DEFAULTED_FUNCTIONS                                                     \
  ((GLM_LANG & GLM_LANG_CXX0X_FLAG) &&                                                  \
       (((GLM_COMPILER & GLM_COMPILER_VC) && (GLM_COMPILER >= GLM_COMPILER_VC12)) ||    \
        ((GLM_COMPILER & GLM_COMPILER_INTEL)) || (GLM_COMPILER & GLM_COMPILER_CUDA)) || \
   ((GLM_COMPILER & GLM_COMPILER_HIP)))
#endif
...
#define GLM_HAS_RANGE_FOR                                                          \
  ((GLM_LANG & GLM_LANG_CXX0X_FLAG) &&                                             \
   (((GLM_COMPILER & GLM_COMPILER_INTEL)) || ((GLM_COMPILER & GLM_COMPILER_VC)) || \
    ((GLM_COMPILER & GLM_COMPILER_CUDA)) || ((GLM_COMPILER & GLM_COMPILER_HIP))))
#endif
...
// http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2007/n2235.pdf N3652 Extended Constant
// Expressions http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2013/n3652.html
...
#define GLM_HAS_CONSTEXPR                                                              \
  ((GLM_LANG & GLM_LANG_CXX0X_FLAG) && GLM_HAS_INITIALIZER_LISTS &&                    \
...
#error \
    "GLM error: GLM_CUDA_FORCE_DEVICE_FUNC and GLM_CUDA_FORCE_HOST_FUNC should not be defined at the same time, GLM by default generates both device and host code for CUDA compiler."
...
#if (GLM_COMPILER & GLM_COMPILER_VC) || \
    ((GLM_COMPILER & GLM_COMPILER_INTEL) && (GLM_PLATFORM & GLM_PLATFORM_WINDOWS))
#define GLM_DEPRECATED __declspec(deprecated)
#define GLM_ALIGNED_TYPEDEF(type, name, alignment) typedef __declspec(align(alignment)) type name
#elif GLM_COMPILER & (GLM_COMPILER_GCC | GLM_COMPILER_CLANG | GLM_COMPILER_INTEL)
#define GLM_DEPRECATED __attribute__((__deprecated__))
#define GLM_ALIGNED_TYPEDEF(type, name, alignment) \
  typedef type name __attribute__((aligned(alignment)))
#elif (GLM_COMPILER & GLM_COMPILER_CUDA) || (GLM_COMPILER & GLM_COMPILER_HIP)
...
#define GLM_FORCE_ALIGNED_GENTYPES
    ...
    (defined(GLM_FORCE_ALIGNED_GENTYPES) || (GLM_CONFIG_SIMD == GLM_ENABLE))
...
#if ((GLM_CONFIG_SIMD == GLM_ENABLE) || (GLM_CONFIG_SWIZZLE == GLM_SWIZZLE_OPERATOR) || \
     (GLM_CONFIG_ALIGNED_GENTYPES == GLM_ENABLE))
...
#error \
    "GLM error: A different version of GLM is already included. Define GLM_FORCE_IGNORE_VERSION before including GLM headers to ignore this error."
...
#pragma message( \
    "GLM: GLM_FORCE_XYZW_ONLY is defined. Only x, y, z and w component are available in vector type. This define disables swizzle operators and SIMD instruction sets.")
#endif
...
#pragma message( \
    "GLM: GLM_FORCE_SWIZZLE is defined, swizzling functions enabled. Enable compiler C++ language extensions to enable swizzle operators.")
#else
#pragma message( \
...
#if GLM_CONFIG_LENGTH_TYPE == GLM_LENGTH_SIZE_T
#pragma message( \
    "GLM: GLM_FORCE_SIZE_T_LENGTH is defined. .length() returns a glm::length_t, a typedef of std::size_t.")
#else
#pragma message( \
...
#pragma message( \
    "GLM: GLM_FORCE_UNRESTRICTED_GENTYPE is defined. Removes GLSL restrictions on valid function genTypes.")
#else
#pragma message( \
...
#pragma message( \
    "GLM: GLM_FORCE_SILENT_WARNINGS is defined. Ignores C++ warnings from using C++ language extensions.")
#else
#pragma message( \
...
#pragma message( \
    "GLM: GLM_FORCE_SINGLE_ONLY is defined. Using only single precision floating-point types.")
#endif

#if defined(GLM_FORCE_ALIGNED_GENTYPES) && (GLM_CONFIG_ALIGNED_GENTYPES == GLM_ENABLE)
#undef GLM_FORCE_ALIGNED_GENTYPES
#pragma message( \
    "GLM: GLM_FORCE_ALIGNED_GENTYPES is defined, allowing aligned types. This prevents the use of C++ constexpr.")
#elif defined(GLM_FORCE_ALIGNED_GENTYPES) && (GLM_CONFIG_ALIGNED_GENTYPES == GLM_DISABLE)
#undef GLM_FORCE_ALIGNED_GENTYPES
#pragma message( \
    "GLM: GLM_FORCE_ALIGNED_GENTYPES is defined but is disabled. It requires C++11 and language extensions.")
#endif
...
#pragma message( \
    "GLM: GLM_FORCE_DEFAULT_ALIGNED_GENTYPES is defined but is disabled. It requires C++11 and language extensions.")
#elif GLM_CONFIG_ALIGNED_GENTYPES == GLM_ENABLE
#pragma message( \
    "GLM: GLM_FORCE_DEFAULT_ALIGNED_GENTYPES is defined. All gentypes (e.g. vec3) will be aligned and padded by default.")
#endif
#endif
