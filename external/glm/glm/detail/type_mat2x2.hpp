...
struct mat<2, 2, T, Q> {
 ...
 public:
  ...
  GLM_CTOR_DECL mat(T const& x1, T const& y1, T const& x2, T const& y2);
  GLM_CTOR_DECL mat(col_type const& v1, col_type const& v2);

  // -- Conversions --

  template <typename U, typename V, typename M, typename N>
  GLM_CTOR_DECL mat(U const& x1, V const& y1, M const& x2, N const& y2);

  template <typename U, typename V>
  GLM_CTOR_DECL mat(vec<2, U, Q> const& v1, vec<2, V, Q> const& v2);
...
template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR mat<2, 2, T, Q> operator+(mat<2, 2, T, Q> const& m1,
...
template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR typename mat<2, 2, T, Q>::col_type operator*(
    mat<2, 2, T, Q> const& m, typename mat<2, 2, T, Q>::row_type const& v);

template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR typename mat<2, 2, T, Q>::row_type operator*(
    typename mat<2, 2, T, Q>::col_type const& v, mat<2, 2, T, Q> const& m);
...
template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR mat<3, 2, T, Q> operator*(mat<2, 2, T, Q> const& m1,
                                                      mat<3, 2, T, Q> const& m2);

template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR mat<4, 2, T, Q> operator*(mat<2, 2, T, Q> const& m1,
