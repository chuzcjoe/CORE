...
struct compute_vec_and<L, T, Q, IsInt, Size, false> {
  GLM_FUNC_QUALIFIER GLM_CONSTEXPR static vec<L, T, Q> call(vec<L, T, Q> const& a,
                                                            vec<L, T, Q> const& b) {
    vec<L, T, Q> v(a);
    for (length_t i = 0; i < L; ++i) v[i] &= static_cast<T>(b[i]);
    return v;
  }
};
...
struct compute_vec_equal<L, T, Q, IsInt, Size, false> {
  GLM_FUNC_QUALIFIER GLM_CONSTEXPR static bool call(vec<L, T, Q> const& v1,
                                                    vec<L, T, Q> const& v2) {
    bool b = true;
...
struct compute_vec_nequal<L, T, Q, IsInt, Size, false> {
  GLM_FUNC_QUALIFIER GLM_CONSTEXPR static bool call(vec<4, T, Q> const& v1,
                                                    vec<4, T, Q> const& v2) {
    return !compute_vec_equal<L, T, Q, detail::is_int<T>::value, sizeof(T) * 8,
...
struct compute_vec_bitwise_not<L, T, Q, IsInt, Size, false> {
  GLM_FUNC_QUALIFIER GLM_CONSTEXPR static vec<L, T, Q> call(vec<L, T, Q> const& a) {
    vec<L, T, Q> v(a);
    for (length_t i = 0; i < L; ++i) v[i] = ~v[i];
    return v;
  }
};
