...
struct mat<2, 3, T, Q> {
 ...
 public:
  ...
  GLM_CTOR_DECL mat(T x0, T y0, T z0, T x1, T y1, T z1);
  GLM_CTOR_DECL mat(col_type const& v0, col_type const& v1);

  // -- Conversions --

  template <typename X1, typename Y1, typename Z1, typename X2, typename Y2, typename Z2>
  GLM_CTOR_DECL mat(X1 x1, Y1 y1, Z1 z1, X2 x2, Y2 y2, Z2 z2);

  template <typename U, typename V>
  GLM_CTOR_DECL mat(vec<3, U, Q> const& v1, vec<3, V, Q> const& v2);
...
template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR mat<2, 3, T, Q> operator+(mat<2, 3, T, Q> const& m1,
...
template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR typename mat<2, 3, T, Q>::col_type operator*(
    mat<2, 3, T, Q> const& m, typename mat<2, 3, T, Q>::row_type const& v);

template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR typename mat<2, 3, T, Q>::row_type operator*(
    typename mat<2, 3, T, Q>::col_type const& v, mat<2, 3, T, Q> const& m);
...
template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR mat<3, 3, T, Q> operator*(mat<2, 3, T, Q> const& m1,
                                                      mat<3, 2, T, Q> const& m2);

template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR mat<4, 3, T, Q> operator*(mat<2, 3, T, Q> const& m1,
