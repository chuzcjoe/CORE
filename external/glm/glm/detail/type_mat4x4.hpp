...
struct mat<4, 4, T, Q> {
 ...
 public:
  ...
  GLM_CTOR_DECL mat(T const& x0, T const& y0, T const& z0, T const& w0, T const& x1, T const& y1,
                    T const& z1, T const& w1, T const& x2, T const& y2, T const& z2, T const& w2,
  ...
  GLM_CTOR_DECL mat(X1 const& x1, Y1 const& y1, Z1 const& z1, W1 const& w1, X2 const& x2,
  ...
  GLM_CTOR_DECL mat(vec<4, V1, Q> const& v1, vec<4, V2, Q> const& v2, vec<4, V3, Q> const& v3,
                    vec<4, V4, Q> const& v4);
...
template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR mat<4, 4, T, Q> operator+(mat<4, 4, T, Q> const& m1,
...
template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR typename mat<4, 4, T, Q>::col_type operator*(
    mat<4, 4, T, Q> const& m, typename mat<4, 4, T, Q>::row_type const& v);

template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR typename mat<4, 4, T, Q>::row_type operator*(
    typename mat<4, 4, T, Q>::col_type const& v, mat<4, 4, T, Q> const& m);

template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR mat<2, 4, T, Q> operator*(mat<4, 4, T, Q> const& m1,
                                                      mat<2, 4, T, Q> const& m2);

template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR mat<3, 4, T, Q> operator*(mat<4, 4, T, Q> const& m1,
