...
struct mat<2, 4, T, Q> {
 ...
 public:
  ...
  template <typename X1, typename Y1, typename Z1, typename W1, typename X2, typename Y2,
            typename Z2, typename W2>
  GLM_CTOR_DECL mat(X1 x1, Y1 y1, Z1 z1, W1 w1, X2 x2, Y2 y2, Z2 z2, W2 w2);

  template <typename U, typename V>
  GLM_CTOR_DECL mat(vec<4, U, Q> const& v1, vec<4, V, Q> const& v2);
...
template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR mat<2, 4, T, Q> operator+(mat<2, 4, T, Q> const& m1,
...
template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR typename mat<2, 4, T, Q>::col_type operator*(
    mat<2, 4, T, Q> const& m, typename mat<2, 4, T, Q>::row_type const& v);

template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR typename mat<2, 4, T, Q>::row_type operator*(
    typename mat<2, 4, T, Q>::col_type const& v, mat<2, 4, T, Q> const& m);

template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR mat<4, 4, T, Q> operator*(mat<2, 4, T, Q> const& m1,
...
template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR mat<3, 4, T, Q> operator*(mat<2, 4, T, Q> const& m1,
