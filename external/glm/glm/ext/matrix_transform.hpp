...
/// @see <a
/// href="https://www.khronos.org/registry/OpenGL-Refpages/gl2.1/xhtml/glTranslate.xml">glTranslate
/// man page</a>
template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR mat<4, 4, T, Q> translate(mat<4, 4, T, Q> const& m,
                                                      vec<3, T, Q> const& v);
...
/// @see <a
/// href="https://www.khronos.org/registry/OpenGL-Refpages/gl2.1/xhtml/glRotate.xml">glRotate man
/// page</a>
template <typename T, qualifier Q>
...
/// @see <a href="https://www.khronos.org/registry/OpenGL-Refpages/gl2.1/xhtml/glScale.xml">glScale
/// man page</a>
template <typename T, qualifier Q>
...
/// @see no resource...
template <typename T, qualifier Q>
GLM_FUNC_QUALIFIER mat<4, 4, T, Q> shear(mat<4, 4, T, Q> const& m, vec<3, T, Q> const& p,
                                         vec<2, T, Q> const& l_x, vec<2, T, Q> const& l_y,
                                         vec<2, T, Q> const& l_z);
...
/// @tparam Q A value from qualifier enum
///
/// @see - frustum(T const& left, T const& right, T const& bottom, T const& top, T const& nearVal, T
/// const& farVal) frustum(T const& left, T const& right, T const& bottom, T const& top, T const&
/// nearVal, T const& farVal)
template <typename T, qualifier Q>
...
/// nearVal, T const& farVal)
/// @see <a
/// href="https://www.khronos.org/registry/OpenGL-Refpages/gl2.1/xhtml/gluLookAt.xml">gluLookAt man
/// page</a>
template <typename T, qualifier Q>
