...
typedef EGLsizeiANDROID (*EGLGetBlobFuncANDROID)(const void *key, EGLsizeiANDROID keySize,
...
typedef EGLClientBuffer(APIENTRYP PFNEGLCREATENATIVECLIENTBUFFERANDROIDPROC)(
    const EGLint *attrib_list);
...
typedef EGLClientBuffer(APIENTRYP PFNEGLGETNATIVECLIENTBUFFERANDROIDPROC)(
